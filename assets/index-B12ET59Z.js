...
void main() {
	...
	`}function w0(i){let t=new WeakMap,e=null;function n(l){if(l&&l.isTexture){const c=l.mapping,h=c===dc||c===fc,u=c===rs||c===ss;if(h||u){let d=t.get(l);const m=d!==void 0?d.texture.pmremVersion:0;if(l.isRenderTargetTexture&&l.pmremVersion!==m)return e===null&&(e=new vd(i)),d=h?e.fromEquirectangular(l,d):e.fromCubemap(l,d),d.texture.pmremVersion=l.pmremVersion,t.set(l,d),d.texture;if(d!==void 0)return d.texture;{const _=l.image;return h&&_&&_.height>0||u&&_&&r(_)?(e===null&&(e=new vd(i)),d=h?e.fromEquirectangular(l):e.fromCubemap(l),d.texture.pmremVersion=l.pmremVersion,t.set(l,d),l.addEventListener("dispose",s),d.texture):null}}}return l}function r(l){let c=0;const h=6;for(let u=0;u<h;u++)l[u]!==void 0&&c++;return c===h}function s(l){const c=l.target;c.removeEventListener("dispose",s);const h=t.get(c);h!==void 0&&(t.delete(c),h.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function b0(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&ga("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function R0(i,t,e,n){const r={},s=new WeakMap;function o(d){const m=d.target;m.index!==null&&t.remove(m.index);for(const x in m.attributes)t.remove(m.attributes[x]);m.removeEventListener("dispose",o),delete r[m.id];const _=s.get(m);_&&(t.remove(_),s.delete(m)),n.releaseStatesOfGeometry(m),m.isInstancedBufferGeometry===!0&&delete m._maxInstanceCount,e.memory.geometries--}function l(d,m){return r[m.id]===!0||(m.addEventListener("dispose",o),r[m.id]=!0,e.memory.geometries++),m}function c(d){const m=d.attributes;for(const _ in m)t.update(m[_],i.ARRAY_BUFFER)}function h(d){const m=[],_=d.index,x=d.attributes.position;let M=0;if(_!==null){const I=_.array;M=_.version;for(let D=0,P=I.length;D<P;D+=3){const V=I[D+0],F=I[D+1],S=I[D+2];m.push(V,F,F,S,S,V)}}else if(x!==void 0){const I=x.array;M=x.version;for(let D=0,P=I.length/3-1;D<P;D+=3){const V=D+0,F=D+1,S=D+2;m.push(V,F,F,S,S,V)}}else return;const g=new(vp(m)?Mp:Sp)(m,1);g.version=M;const p=s.get(d);p&&t.remove(p),s.set(d,g)}function u(d){const m=s.get(d);if(m){const _=d.index;_!==null&&m.version<_.version&&h(d)}else h(d);return s.get(d)}return{get:l,update:c,getWireframeAttribute:u}}function C0(i,t,e){let n;function r(m){n=m}let s,o;function l(m){s=m.type,o=m.bytesPerElement}function c(m,_){i.drawElements(n,_,s,m*o),e.update(_,n,1)}function h(m,_,x){x!==0&&(i.drawElementsInstanced(n,_,s,m*o,x),e.update(_,n,x))}function u(m,_,x){if(x===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,_,0,s,m,0,x);let g=0;for(let p=0;p<x;p++)g+=_[p];e.update(g,n,1)}function d(m,_,x,M){if(x===0)return;const g=t.get("WEBGL_multi_draw");if(g===null)for(let p=0;p<m.length;p++)h(m[p]/o,_[p],M[p]);else{g.multiDrawElementsInstancedWEBGL(n,_,0,s,m,0,M,0,x);let p=0;for(let I=0;I<x;I++)p+=_[I]*M[I];e.update(p,n,1)}}this.setMode=r,this.setIndex=l,this.render=c,this.renderInstances=h,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function I0(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,l){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=l*(s/3);break;case i.LINES:e.lines+=l*(s/2);break;case i.LINE_STRIP:e.lines+=l*(s-1);break;case i.LINE_LOOP:e.lines+=l*s;break;case i.POINTS:e.points+=l*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function P0(i,t,e){const n=new WeakMap,r=new Te;function s(o,l,c){const h=o.morphTargetInfluences,u=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,d=u!==void 0?u.length:0;let m=n.get(l);if(m===void 0||m.count!==d){let v=function(){T.dispose(),n.delete(l),l.removeEventListener("dispose",v)};var _=v;m!==void 0&&m.texture.dispose();const x=l.morphAttributes.position!==void 0,M=l.morphAttributes.normal!==void 0,g=l.morphAttributes.color!==void 0,p=l.morphAttributes.position||[],I=l.morphAttributes.normal||[],D=l.morphAttributes.color||[];let P=0;x===!0&&(P=1),M===!0&&(P=2),g===!0&&(P=3);let V=l.attributes.position.count*P,F=1;V>t.maxTextureSize&&(F=Math.ceil(V/t.maxTextureSize),V=t.maxTextureSize);const S=new Float32Array(V*F*4*d),T=new yp(S,V,F,d);T.type=di,T.needsUpdate=!0;const y=P*4;for(let A=0;A<d;A++){const L=p[A],b=I[A],Z=D[A],nt=V*F*4*A;for(let tt=0;tt<L.count;tt++){const it=tt*y;x===!0&&(r.fromBufferAttribute(L,tt),S[nt+it+0]=r.x,S[nt+it+1]=r.y,S[nt+it+2]=r.z,S[nt+it+3]=0),M===!0&&(r.fromBufferAttribute(b,tt),S[nt+it+4]=r.x,S[nt+it+5]=r.y,S[nt+it+6]=r.z,S[nt+it+7]=0),g===!0&&(r.fromBufferAttribute(Z,tt),S[nt+it+8]=r.x,S[nt+it+9]=r.y,S[nt+it+10]=r.z,S[nt+it+11]=Z.itemSize===4?r.w:1)}}m={count:d,texture:T,size:new Xt(V,F)},n.set(l,m),l.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let x=0;for(let g=0;g<h.length;g++)x+=h[g];const M=l.morphTargetsRelative?1:1-x;c.getUniforms().setValue(i,"morphTargetBaseInfluence",M),c.getUniforms().setValue(i,"morphTargetInfluences",h)}c.getUniforms().setValue(i,"morphTargetsTexture",m.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",m.size)}return{update:s}}function D0(i,t,e,n){let r=new WeakMap;function s(c){const h=n.render.frame,u=c.geometry,d=t.get(c,u);if(r.get(d)!==h&&(t.update(d),r.set(d,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==h&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,h))),c.isSkinnedMesh){const m=c.skeleton;r.get(m)!==h&&(m.update(),r.set(m,h))}return d}function o(){r=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),e.remove(h.instanceMatrix),h.instanceColor!==null&&e.remove(h.instanceColor)}return{update:s,dispose:o}}const Pp=new dn,Td=new bp(1,1),Dp=new yp,Lp=new Z_,Np=new Ah,Sd=[],Md=[],Ad=new Float32Array(16),wd=new Float32Array(9),bd=new Float32Array(4);function gs(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=Sd[r];if(s===void 0&&(s=new Float32Array(r),Sd[r]=s),t!==0){n.toArray(s,0);for(let o=1,l=0;o!==t;++o)l+=e,i[o].toArray(s,l)}return s}function qe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Xe(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function $a(i,t){let e=Md[t];e===void 0&&(e=new Int32Array(t),Md[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function L0(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function N0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;i.uniform2fv(this.addr,t),Xe(e,t)}}function U0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(qe(e,t))return;i.uniform3fv(this.addr,t),Xe(e,t)}}function F0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;i.uniform4fv(this.addr,t),Xe(e,t)}}function O0(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(qe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Xe(e,t)}else{if(qe(e,n))return;bd.set(n),i.uniformMatrix2fv(this.addr,!1,bd),Xe(e,n)}}function V0(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(qe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Xe(e,t)}else{if(qe(e,n))return;wd.set(n),i.uniformMatrix3fv(this.addr,!1,wd),Xe(e,n)}}function B0(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(qe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Xe(e,t)}else{if(qe(e,n))return;Ad.set(n),i.uniformMatrix4fv(this.addr,!1,Ad),Xe(e,n)}}function k0(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function z0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;i.uniform2iv(this.addr,t),Xe(e,t)}}function H0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(qe(e,t))return;i.uniform3iv(this.addr,t),Xe(e,t)}}function G0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;i.uniform4iv(this.addr,t),Xe(e,t)}}function W0(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function q0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(qe(e,t))return;i.uniform2uiv(this.addr,t),Xe(e,t)}}function X0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(qe(e,t))return;i.uniform3uiv(this.addr,t),Xe(e,t)}}function $0(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(qe(e,t))return;i.uniform4uiv(this.addr,t),Xe(e,t)}}function j0(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Td.compareFunction=_p,s=Td):s=Pp,e.setTexture2D(t||s,r)}function Y0(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||Lp,r)}function K0(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||Np,r)}function Q0(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||Dp,r)}function Z0(i){switch(i){case 5126:return L0;case 35664:return N0;case 35665:return U0;case 35666:return F0;case 35674:return O0;case 35675:return V0;case 35676:return B0;case 5124:case 35670:return k0;case 35667:case 35671:return z0;case 35668:case 35672:return H0;case 35669:case 35673:return G0;case 5125:return W0;case 36294:return q0;case 36295:return X0;case 36296:return $0;case 35678:case 36198:case 36298:case 36306:case 35682:return j0;case 35679:case 36299:case 36307:return Y0;case 35680:case 36300:case 36308:case 36293:return K0;case 36289:case 36303:case 36311:case 36292:return Q0}}function J0(i,t){i.uniform1fv(this.addr,t)}function tx(i,t){const e=gs(t,this.size,2);i.uniform2fv(this.addr,e)}function ex(i,t){const e=gs(t,this.size,3);i.uniform3fv(this.addr,e)}function nx(i,t){const e=gs(t,this.size,4);i.uniform4fv(this.addr,e)}function ix(i,t){const e=gs(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function rx(i,t){const e=gs(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function sx(i,t){const e=gs(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function ox(i,t){i.uniform1iv(this.addr,t)}function ax(i,t){i.uniform2iv(this.addr,t)}function lx(i,t){i.uniform3iv(this.addr,t)}function cx(i,t){i.uniform4iv(this.addr,t)}function hx(i,t){i.uniform1uiv(this.addr,t)}function ux(i,t){i.uniform2uiv(this.addr,t)}function dx(i,t){i.uniform3uiv(this.addr,t)}function fx(i,t){i.uniform4uiv(this.addr,t)}function px(i,t,e){const n=this.cache,r=t.length,s=$a(e,r);qe(n,s)||(i.uniform1iv(this.addr,s),Xe(n,s));for(let o=0;o!==r;++o)e.setTexture2D(t[o]||Pp,s[o])}function mx(i,t,e){const n=this.cache,r=t.length,s=$a(e,r);qe(n,s)||(i.uniform1iv(this.addr,s),Xe(n,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||Lp,s[o])}function gx(i,t,e){const n=this.cache,r=t.length,s=$a(e,r);qe(n,s)||(i.uniform1iv(this.addr,s),Xe(n,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||Np,s[o])}function _x(i,t,e){const n=this.cache,r=t.length,s=$a(e,r);qe(n,s)||(i.uniform1iv(this.addr,s),Xe(n,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||Dp,s[o])}function vx(i){switch(i){case 5126:return J0;case 35664:return tx;case 35665:return ex;case 35666:return nx;case 35674:return ix;case 35675:return rx;case 35676:return sx;case 5124:case 35670:return ox;case 35667:case 35671:return ax;case 35668:case 35672:return lx;case 35669:case 35673:return cx;case 5125:return hx;case 36294:return ux;case 36295:return dx;case 36296:return fx;case 35678:case 36198:case 36298:case 36306:case 35682:return px;case 35679:case 36299:case 36307:return mx;case 35680:case 36300:case 36308:case 36293:return gx;case 36289:case 36303:case 36311:case 36292:return _x}}class yx{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Z0(e.type)}}class Ex{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=vx(e.type)}}class xx{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const l=r[s];l.setValue(t,e[l.id],n)}}}const Wl=/(\w+)(\])?(\[|\.)?/g;function Rd(i,t){i.seq.push(t),i.map[t.id]=t}function Tx(i,t,e){const n=i.name,r=n.length;for(Wl.lastIndex=0;;){const s=Wl.exec(n),o=Wl.lastIndex;let l=s[1];const c=s[2]==="]",h=s[3];if(c&&(l=l|0),h===void 0||h==="["&&o+2===r){Rd(e,h===void 0?new yx(l,i,t):new Ex(l,i,t));break}else{let d=e.map[l];d===void 0&&(d=new xx(l),Rd(e,d)),e=d}}}class _a{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),o=t.getUniformLocation(e,s.name);Tx(s,o,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,o=e.length;s!==o;++s){const l=e[s],c=n[l.id];c.needsUpdate!==!1&&l.setValue(t,c.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&n.push(o)}return n}}function Cd(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Sx=37297;let Mx=0;function Ax(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const l=o+1;n.push(`${l===t?">":" "} ${l}: ${e[o]}`)}return n.join(`
`)}const Id=new Kt;function wx(i){me._getMatrix(Id,me.workingColorSpace,i);const t=`mat3( ${Id.elements.map(e=>e.toFixed(4))} )`;switch(me.getTransfer(i)){case wa:return[t,"LinearTransferOETF"];case Ee:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function Pd(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+Ax(i.getShaderSource(t),o)}else return r}function bx(i,t){const e=wx(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Rx(i,t){let e;switch(t){case S_:e="Linear";break;case M_:e="Reinhard";break;case A_:e="Cineon";break;case w_:e="ACESFilmic";break;case R_:e="AgX";break;case C_:e="Neutral";break;case b_:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const ea=new z;function Cx(){me.getLuminanceCoefficients(ea);const i=ea.x.toFixed(4),t=ea.y.toFixed(4),e=ea.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Ix(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Bs).join(`
`)}function Px(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Dx(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),o=s.name;let l=1;s.type===i.FLOAT_MAT2&&(l=2),s.type===i.FLOAT_MAT3&&(l=3),s.type===i.FLOAT_MAT4&&(l=4),e[o]={type:s.type,location:i.getAttribLocation(t,o),locationSize:l}}return e}function Bs(i){return i!==""}function Dd(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Ld(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Lx=/^[ \t]*#include +<([\w\d./]+)>/gm;function Gc(i){return i.replace(Lx,Ux)}const Nx=new Map;function Ux(i,t){let e=Qt[t];if(e===void 0){const n=Nx.get(t);if(n!==void 0)e=Qt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Gc(e)}const Fx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Nd(i){return i.replace(Fx,Ox)}function Ox(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ud(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Vx(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===sp?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===n_?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ci&&(t="SHADOWMAP_TYPE_VSM"),t}function Bx(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case rs:case ss:t="ENVMAP_TYPE_CUBE";break;case Wa:t="ENVMAP_TYPE_CUBE_UV";break}return t}function kx(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ss:t="ENVMAP_MODE_REFRACTION";break}return t}function zx(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case op:t="ENVMAP_BLENDING_MULTIPLY";break;case x_:t="ENVMAP_BLENDING_MIX";break;case T_:t="ENVMAP_BLENDING_ADD";break}return t}function Hx(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Gx(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,l=e.fragmentShader;const c=Vx(e),h=Bx(e),u=kx(e),d=zx(e),m=Hx(e),_=Ix(e),x=Px(s),M=r.createProgram();let g,p,I=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function $T(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let Xd=!1;class Ih{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:r,title:s="Controls",closeFolders:o=!1,injectStyles:l=!0,touchStyles:c=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("button"),this.$title.classList.add("title"),this.$title.setAttribute("aria-expanded",!0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),c&&this.domElement.classList.add("allow-touch-styles"),!Xd&&l&&($T(XT),Xd=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=o}add(t,e,n,r,s){if(Object(n)===n)return new WT(this,t,e,n);const o=t[e];switch(typeof o){case"number":return new GT(this,t,e,n,r,s);case"boolean":return new FT(this,t,e);case"string":return new qT(this,t,e);case"function":return new Xl(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,o)}addColor(t,e,n=1){return new HT(this,t,e,n)}addFolder(t){const e=new Ih({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof Xl||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof Xl)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}let ir,ur;const ui=[];function jT(i,t,e){ir=new Ih,ui.volume=ir.add(t,"volume",0,100,1).name("Volume").onChange(n=>{ur=e(),ur&&ur.setVolume&&ur.setVolume(n)}),ui.earthSpeed=ir.add(i,"earthSpeed",1,100,1).name("Earth Speed"),ui.earthRotationSpeed=ir.add(i,"earthRotationSpeed",1,100,1).name("Earth Rotation Speed"),ui.lightIntensity=ir.add(i,"lightIntensity",1,100,1).name("Light Intensity"),ui.rotationDirection=ir.add(i,"rotationDirection").name("Change Rotation Direction")}function KT(i,t,e){const n=i.songNum;e.aroundSunDirection=i.rotationDirection,ui.earthSpeed.setValue(i.earthSpeed),ui.earthRotationSpeed.setValue(i.earthRotationSpeed),ui.lightIntensity.setValue(i.lightIntensity),ui.volume.setValue(i.volume),ur&&n&&t&&(ur.loadVideoById(t[n-1].id),ur.playVideo())}function QT(i){ir.show(i)}const ZT=()=>{};var $d={};/**
 * @license
 ...
 */const Op=function(i){const t=[];let e=0;for(let n=0;n<i.length;n++){let r=i.charCodeAt(n);r<128?t[e++]=r:r<2048?(t[e++]=r>>6|192,t[e++]=r&63|128):(r&64512)===55296&&n+1<i.length&&(i.charCodeAt(n+1)&64512)===56320?(r=65536+((r&1023)<<10)+(i.charCodeAt(++n)&1023),t[e++]=r>>18|240,t[e++]=r>>12&63|128,t[e++]=r>>6&63|128,t[e++]=r&63|128):(t[e++]=r>>12|224,t[e++]=r>>6&63|128,t[e++]=r&63|128)}return t},JT=function(i){const t=[];let e=0,n=0;for(;e<i.length;){const r=i[e++];if(r<128)t[n++]=String.fromCharCode(r);else if(r>191&&r<224){const s=i[e++];t[n++]=String.fromCharCode((r&31)<<6|s&63)}else if(r>239&&r<365){const s=i[e++],o=i[e++],l=i[e++],c=((r&7)<<18|(s&63)<<12|(o&63)<<6|l&63)-65536;t[n++]=String.fromCharCode(55296+(c>>10)),t[n++]=String.fromCharCode(56320+(c&1023))}else{const s=i[e++],o=i[e++];t[n++]=String.fromCharCode((r&15)<<12|(s&63)<<6|o&63)}}return t.join("")},Vp={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(i,t){if(!Array.isArray(i))throw Error("encodeByteArray takes an array as a parameter");this.init_();const e=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,n=[];for(let r=0;r<i.length;r+=3){const s=i[r],o=r+1<i.length,l=o?i[r+1]:0,c=r+2<i.length,h=c?i[r+2]:0,u=s>>2,d=(s&3)<<4|l>>4;let m=(l&15)<<2|h>>6,_=h&63;c||(_=64,o||(m=64)),n.push(e[u],e[d],e[m],e[_])}return n.join("")},encodeString(i,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(i):this.encodeByteArray(Op(i),t)},decodeString(i,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(i):JT(this.decodeStringToByteArray(i,t))},decodeStringToByteArray(i,t){this.init_();const e=t?this.charToByteMapWebSafe_:this.charToByteMap_,n=[];for(let r=0;r<i.length;){const s=e[i.charAt(r++)],l=r<i.length?e[i.charAt(r)]:0;++r;const h=r<i.length?e[i.charAt(r)]:64;++r;const d=r<i.length?e[i.charAt(r)]:64;if(++r,s==null||l==null||h==null||d==null)throw new tS;const m=s<<2|l>>4;if(n.push(m),h!==64){const _=l<<4&240|h>>2;if(n.push(_),d!==64){const x=h<<6&192|d;n.push(x)}}}return n},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let i=0;i<this.ENCODED_VALS.length;i++)this.byteToCharMap_[i]=this.ENCODED_VALS.charAt(i),this.charToByteMap_[this.byteToCharMap_[i]]=i,this.byteToCharMapWebSafe_[i]=this.ENCODED_VALS_WEBSAFE.charAt(i),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[i]]=i,i>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(i)]=i,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(i)]=i)}}};class tS extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const eS=function(i){const t=Op(i);return Vp.encodeByteArray(t,!0)},Ra=function(i){return eS(i).replace(/\./g,"")},nS=function(i){try{return Vp.decodeString(i,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rS=()=>iS().__FIREBASE_DEFAULTS__,sS=()=>{if(typeof process>"u"||typeof $d>"u")return;const i=$d.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},oS=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=i&&nS(i[1]);return t&&JSON.parse(t)},Ph=()=>{try{return ZT()||rS()||sS()||oS()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},aS=i=>{var t,e;return(e=(t=Ph())===null||t===void 0?void 0:t.emulatorHosts)===null||e===void 0?void 0:e[i]},lS=i=>{const t=aS(i);if(!t)return;const e=t.lastIndexOf(":");if(e<=0||e+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const n=parseInt(t.substring(e+1),10);return t[0]==="["?[t.substring(1,e-1),n]:[t.substring(0,e),n]},Bp=()=>{var i;return(i=Ph())===null||i===void 0?void 0:i.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cS{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,e)=>{this.resolve=t,this.reject=e})}wrapCallback(t){return(e,n)=>{e?this.reject(e):this.resolve(n),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(e):t(e,n))}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hS(i,t){if(i.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const e={alg:"none",type:"JWT"},n=t||"demo-project",r=i.iat||0,s=i.sub||i.user_id;if(!s)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:r,exp:r+3600,auth_time:r,sub:s,user_id:s,firebase:{sign_in_provider:"custom",identities:{}}},i);return[Ra(JSON.stringify(e)),Ra(JSON.stringify(o)),""].join(".")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uS(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function dS(){var i;const t=(i=Ph())===null||i===void 0?void 0:i.forceEnvironment;if(t==="node")return!0;if(t==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function fS(){return!dS()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function pS(){try{return typeof indexedDB=="object"}catch{return!1}}function mS(){return new Promise((i,t)=>{try{let e=!0;const n="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(n);r.onsuccess=()=>{r.result.close(),e||self.indexedDB.deleteDatabase(n),i(!0)},r.onupgradeneeded=()=>{e=!1},r.onerror=()=>{var s;t(((s=r.error)===null||s===void 0?void 0:s.message)||"")}}catch(e){t(e)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gS="FirebaseError";class _s extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=gS,Object.setPrototypeOf(this,_s.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,kp.prototype.create)}}class kp{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},r=`${this.service}/${t}`,s=this.errors[t],o=s?_S(s,n):"Error",l=`${this.serviceName}: ${o} (${r}).`;return new _s(r,l,n)}}function _S(i,t){return i.replace(vS,(e,n)=>{const r=t[n];return r!=null?String(r):`<${n}?>`})}const vS=/\{\$([^}]+)}/g;function no(i,t){if(i===t)return!0;const e=Object.keys(i),n=Object.keys(t);for(const r of e){if(!n.includes(r))return!1;const s=i[r],o=t[r];if(jd(s)&&jd(o)){if(!no(s,o))return!1}else if(s!==o)return!1}for(const r of n)if(!e.includes(r))return!1;return!0}function jd(i){return i!==null&&typeof i=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class SS{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const e=this.getProvider(t.name);if(e.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);e.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const e=new ES(t,this);return this.providers.set(t,e),e}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ue;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(ue||(ue={}));const MS={debug:ue.DEBUG,verbose:ue.VERBOSE,info:ue.INFO,warn:ue.WARN,error:ue.ERROR,silent:ue.SILENT},AS=ue.INFO,wS={[ue.DEBUG]:"log",[ue.VERBOSE]:"log",[ue.INFO]:"info",[ue.WARN]:"warn",[ue.ERROR]:"error"},bS=(i,t,...e)=>{if(t<i.logLevel)return;const n=new Date().toISOString(),r=wS[t];if(r)console[r](`[${n}]  ${i.name}:`,...e);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class Hp{constructor(t){this.name=t,this._logLevel=AS,this._logHandler=bS,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in ue))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?MS[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,ue.DEBUG,...t),this._logHandler(this,ue.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,ue.VERBOSE,...t),this._logHandler(this,ue.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,ue.INFO,...t),this._logHandler(this,ue.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,ue.WARN,...t),this._logHandler(this,ue.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,ue.ERROR,...t),this._logHandler(this,ue.ERROR,...t)}}const RS=(i,t)=>t.some(e=>i instanceof e);let Yd,Kd;function CS(){return Yd||(Yd=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function IS(){return Kd||(Kd=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Gp=new WeakMap,Xc=new WeakMap,Wp=new WeakMap,$l=new WeakMap,Dh=new WeakMap;function PS(i){const t=new Promise((e,n)=>{const r=()=>{i.removeEventListener("success",s),i.removeEventListener("error",o)},s=()=>{e(Ui(i.result)),r()},o=()=>{n(i.error),r()};i.addEventListener("success",s),i.addEventListener("error",o)});return t.then(e=>{e instanceof IDBCursor&&Gp.set(e,i)}).catch(()=>{}),Dh.set(t,i),t}function DS(i){if(Xc.has(i))return;const t=new Promise((e,n)=>{const r=()=>{i.removeEventListener("complete",s),i.removeEventListener("error",o),i.removeEventListener("abort",o)},s=()=>{e(),r()},o=()=>{n(i.error||new DOMException("AbortError","AbortError")),r()};i.addEventListener("complete",s),i.addEventListener("error",o),i.addEventListener("abort",o)});Xc.set(i,t)}let $c={get(i,t,e){if(i instanceof IDBTransaction){if(t==="done")return Xc.get(i);if(t==="objectStoreNames")return i.objectStoreNames||Wp.get(i);if(t==="store")return e.objectStoreNames[1]?void 0:e.objectStore(e.objectStoreNames[0])}return Ui(i[t])},set(i,t,e){return i[t]=e,!0},has(i,t){return i instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in i}};function LS(i){$c=i($c)}function NS(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...e){const n=i.call(jl(this),t,...e);return Wp.set(n,t.sort?t.sort():[t]),Ui(n)}:IS().includes(i)?function(...t){return i.apply(jl(this),t),Ui(Gp.get(this))}:function(...t){return Ui(i.apply(jl(this),t))}}function US(i){return typeof i=="function"?NS(i):(i instanceof IDBTransaction&&DS(i),RS(i,CS())?new Proxy(i,$c):i)}function Ui(i){if(i instanceof IDBRequest)return PS(i);if($l.has(i))return $l.get(i);const t=US(i);return t!==i&&($l.set(i,t),Dh.set(t,i)),t}const jl=i=>Dh.get(i);function FS(i,t,{blocked:e,upgrade:n,blocking:r,terminated:s}={}){const o=indexedDB.open(i,t),l=Ui(o);return n&&o.addEventListener("upgradeneeded",c=>{n(Ui(o.result),c.oldVersion,c.newVersion,Ui(o.transaction),c)}),e&&o.addEventListener("blocked",c=>e(c.oldVersion,c.newVersion,c)),l.then(c=>{s&&c.addEventListener("close",()=>s()),r&&c.addEventListener("versionchange",h=>r(h.oldVersion,h.newVersion,h))}).catch(()=>{}),l}const OS=["get","getKey","getAll","getAllKeys","count"],VS=["put","add","delete","clear"],Yl=new Map;function Qd(i,t){if(!(i instanceof IDBDatabase&&!(t in i)&&typeof t=="string"))return;if(Yl.get(t))return Yl.get(t);const e=t.replace(/FromIndex$/,""),n=t!==e,r=VS.includes(e);if(!(e in(n?IDBIndex:IDBObjectStore).prototype)||!(r||OS.includes(e)))return;const s=async function(o,...l){const c=this.transaction(o,r?"readwrite":"readonly");let h=c.store;return n&&(h=h.index(l.shift())),(await Promise.all([h[e](...l),r&&c.done]))[0]};return Yl.set(t,s),s}LS(i=>({...i,get:(t,e,n)=>Qd(t,e)||i.get(t,e,n),has:(t,e)=>!!Qd(t,e)||i.has(t,e)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BS{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(kS(e)){const n=e.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(e=>e).join(" ")}}function kS(i){const t=i.getComponent();return(t==null?void 0:t.type)==="VERSION"}const jc="@firebase/app",Zd="0.12.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gi=new Hp("@firebase/app"),zS="@firebase/app-compat",HS="@firebase/analytics-compat",GS="@firebase/analytics",WS="@firebase/app-check-compat",qS="@firebase/app-check",XS="@firebase/auth",$S="@firebase/auth-compat",jS="@firebase/database",YS="@firebase/data-connect",KS="@firebase/database-compat",QS="@firebase/functions",ZS="@firebase/functions-compat",JS="@firebase/installations",tM="@firebase/installations-compat",eM="@firebase/messaging",nM="@firebase/messaging-compat",iM="@firebase/performance",rM="@firebase/performance-compat",sM="@firebase/remote-config",oM="@firebase/remote-config-compat",aM="@firebase/storage",lM="@firebase/storage-compat",cM="@firebase/firestore",hM="@firebase/vertexai",uM="@firebase/firestore-compat",dM="firebase",fM="11.7.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yc="[DEFAULT]",pM={[jc]:"fire-core",[zS]:"fire-core-compat",[GS]:"fire-analytics",[HS]:"fire-analytics-compat",[qS]:"fire-app-check",[WS]:"fire-app-check-compat",[XS]:"fire-auth",[$S]:"fire-auth-compat",[jS]:"fire-rtdb",[YS]:"fire-data-connect",[KS]:"fire-rtdb-compat",[QS]:"fire-fn",[ZS]:"fire-fn-compat",[JS]:"fire-iid",[tM]:"fire-iid-compat",[eM]:"fire-fcm",[nM]:"fire-fcm-compat",[iM]:"fire-perf",[rM]:"fire-perf-compat",[sM]:"fire-rc",[oM]:"fire-rc-compat",[aM]:"fire-gcs",[lM]:"fire-gcs-compat",[cM]:"fire-fst",[uM]:"fire-fst-compat",[hM]:"fire-vertex","fire-js":"fire-js",[dM]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ca=new Map,mM=new Map,Kc=new Map;function Jd(i,t){try{i.container.addComponent(t)}catch(e){gi.debug(`Component ${t.name} failed to register with FirebaseApp ${i.name}`,e)}}function Ia(i){const t=i.name;if(Kc.has(t))return gi.debug(`There were multiple attempts to register component ${t}.`),!1;Kc.set(t,i);for(const e of Ca.values())Jd(e,i);for(const e of mM.values())Jd(e,i);return!0}function gM(i,t){const e=i.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),i.container.getProvider(t)}function _M(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const EM=fM;function qp(i,t={}){let e=i;typeof t!="object"&&(t={name:t});const n=Object.assign({name:Yc,automaticDataCollectionEnabled:!1},t),r=n.name;if(typeof r!="string"||!r)throw Fi.create("bad-app-name",{appName:String(r)});if(e||(e=Bp()),!e)throw Fi.create("no-options");const s=Ca.get(r);if(s){if(no(e,s.options)&&no(n,s.config))return s;throw Fi.create("duplicate-app",{appName:r})}const o=new SS(r);for(const c of Kc.values())o.addComponent(c);const l=new yM(e,n,o);return Ca.set(r,l),l}function xM(i=Yc){const t=Ca.get(i);if(!t&&i===Yc&&Bp())return qp();if(!t)throw Fi.create("no-app",{appName:i});return t}function es(i,t,e){var n;let r=(n=pM[i])!==null&&n!==void 0?n:i;e&&(r+=`-${e}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const l=[`Unable to register library "${r}" with version "${t}":`];s&&l.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${t}" contains illegal characters (whitespace or "/")`),gi.warn(l.join(" "));return}Ia(new ro(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TM="firebase-heartbeat-database",SM=1,so="firebase-heartbeat-store";let Kl=null;function Xp(){return Kl||(Kl=FS(TM,SM,{upgrade:(i,t)=>{switch(t){case 0:try{i.createObjectStore(so)}catch(e){console.warn(e)}}}}).catch(i=>{throw Fi.create("idb-open",{originalErrorMessage:i.message})})),Kl}async function MM(i){try{const e=(await Xp()).transaction(so),n=await e.objectStore(so).get($p(i));return await e.done,n}catch(t){if(t instanceof _s)gi.warn(t.message);else{const e=Fi.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});gi.warn(e.message)}}}async function tf(i,t){try{const n=(await Xp()).transaction(so,"readwrite");await n.objectStore(so).put(t,$p(i)),await n.done}catch(e){if(e instanceof _s)gi.warn(e.message);else{const n=Fi.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});gi.warn(n.message)}}}function $p(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AM=1024,wM=30;class bM{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new CM(e),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var t,e;try{const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=ef();if(((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:r}),this._heartbeatsCache.heartbeats.length>wM){const o=IM(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){gi.warn(n)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=ef(),{heartbeatsToSend:n,unsentEntries:r}=RM(this._heartbeatsCache.heartbeats),s=Ra(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return gi.warn(e),""}}}function ef(){return new Date().toISOString().substring(0,10)}function RM(i,t=AM){const e=[];let n=i.slice();for(const r of i){const s=e.find(o=>o.agent===r.agent);if(s){if(s.dates.push(r.date),nf(e)>t){s.dates.pop();break}}else if(e.push({agent:r.agent,dates:[r.date]}),nf(e)>t){e.pop();break}n=n.slice(1)}return{heartbeatsToSend:e,unsentEntries:n}}class CM{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return pS()?mS().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await MM(this.app);return e!=null&&e.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){const r=await this.read();return tf(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:r.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var e;if(await this._canUseIndexedDBPromise){const r=await this.read();return tf(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...t.heartbeats]})}else return}}function nf(i){return Ra(JSON.stringify({version:2,heartbeats:i})).length}function IM(i){if(i.length===0)return-1;let t=0,e=i[0].date;for(let n=1;n<i.length;n++)i[n].date<e&&(e=i[n].date,t=n);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PM(i){Ia(new ro("platform-logger",t=>new BS(t),"PRIVATE")),Ia(new ro("heartbeat",t=>new bM(t),"PRIVATE")),es(jc,Zd,i),es(jc,Zd,"esm2017"),es("fire-js","")}PM("");var DM="firebase",LM="11.7.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gr=new Hp("@firebase/firestore");function Wr(){return gr.logLevel}function xt(i,...t){if(gr.logLevel<=ue.DEBUG){const e=t.map(Lh);gr.debug(`Firestore (${vs}): ${i}`,...e)}}function _i(i,...t){if(gr.logLevel<=ue.ERROR){const e=t.map(Lh);gr.error(`Firestore (${vs}): ${i}`,...e)}}function ls(i,...t){if(gr.logLevel<=ue.WARN){const e=t.map(Lh);gr.warn(`Firestore (${vs}): ${i}`,...e)}}function Lh(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bt(i,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,tm(i,n,e)}function tm(i,t,e){let n=`FIRESTORE (${vs}) INTERNAL ASSERTION FAILED: ${t} (ID: ${i.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw _i(n),new Error(n)}function _e(i,t,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,i||tm(t,r,n)}function $t(i,t){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class em{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class NM{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(an.UNAUTHENTICATED))}shutdown(){}}class UM{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class FM{constructor(t){this.t=t,this.currentUser=an.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){_e(this.o===void 0,42304);let n=this.i;const r=c=>this.i!==n?(n=this.i,e(c)):Promise.resolve();let s=new Vi;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new Vi,t.enqueueRetryable(()=>r(this.currentUser))};const o=()=>{const c=s;t.enqueueRetryable(async()=>{await c.promise,await r(this.currentUser)})},l=c=>{xt("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(c=>l(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?l(c):(xt("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new Vi)}},0),o()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(n=>this.i!==t?(xt("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(_e(typeof n.accessToken=="string",31837,{l:n}),new em(n.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return _e(t===null||typeof t=="string",2055,{h:t}),new an(t)}}class OM{constructor(t,e,n){this.P=t,this.T=e,this.I=n,this.type="FirstParty",this.user=an.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const t=this.R();return t&&this.A.set("Authorization",t),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class VM{constructor(t,e,n){this.P=t,this.T=e,this.I=n}getToken(){return Promise.resolve(new OM(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable(()=>e(an.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class af{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class BM{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,_M(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){_e(this.o===void 0,3512);const n=s=>{s.error!=null&&xt("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.m;return this.m=s.token,xt("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?e(s.token):Promise.resolve()};this.o=s=>{t.enqueueRetryable(()=>n(s))};const r=s=>{xt("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(s=>r(s)),setTimeout(()=>{if(!this.appCheck){const s=this.V.getImmediate({optional:!0});s?r(s):xt("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new af(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(_e(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new af(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class im{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const r=kM(40);for(let s=0;s<r.length;++s)n.length<20&&r[s]<e&&(n+=t.charAt(r[s]%62))}return n}}function Zt(i,t){return i<t?-1:i>t?1:0}function Zc(i,t){let e=0;for(;e<i.length&&e<t.length;){const n=i.codePointAt(e),r=t.codePointAt(e);if(n!==r){if(n<128&&r<128)return Zt(n,r);{const s=nm(),o=zM(s.encode(lf(i,e)),s.encode(lf(t,e)));return o!==0?o:Zt(n,r)}}e+=n>65535?2:1}return Zt(i.length,t.length)}function lf(i,t){return i.codePointAt(t)>65535?i.substring(t,t+2):i.substring(t,t+1)}function zM(i,t){for(let e=0;e<i.length&&e<t.length;++e)if(i[e]!==t[e])return Zt(i[e],t[e]);return Zt(i.length,t.length)}function cs(i,t,e){return i.length===t.length&&i.every((n,r)=>e(n,t[r]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XM="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class $M{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(t=>t())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nh=-1;function Ya(i){return i==null}function Pa(i){return i===0&&1/i==-1/0}function YM(i){return typeof i=="number"&&Number.isInteger(i)&&!Pa(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rm="";function KM(i){let t="";for(let e=0;e<i.length;e++)t.length>0&&(t=df(t)),t=QM(i.get(e),t);return df(t)}function QM(i,t){let e=t;const n=i.length;for(let r=0;r<n;r++){const s=i.charAt(r);switch(s){case"\0":e+="";break;case rm:e+="";break;default:e+=s}}return e}function df(i){return i+rm+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ff(i){let t=0;for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t++;return t}function yr(i,t){for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t(e,i[e])}function sm(i){for(const t in i)if(Object.prototype.hasOwnProperty.call(i,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const am="server_timestamp",lm="__type__",cm="__previous_value__",hm="__local_write_time__";function Uh(i){var t,e;return((e=(((t=i==null?void 0:i.mapValue)===null||t===void 0?void 0:t.fields)||{})[lm])===null||e===void 0?void 0:e.stringValue)===am}function Ka(i){const t=i.mapValue.fields[cm];return Uh(t)?Ka(t):t}function ao(i){const t=Gi(i.mapValue.fields[hm].timestampValue);return new Ge(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cn{constructor(t){this.value=t}static empty(){return new Cn({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let n=0;n<t.length-1;++n)if(e=(e.mapValue.fields||{})[t.get(n)],!Ea(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=Xs(e)}setAll(t){let e=Ze.emptyPath(),n={},r=[];t.forEach((o,l)=>{if(!e.isImmediateParentOf(l)){const c=this.getFieldsMap(e);this.applyChanges(c,n,r),n={},r=[],e=l.popLast()}o?n[l.lastSegment()]=Xs(o):r.push(l.lastSegment())});const s=this.getFieldsMap(e);this.applyChanges(s,n,r)}delete(t){const e=this.field(t.popLast());Ea(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return Zn(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let n=0;n<t.length;++n){let r=e.mapValue.fields[t.get(n)];Ea(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},e.mapValue.fields[t.get(n)]=r),e=r}return e.mapValue.fields}applyChanges(t,e,n){yr(e,(r,s)=>t[r]=s);for(const r of n)delete t[r]}clone(){return new Cn(Xs(this.value))}}function fm(i){const t=[];return yr(i.fields,(e,n)=>{const r=new Ze([e]);if(Ea(n)){const s=fm(n.mapValue).fields;if(s.length===0)t.push(r);else for(const o of s)t.push(r.child(o))}else t.push(r)}),new Vn(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ua{constructor(t,e="asc"){this.field=t,this.dir=e}}function iA(i,t){return i.dir===t.dir&&i.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pm{}class He extends pm{constructor(t,e,n){super(),this.field=t,this.op=e,this.value=n}static create(t,e,n){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,n):new sA(t,e,n):e==="array-contains"?new lA(t,n):e==="in"?new cA(t,n):e==="not-in"?new hA(t,n):e==="array-contains-any"?new uA(t,n):new He(t,e,n)}static createKeyFieldInFilter(t,e,n){return e==="in"?new oA(t,n):new aA(t,n)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&e.nullValue===void 0&&this.matchesComparison(hs(e,this.value)):e!==null&&qi(this.value)===qi(e)&&this.matchesComparison(hs(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return Bt(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Jn extends pm{constructor(t,e){super(),this.filters=t,this.op=e,this.Te=null}static create(t,e){return new Jn(t,e)}matches(t){return mm(this)?this.filters.find(e=>!e.matches(t))===void 0:this.filters.find(e=>e.matches(t))!==void 0}getFlattenedFilters(){return this.Te!==null||(this.Te=this.filters.reduce((t,e)=>t.concat(e.getFlattenedFilters()),[])),this.Te}getFilters(){return Object.assign([],this.filters)}}function mm(i){return i.op==="and"}function gm(i){return rA(i)&&mm(i)}function rA(i){for(const t of i.filters)if(t instanceof Jn)return!1;return!0}function eh(i){if(i instanceof He)return i.field.canonicalString()+i.op.toString()+us(i.value);if(gm(i))return i.filters.map(t=>eh(t)).join(",");{const t=i.filters.map(e=>eh(e)).join(",");return`${i.op}(${t})`}}function _m(i,t){return i instanceof He?function(n,r){return r instanceof He&&n.op===r.op&&n.field.isEqual(r.field)&&Zn(n.value,r.value)}(i,t):i instanceof Jn?function(n,r){return r instanceof Jn&&n.op===r.op&&n.filters.length===r.filters.length?n.filters.reduce((s,o,l)=>s&&_m(o,r.filters[l]),!0):!1}(i,t):void Bt(19439)}function vm(i){return i instanceof He?function(e){return`${e.field.canonicalString()} ${e.op} ${us(e.value)}`}(i):i instanceof Jn?function(e){return e.op.toString()+" {"+e.getFilters().map(vm).join(" ,")+"}"}(i):"Filter"}class sA extends He{constructor(t,e,n){super(t,e,n),this.key=Lt.fromName(n.referenceValue)}matches(t){const e=Lt.comparator(t.key,this.key);return this.matchesComparison(e)}}class oA extends He{constructor(t,e){super(t,"in",e),this.keys=ym("in",e)}matches(t){return this.keys.some(e=>e.isEqual(t.key))}}class aA extends He{constructor(t,e){super(t,"not-in",e),this.keys=ym("not-in",e)}matches(t){return!this.keys.some(e=>e.isEqual(t.key))}}function ym(i,t){var e;return(((e=t.arrayValue)===null||e===void 0?void 0:e.values)||[]).map(n=>Lt.fromName(n.referenceValue))}class lA extends He{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return Fh(e)&&co(e.arrayValue,this.value)}}class cA extends He{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&co(this.value.arrayValue,e)}}class hA extends He{constructor(t,e){super(t,"not-in",e)}matches(t){if(co(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&e.nullValue===void 0&&!co(this.value.arrayValue,e)}}class uA extends He{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!Fh(e)||!e.arrayValue.values)&&e.arrayValue.values.some(n=>co(this.value.arrayValue,n))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dA{constructor(t,e=null,n=[],r=[],s=null,o=null,l=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=r,this.limit=s,this.startAt=o,this.endAt=l,this.Ie=null}}function xf(i,t=null,e=[],n=[],r=null,s=null,o=null){return new dA(i,t,e,n,r,s,o)}function Oh(i){const t=$t(i);if(t.Ie===null){let e=t.path.canonicalString();t.collectionGroup!==null&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map(n=>eh(n)).join(","),e+="|ob:",e+=t.orderBy.map(n=>function(s){return s.field.canonicalString()+s.dir}(n)).join(","),Ya(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(n=>us(n)).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(n=>us(n)).join(",")),t.Ie=e}return t.Ie}function Vh(i,t){if(i.limit!==t.limit||i.orderBy.length!==t.orderBy.length)return!1;for(let e=0;e<i.orderBy.length;e++)if(!iA(i.orderBy[e],t.orderBy[e]))return!1;if(i.filters.length!==t.filters.length)return!1;for(let e=0;e<i.filters.length;e++)if(!_m(i.filters[e],t.filters[e]))return!1;return i.collectionGroup===t.collectionGroup&&!!i.path.isEqual(t.path)&&!!Ef(i.startAt,t.startAt)&&Ef(i.endAt,t.endAt)}function nh(i){return Lt.isDocumentKey(i.path)&&i.collectionGroup===null&&i.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vA=new De(Lt.comparator);function vi(){return vA}const Sm=new De(Lt.comparator);function Gs(...i){let t=Sm;for(const e of i)t=t.insert(e.key,e);return t}function Mm(i){let t=Sm;return i.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function dr(){return js()}function Am(){return js()}function js(){return new Er(i=>i.toString(),(i,t)=>i.isEqual(t))}const yA=new De(Lt.comparator),EA=new We(Lt.comparator);function se(...i){let t=EA;for(const e of i)t=t.add(e);return t}const xA=new We(Zt);function TA(){return xA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bh(i,t){if(i.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Pa(t)?"-0":t}}function wm(i){return{integerValue:""+i}}function SA(i,t){return YM(t)?wm(t):Bh(i,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tl{constructor(){this._=void 0}}function MA(i,t,e){return i instanceof Fa?function(r,s){const o={fields:{[lm]:{stringValue:am},[hm]:{timestampValue:{seconds:r.seconds,nanos:r.nanoseconds}}}};return s&&Uh(s)&&(s=Ka(s)),s&&(o.fields[cm]=s),{mapValue:o}}(e,t):i instanceof ds?Rm(i,t):i instanceof ho?Cm(i,t):function(r,s){const o=bm(r,s),l=Sf(o)+Sf(r.Re);return th(o)&&th(r.Re)?wm(l):Bh(r.serializer,l)}(i,t)}function AA(i,t,e){return i instanceof ds?Rm(i,t):i instanceof ho?Cm(i,t):e}function bm(i,t){return i instanceof Oa?function(n){return th(n)||function(s){return!!s&&"doubleValue"in s}(n)}(t)?t:{integerValue:0}:null}class Fa extends tl{}class ds extends tl{constructor(t){super(),this.elements=t}}function Rm(i,t){const e=Im(t);for(const n of i.elements)e.some(r=>Zn(r,n))||e.push(n);return{arrayValue:{values:e}}}class ho extends tl{constructor(t){super(),this.elements=t}}function Cm(i,t){let e=Im(t);for(const n of i.elements)e=e.filter(r=>!Zn(r,n));return{arrayValue:{values:e}}}class Oa extends tl{constructor(t,e){super(),this.serializer=t,this.Re=e}}function Sf(i){return Ue(i.integerValue||i.doubleValue)}function Im(i){return Fh(i)&&i.arrayValue.values?i.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wA{constructor(t,e){this.field=t,this.transform=e}}function bA(i,t){return i.field.isEqual(t.field)&&function(n,r){return n instanceof ds&&r instanceof ds||n instanceof ho&&r instanceof ho?cs(n.elements,r.elements,Zn):n instanceof Oa&&r instanceof Oa?Zn(n.Re,r.Re):n instanceof Fa&&r instanceof Fa}(i.transform,t.transform)}class RA{constructor(t,e){this.version=t,this.transformResults=e}}class mi{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new mi}static exists(t){return new mi(void 0,t)}static updateTime(t){return new mi(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function xa(i,t){return i.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(i.updateTime):i.exists===void 0||i.exists===t.isFoundDocument()}class el{}function Pm(i,t){if(!i.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return i.isNoDocument()?new Lm(i.key,mi.none()):new vo(i.key,i.data,mi.none());{const e=i.data,n=Cn.empty();let r=new We(Ze.comparator);for(let s of t.fields)if(!r.has(s)){let o=e.field(s);o===null&&s.length>1&&(s=s.popLast(),o=e.field(s)),o===null?n.delete(s):n.set(s,o),r=r.add(s)}return new xr(i.key,n,new Vn(r.toArray()),mi.none())}}function CA(i,t,e){i instanceof vo?function(r,s,o){const l=r.value.clone(),c=Af(r.fieldTransforms,s,o.transformResults);l.setAll(c),s.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(i,t,e):i instanceof xr?function(r,s,o){if(!xa(r.precondition,s))return void s.convertToUnknownDocument(o.version);const l=Af(r.fieldTransforms,s,o.transformResults),c=s.data;c.setAll(Dm(r)),c.setAll(l),s.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(i,t,e):function(r,s,o){s.convertToNoDocument(o.version).setHasCommittedMutations()}(0,t,e)}function Ys(i,t,e,n){return i instanceof vo?function(s,o,l,c){if(!xa(s.precondition,o))return l;const h=s.value.clone(),u=wf(s.fieldTransforms,c,o);return h.setAll(u),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),null}(i,t,e,n):i instanceof xr?function(s,o,l,c){if(!xa(s.precondition,o))return l;const h=wf(s.fieldTransforms,c,o),u=o.data;return u.setAll(Dm(s)),u.setAll(h),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),l===null?null:l.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map(d=>d.field))}(i,t,e,n):function(s,o,l){return xa(s.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):l}(i,t,e)}function IA(i,t){let e=null;for(const n of i.fieldTransforms){const r=t.data.field(n.field),s=bm(n.transform,r||null);s!=null&&(e===null&&(e=Cn.empty()),e.set(n.field,s))}return e||null}function Mf(i,t){return i.type===t.type&&!!i.key.isEqual(t.key)&&!!i.precondition.isEqual(t.precondition)&&!!function(n,r){return n===void 0&&r===void 0||!(!n||!r)&&cs(n,r,(s,o)=>bA(s,o))}(i.fieldTransforms,t.fieldTransforms)&&(i.type===0?i.value.isEqual(t.value):i.type!==1||i.data.isEqual(t.data)&&i.fieldMask.isEqual(t.fieldMask))}class vo extends el{constructor(t,e,n,r=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class xr extends el{constructor(t,e,n,r,s=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=r,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function Dm(i){const t=new Map;return i.fieldMask.fields.forEach(e=>{if(!e.isEmpty()){const n=i.data.field(e);t.set(e,n)}}),t}function Af(i,t,e){const n=new Map;_e(i.length===e.length,32656,{Ve:e.length,me:i.length});for(let r=0;r<e.length;r++){const s=i[r],o=s.transform,l=t.data.field(s.field);n.set(s.field,AA(o,l,e[r]))}return n}function wf(i,t,e){const n=new Map;for(const r of i){const s=r.transform,o=e.data.field(r.field);n.set(r.field,MA(s,o,t))}return n}class Lm extends el{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class PA extends el{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DA{constructor(t,e,n,r){this.batchId=t,this.localWriteTime=e,this.baseMutations=n,this.mutations=r}applyToRemoteDocument(t,e){const n=e.mutationResults;for(let r=0;r<this.mutations.length;r++){const s=this.mutations[r];s.key.isEqual(t.key)&&CA(s,t,n[r])}}applyToLocalView(t,e){for(const n of this.baseMutations)n.key.isEqual(t.key)&&(e=Ys(n,t,e,this.localWriteTime));for(const n of this.mutations)n.key.isEqual(t.key)&&(e=Ys(n,t,e,this.localWriteTime));return e}applyToLocalDocumentSet(t,e){const n=Am();return this.mutations.forEach(r=>{const s=t.get(r.key),o=s.overlayedDocument;let l=this.applyToLocalView(o,s.mutatedFields);l=e.has(r.key)?null:l;const c=Pm(o,l);c!==null&&n.set(r.key,c),o.isValidDocument()||o.convertToNoDocument(Gt.min())}),n}keys(){return this.mutations.reduce((t,e)=>t.add(e.key),se())}isEqual(t){return this.batchId===t.batchId&&cs(this.mutations,t.mutations,(e,n)=>Mf(e,n))&&cs(this.baseMutations,t.baseMutations,(e,n)=>Mf(e,n))}}class kh{constructor(t,e,n,r){this.batch=t,this.commitVersion=e,this.mutationResults=n,this.docVersions=r}static from(t,e,n){_e(t.mutations.length===n.length,58842,{fe:t.mutations.length,ge:n.length});let r=function(){return yA}();const s=t.mutations;for(let o=0;o<s.length;o++)r=r.insert(s[o].key,n[o].version);return new kh(t,e,n,r)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ta{constructor(t,e,n,r){this.De=t,this.removedTargetIds=e,this.key=n,this.ve=r}}class Um{constructor(t,e){this.targetId=t,this.Ce=e}}class Fm{constructor(t,e,n=Je.EMPTY_BYTE_STRING,r=null){this.state=t,this.targetIds=e,this.resumeToken=n,this.cause=r}}class Cf{constructor(){this.Fe=0,this.Me=If(),this.xe=Je.EMPTY_BYTE_STRING,this.Oe=!1,this.Ne=!0}get current(){return this.Oe}get resumeToken(){return this.xe}get Be(){return this.Fe!==0}get Le(){return this.Ne}ke(t){t.approximateByteSize()>0&&(this.Ne=!0,this.xe=t)}qe(){let t=se(),e=se(),n=se();return this.Me.forEach((r,s)=>{switch(s){case 0:t=t.add(r);break;case 2:e=e.add(r);break;case 1:n=n.add(r);break;default:Bt(38017,{changeType:s})}}),new yo(this.xe,this.Oe,t,e,n)}Qe(){this.Ne=!1,this.Me=If()}$e(t,e){this.Ne=!0,this.Me=this.Me.insert(t,e)}Ue(t){this.Ne=!0,this.Me=this.Me.remove(t)}Ke(){this.Fe+=1}We(){this.Fe-=1,_e(this.Fe>=0,3241,{Fe:this.Fe})}Ge(){this.Ne=!0,this.Oe=!0}}class OA{constructor(t){this.ze=t,this.je=new Map,this.He=vi(),this.Je=oa(),this.Ye=oa(),this.Ze=new De(Zt)}Xe(t){for(const e of t.De)t.ve&&t.ve.isFoundDocument()?this.et(e,t.ve):this.tt(e,t.key,t.ve);for(const e of t.removedTargetIds)this.tt(e,t.key,t.ve)}nt(t){this.forEachTarget(t,e=>{const n=this.rt(e);switch(t.state){case 0:this.it(e)&&n.ke(t.resumeToken);break;case 1:n.We(),n.Be||n.Qe(),n.ke(t.resumeToken);break;case 2:n.We(),n.Be||this.removeTarget(e);break;case 3:this.it(e)&&(n.Ge(),n.ke(t.resumeToken));break;case 4:this.it(e)&&(this.st(e),n.ke(t.resumeToken));break;default:Bt(56790,{state:t.state})}})}forEachTarget(t,e){t.targetIds.length>0?t.targetIds.forEach(e):this.je.forEach((n,r)=>{this.it(r)&&e(r)})}ot(t){const e=t.targetId,n=t.Ce.count,r=this._t(e);if(r){const s=r.target;if(nh(s))if(n===0){const o=new Lt(s.path);this.tt(e,o,ln.newNoDocument(o,Gt.min()))}else _e(n===1,20013,{expectedCount:n});else{const o=this.ut(e);if(o!==n){const l=this.ct(t),c=l?this.lt(l,t,o):1;if(c!==0){this.st(e);const h=c===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ze=this.Ze.insert(e,h)}}}}}ct(t){const e=t.Ce.unchangedNames;if(!e||!e.bits)return null;const{bits:{bitmap:n="",padding:r=0},hashCount:s=0}=e;let o,l;try{o=Wi(n).toUint8Array()}catch(c){if(c instanceof om)return ls("Decoding the base64 bloom filter in existence filter failed ("+c.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw c}try{l=new zh(o,r,s)}catch(c){return ls(c instanceof Ws?"BloomFilter error: ":"Applying bloom filter failed: ",c),null}return l.pe===0?null:l}lt(t,e,n){return e.Ce.count===n-this.Tt(t,e.targetId)?0:2}Tt(t,e){const n=this.ze.getRemoteKeysForTarget(e);let r=0;return n.forEach(s=>{const o=this.ze.Pt(),l=`projects/${o.projectId}/databases/${o.database}/documents/${s.path.canonicalString()}`;t.mightContain(l)||(this.tt(e,s,null),r++)}),r}It(t){const e=new Map;this.je.forEach((s,o)=>{const l=this._t(o);if(l){if(s.current&&nh(l.target)){const c=new Lt(l.target.path);this.Et(c).has(o)||this.dt(o,c)||this.tt(o,c,ln.newNoDocument(c,t))}s.Le&&(e.set(o,s.qe()),s.Qe())}});let n=se();this.Ye.forEach((s,o)=>{let l=!0;o.forEachWhile(c=>{const h=this._t(c);return!h||h.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)}),l&&(n=n.add(s))}),this.He.forEach((s,o)=>o.setReadTime(t));const r=new nl(t,e,this.Ze,this.He,n);return this.He=vi(),this.Je=oa(),this.Ye=oa(),this.Ze=new De(Zt),r}et(t,e){if(!this.it(t))return;const n=this.dt(t,e.key)?2:0;this.rt(t).$e(e.key,n),this.He=this.He.insert(e.key,e),this.Je=this.Je.insert(e.key,this.Et(e.key).add(t)),this.Ye=this.Ye.insert(e.key,this.At(e.key).add(t))}tt(t,e,n){if(!this.it(t))return;const r=this.rt(t);this.dt(t,e)?r.$e(e,1):r.Ue(e),this.Ye=this.Ye.insert(e,this.At(e).delete(t)),this.Ye=this.Ye.insert(e,this.At(e).add(t)),n&&(this.He=this.He.insert(e,n))}removeTarget(t){this.je.delete(t)}ut(t){const e=this.rt(t).qe();return this.ze.getRemoteKeysForTarget(t).size+e.addedDocuments.size-e.removedDocuments.size}Ke(t){this.rt(t).Ke()}rt(t){let e=this.je.get(t);return e||(e=new Cf,this.je.set(t,e)),e}At(t){let e=this.Ye.get(t);return e||(e=new We(Zt),this.Ye=this.Ye.insert(t,e)),e}Et(t){let e=this.Je.get(t);return e||(e=new We(Zt),this.Je=this.Je.insert(t,e)),e}it(t){const e=this._t(t)!==null;return e||xt("WatchChangeAggregator","Detected inactive target",t),e}_t(t){const e=this.je.get(t);return e&&e.Be?null:this.ze.Rt(t)}st(t){this.je.set(t,new Cf),this.ze.getRemoteKeysForTarget(t).forEach(e=>{this.tt(t,e,null)})}dt(t,e){return this.ze.getRemoteKeysForTarget(t).has(e)}}function oa(){return new De(Lt.comparator)}function If(){return new De(Lt.comparator)}const VA={asc:"ASCENDING",desc:"DESCENDING"},BA={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},kA={and:"AND",or:"OR"};class zA{constructor(t,e){this.databaseId=t,this.useProto3Json=e}}function rh(i,t){return i.useProto3Json||Ya(t)?t:{value:t}}function Va(i,t){return i.useProto3Json?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function Om(i,t){return i.useProto3Json?t.toBase64():t.toUint8Array()}function HA(i,t){return Va(i,t.toTimestamp())}function Yn(i){return _e(!!i,49232),Gt.fromTimestamp(function(e){const n=Gi(e);return new Ge(n.seconds,n.nanos)}(i))}function Hh(i,t){return sh(i,t).canonicalString()}function sh(i,t){const e=function(r){return new Pe(["projects",r.projectId,"databases",r.database])}(i).child("documents");return t===void 0?e:e.child(t)}function Vm(i){const t=Pe.fromString(i);return _e(Gm(t),10190,{key:t.toString()}),t}function oh(i,t){return Hh(i.databaseId,t.path)}function Ql(i,t){const e=Vm(t);if(e.get(1)!==i.databaseId.projectId)throw new It(st.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+e.get(1)+" vs "+i.databaseId.projectId);if(e.get(3)!==i.databaseId.database)throw new It(st.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+e.get(3)+" vs "+i.databaseId.database);return new Lt(km(e))}function Bm(i,t){return Hh(i.databaseId,t)}function GA(i){const t=Vm(i);return t.length===4?Pe.emptyPath():km(t)}function ah(i){return new Pe(["projects",i.databaseId.projectId,"databases",i.databaseId.database]).canonicalString()}function km(i){return _e(i.length>4&&i.get(4)==="documents",29091,{key:i.toString()}),i.popFirst(5)}function Pf(i,t,e){return{name:oh(i,t),fields:e.value.mapValue.fields}}function WA(i,t){let e;if("targetChange"in t){t.targetChange;const n=function(h){return h==="NO_CHANGE"?0:h==="ADD"?1:h==="REMOVE"?2:h==="CURRENT"?3:h==="RESET"?4:Bt(39313,{state:h})}(t.targetChange.targetChangeType||"NO_CHANGE"),r=t.targetChange.targetIds||[],s=function(h,u){return h.useProto3Json?(_e(u===void 0||typeof u=="string",58123),Je.fromBase64String(u||"")):(_e(u===void 0||u instanceof Buffer||u instanceof Uint8Array,16193),Je.fromUint8Array(u||new Uint8Array))}(i,t.targetChange.resumeToken),o=t.targetChange.cause,l=o&&function(h){const u=h.code===void 0?st.UNKNOWN:Nm(h.code);return new It(u,h.message||"")}(o);e=new Fm(n,r,s,l||null)}else if("documentChange"in t){t.documentChange;const n=t.documentChange;n.document,n.document.name,n.document.updateTime;const r=Ql(i,n.document.name),s=Yn(n.document.updateTime),o=n.document.createTime?Yn(n.document.createTime):Gt.min(),l=new Cn({mapValue:{fields:n.document.fields}}),c=ln.newFoundDocument(r,s,o,l),h=n.targetIds||[],u=n.removedTargetIds||[];e=new Ta(h,u,c.key,c)}else if("documentDelete"in t){t.documentDelete;const n=t.documentDelete;n.document;const r=Ql(i,n.document),s=n.readTime?Yn(n.readTime):Gt.min(),o=ln.newNoDocument(r,s),l=n.removedTargetIds||[];e=new Ta([],l,o.key,o)}else if("documentRemove"in t){t.documentRemove;const n=t.documentRemove;n.document;const r=Ql(i,n.document),s=n.removedTargetIds||[];e=new Ta([],s,r,null)}else{if(!("filter"in t))return Bt(11601,{Vt:t});{t.filter;const n=t.filter;n.targetId;const{count:r=0,unchangedNames:s}=n,o=new NA(r,s),l=n.targetId;e=new Um(l,o)}}return e}function qA(i,t){let e;if(t instanceof vo)e={update:Pf(i,t.key,t.value)};else if(t instanceof Lm)e={delete:oh(i,t.key)};else if(t instanceof xr)e={update:Pf(i,t.key,t.data),updateMask:tw(t.fieldMask)};else{if(!(t instanceof PA))return Bt(16599,{ft:t.type});e={verify:oh(i,t.key)}}return t.fieldTransforms.length>0&&(e.updateTransforms=t.fieldTransforms.map(n=>function(s,o){const l=o.transform;if(l instanceof Fa)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof ds)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof ho)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof Oa)return{fieldPath:o.field.canonicalString(),increment:l.Re};throw Bt(20930,{transform:o.transform})}(0,n))),t.precondition.isNone||(e.currentDocument=function(r,s){return s.updateTime!==void 0?{updateTime:HA(r,s.updateTime)}:s.exists!==void 0?{exists:s.exists}:Bt(27497)}(i,t.precondition)),e}function XA(i,t){return i&&i.length>0?(_e(t!==void 0,14353),i.map(e=>function(r,s){let o=r.updateTime?Yn(r.updateTime):Yn(s);return o.isEqual(Gt.min())&&(o=Yn(s)),new RA(o,r.transformResults||[])}(e,t))):[]}function $A(i,t){return{documents:[Bm(i,t.path)]}}function jA(i,t){const e={structuredQuery:{}},n=t.path;let r;t.collectionGroup!==null?(r=n,e.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(r=n.popLast(),e.structuredQuery.from=[{collectionId:n.lastSegment()}]),e.parent=Bm(i,r);const s=function(h){if(h.length!==0)return Hm(Jn.create(h,"and"))}(t.filters);s&&(e.structuredQuery.where=s);const o=function(h){if(h.length!==0)return h.map(u=>function(m){return{field:Xr(m.field),direction:QA(m.dir)}}(u))}(t.orderBy);o&&(e.structuredQuery.orderBy=o);const l=rh(i,t.limit);return l!==null&&(e.structuredQuery.limit=l),t.startAt&&(e.structuredQuery.startAt=function(h){return{before:h.inclusive,values:h.position}}(t.startAt)),t.endAt&&(e.structuredQuery.endAt=function(h){return{before:!h.inclusive,values:h.position}}(t.endAt)),{gt:e,parent:r}}function YA(i){let t=GA(i.parent);const e=i.structuredQuery,n=e.from?e.from.length:0;let r=null;if(n>0){_e(n===1,65062);const u=e.from[0];u.allDescendants?r=u.collectionId:t=t.child(u.collectionId)}let s=[];e.where&&(s=function(d){const m=zm(d);return m instanceof Jn&&gm(m)?m.getFilters():[m]}(e.where));let o=[];e.orderBy&&(o=function(d){return d.map(m=>function(x){return new Ua($r(x.field),function(g){switch(g){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(x.direction))}(m))}(e.orderBy));let l=null;e.limit&&(l=function(d){let m;return m=typeof d=="object"?d.value:d,Ya(m)?null:m}(e.limit));let c=null;e.startAt&&(c=function(d){const m=!!d.before,_=d.values||[];return new Na(_,m)}(e.startAt));let h=null;return e.endAt&&(h=function(d){const m=!d.before,_=d.values||[];return new Na(_,m)}(e.endAt)),fA(t,r,o,s,l,"F",c,h)}function KA(i,t){const e=function(r){switch(r){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return Bt(28987,{purpose:r})}}(t.purpose);return e==null?null:{"goog-listen-tags":e}}function zm(i){return i.unaryFilter!==void 0?function(e){switch(e.unaryFilter.op){case"IS_NAN":const n=$r(e.unaryFilter.field);return He.create(n,"==",{doubleValue:NaN});case"IS_NULL":const r=$r(e.unaryFilter.field);return He.create(r,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const s=$r(e.unaryFilter.field);return He.create(s,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=$r(e.unaryFilter.field);return He.create(o,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return Bt(61313);default:return Bt(60726)}}(i):i.fieldFilter!==void 0?function(e){return He.create($r(e.fieldFilter.field),function(r){switch(r){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return Bt(58110);default:return Bt(50506)}}(e.fieldFilter.op),e.fieldFilter.value)}(i):i.compositeFilter!==void 0?function(e){return Jn.create(e.compositeFilter.filters.map(n=>zm(n)),function(r){switch(r){case"AND":return"and";case"OR":return"or";default:return Bt(1026)}}(e.compositeFilter.op))}(i):Bt(30097,{filter:i})}function QA(i){return VA[i]}function ZA(i){return BA[i]}function JA(i){return kA[i]}function Xr(i){return{fieldPath:i.canonicalString()}}function $r(i){return Ze.fromServerFormat(i.fieldPath)}function Hm(i){return i instanceof He?function(e){if(e.op==="=="){if(vf(e.value))return{unaryFilter:{field:Xr(e.field),op:"IS_NAN"}};if(_f(e.value))return{unaryFilter:{field:Xr(e.field),op:"IS_NULL"}}}else if(e.op==="!="){if(vf(e.value))return{unaryFilter:{field:Xr(e.field),op:"IS_NOT_NAN"}};if(_f(e.value))return{unaryFilter:{field:Xr(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Xr(e.field),op:ZA(e.op),value:e.value}}}(i):i instanceof Jn?function(e){const n=e.getFilters().map(r=>Hm(r));return n.length===1?n[0]:{compositeFilter:{op:JA(e.op),filters:n}}}(i):Bt(54877,{filter:i})}function tw(i){const t=[];return i.fields.forEach(e=>t.push(e.canonicalString())),{fieldPaths:t}}function Gm(i){return i.length>=4&&i.get(0)==="projects"&&i.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ew{constructor(t){this.wt=t}}function nw(i){const t=YA({parent:i.parent,structuredQuery:i.structuredQuery});return i.limitType==="LAST"?ih(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vn.DEFAULT_COLLECTION_PERCENTILE=10,vn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,vn.DEFAULT=new vn(Wm,vn.DEFAULT_COLLECTION_PERCENTILE,vn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),vn.DISABLED=new vn(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hw{constructor(){this.changes=new Er(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,ln.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return n!==void 0?J.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uw{constructor(t,e){this.overlayedDocument=t,this.mutatedFields=e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mw{constructor(){this.sessionToken=Je.EMPTY_BYTE_STRING}getSessionToken(t){return J.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,J.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _w{constructor(t){this.Zr=t,this.docs=function(){return new De(Lt.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,r=this.docs.get(n),s=r?r.size:0,o=this.Zr(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:o}),this.size+=o-s,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return J.resolve(n?n.document.mutableCopy():ln.newInvalidDocument(e))}getEntries(t,e){let n=vi();return e.forEach(r=>{const s=this.docs.get(r);n=n.insert(r,s?s.document.mutableCopy():ln.newInvalidDocument(r))}),J.resolve(n)}getDocumentsMatchingQuery(t,e,n,r){let s=vi();const o=e.path,l=new Lt(o.child("__id-9223372036854775808__")),c=this.docs.getIteratorFrom(l);for(;c.hasNext();){const{key:h,value:{document:u}}=c.getNext();if(!o.isPrefixOf(h.path))break;h.path.length>o.length+1||qM(WM(u),n)<=0||(r.has(u.key)||Ja(e,u))&&(s=s.insert(u.key,u.mutableCopy()))}return J.resolve(s)}getAllFromCollectionGroup(t,e,n,r){Bt(9500)}Xr(t,e){return J.forEach(this.docs,n=>e(n))}newChangeBuffer(t){return new vw(this)}getSize(t){return J.resolve(this.size)}}class vw extends hw{constructor(t){super(),this.vr=t}applyChanges(t){const e=[];return this.changes.forEach((n,r)=>{r.isValidDocument()?e.push(this.vr.addEntry(t,r)):this.vr.removeEntry(n)}),J.waitFor(e)}getFromCache(t,e){return this.vr.getEntry(t,e)}getAllFromCache(t,e){return this.vr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qh{constructor(t,e,n,r){this.targetId=t,this.fromCache=e,this.ls=n,this.hs=r}static Ps(t,e){let n=se(),r=se();for(const s of e.docChanges)switch(s.type){case 0:n=n.add(s.doc.key);break;case 1:r=r.add(s.doc.key)}return new qh(t,e.fromCache,n,r)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tw{constructor(){this.Ts=!1,this.Is=!1,this.Es=100,this.ds=function(){return fS()?8:jM(uS())>0?6:4}()}initialize(t,e){this.As=t,this.indexManager=e,this.Ts=!0}getDocumentsMatchingQuery(t,e,n,r){const s={result:null};return this.Rs(t,e).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Vs(t,e,r,n).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new xw;return this.fs(t,e,o).next(l=>{if(s.result=l,this.Is)return this.gs(t,e,o,l.size)})}).next(()=>s.result)}gs(t,e,n,r){return n.documentReadCount<this.Es?(Wr()<=ue.DEBUG&&xt("QueryEngine","SDK will not create cache indexes for query:",qr(e),"since it only creates cache indexes for collection contains","more than or equal to",this.Es,"documents"),J.resolve()):(Wr()<=ue.DEBUG&&xt("QueryEngine","Query:",qr(e),"scans",n.documentReadCount,"local documents and returns",r,"documents as results."),n.documentReadCount>this.ds*r?(Wr()<=ue.DEBUG&&xt("QueryEngine","The SDK decides to create cache indexes for query:",qr(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,jn(e))):J.resolve())}Rs(t,e){if(Tf(e))return J.resolve(null);let n=jn(e);return this.indexManager.getIndexType(t,n).next(r=>r===0?null:(e.limit!==null&&r===1&&(e=ih(e,null,"F"),n=jn(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next(s=>{const o=se(...s);return this.As.getDocuments(t,o).next(l=>this.indexManager.getMinOffset(t,n).next(c=>{const h=this.ps(e,l);return this.ys(e,h,o,c.readTime)?this.Rs(t,ih(e,null,"F")):this.ws(t,h,e,c)}))})))}Vs(t,e,n,r){return Tf(e)||r.isEqual(Gt.min())?J.resolve(null):this.As.getDocuments(t,n).next(s=>{const o=this.ps(e,s);return this.ys(e,o,n,r)?J.resolve(null):(Wr()<=ue.DEBUG&&xt("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),qr(e)),this.ws(t,o,e,GM(r,oo)).next(l=>l))})}ps(t,e){let n=new We(Tm(t));return e.forEach((r,s)=>{Ja(t,s)&&(n=n.add(s))}),n}ys(t,e,n,r){if(t.limit===null)return!1;if(n.size!==e.size)return!0;const s=t.limitType==="F"?e.last():e.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(r)>0)}fs(t,e,n){return Wr()<=ue.DEBUG&&xt("QueryEngine","Using full collection scan to execute query:",qr(e)),this.As.getDocumentsMatchingQuery(t,e,Hi.min(),n)}ws(t,e,n,r){return this.As.getDocumentsMatchingQuery(t,n,r).next(s=>(e.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xh="LocalStore",Sw=3e8;class Mw{constructor(t,e,n,r){this.persistence=t,this.bs=e,this.serializer=r,this.Ss=new De(Zt),this.Ds=new Er(s=>Oh(s),Vh),this.vs=new Map,this.Cs=t.getRemoteDocumentCache(),this.ai=t.getTargetCache(),this.ci=t.getBundleCache(),this.Fs(n)}Fs(t){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new dw(this.Cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Cs.setIndexManager(this.indexManager),this.bs.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",e=>t.collect(e,this.Ss))}}function Aw(i,t,e,n){return new Mw(i,t,e,n)}async function Xm(i,t){const e=$t(i);return await e.persistence.runTransaction("Handle user change","readonly",n=>{let r;return e.mutationQueue.getAllMutationBatches(n).next(s=>(r=s,e.Fs(t),e.mutationQueue.getAllMutationBatches(n))).next(s=>{const o=[],l=[];let c=se();for(const h of r){o.push(h.batchId);for(const u of h.mutations)c=c.add(u.key)}for(const h of s){l.push(h.batchId);for(const u of h.mutations)c=c.add(u.key)}return e.localDocuments.getDocuments(n,c).next(h=>({Ms:h,removedBatchIds:o,addedBatchIds:l}))})})}function ww(i,t){const e=$t(i);return e.persistence.runTransaction("Acknowledge batch","readwrite-primary",n=>{const r=t.batch.keys(),s=e.Cs.newChangeBuffer({trackRemovals:!0});return function(l,c,h,u){const d=h.batch,m=d.keys();let _=J.resolve();return m.forEach(x=>{_=_.next(()=>u.getEntry(c,x)).next(M=>{const g=h.docVersions.get(x);_e(g!==null,48541),M.version.compareTo(g)<0&&(d.applyToRemoteDocument(M,h),M.isValidDocument()&&(M.setReadTime(h.commitVersion),u.addEntry(M)))})}),_.next(()=>l.mutationQueue.removeMutationBatch(c,d))}(e,n,t,s).next(()=>s.apply(n)).next(()=>e.mutationQueue.performConsistencyCheck(n)).next(()=>e.documentOverlayCache.removeOverlaysForBatchId(n,r,t.batch.batchId)).next(()=>e.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,function(l){let c=se();for(let h=0;h<l.mutationResults.length;++h)l.mutationResults[h].transformResults.length>0&&(c=c.add(l.batch.mutations[h].key));return c}(t))).next(()=>e.localDocuments.getDocuments(n,r))})}function $m(i){const t=$t(i);return t.persistence.runTransaction("Get last remote snapshot version","readonly",e=>t.ai.getLastRemoteSnapshotVersion(e))}function bw(i,t){const e=$t(i),n=t.snapshotVersion;let r=e.Ss;return e.persistence.runTransaction("Apply remote event","readwrite-primary",s=>{const o=e.Cs.newChangeBuffer({trackRemovals:!0});r=e.Ss;const l=[];t.targetChanges.forEach((u,d)=>{const m=r.get(d);if(!m)return;l.push(e.ai.removeMatchingKeys(s,u.removedDocuments,d).next(()=>e.ai.addMatchingKeys(s,u.addedDocuments,d)));let _=m.withSequenceNumber(s.currentSequenceNumber);t.targetMismatches.get(d)!==null?_=_.withResumeToken(Je.EMPTY_BYTE_STRING,Gt.min()).withLastLimboFreeSnapshotVersion(Gt.min()):u.resumeToken.approximateByteSize()>0&&(_=_.withResumeToken(u.resumeToken,n)),r=r.insert(d,_),function(M,g,p){return M.resumeToken.approximateByteSize()===0||g.snapshotVersion.toMicroseconds()-M.snapshotVersion.toMicroseconds()>=Sw?!0:p.addedDocuments.size+p.modifiedDocuments.size+p.removedDocuments.size>0}(m,_,u)&&l.push(e.ai.updateTargetData(s,_))});let c=vi(),h=se();if(t.documentUpdates.forEach(u=>{t.resolvedLimboDocuments.has(u)&&l.push(e.persistence.referenceDelegate.updateLimboDocument(s,u))}),l.push(Rw(s,o,t.documentUpdates).next(u=>{c=u.xs,h=u.Os})),!n.isEqual(Gt.min())){const u=e.ai.getLastRemoteSnapshotVersion(s).next(d=>e.ai.setTargetsMetadata(s,s.currentSequenceNumber,n));l.push(u)}return J.waitFor(l).next(()=>o.apply(s)).next(()=>e.localDocuments.getLocalViewOfDocuments(s,c,h)).next(()=>c)}).then(s=>(e.Ss=r,s))}function Rw(i,t,e){let n=se(),r=se();return e.forEach(s=>n=n.add(s)),t.getEntries(i,n).next(s=>{let o=vi();return e.forEach((l,c)=>{const h=s.get(l);c.isFoundDocument()!==h.isFoundDocument()&&(r=r.add(l)),c.isNoDocument()&&c.version.isEqual(Gt.min())?(t.removeEntry(l,c.readTime),o=o.insert(l,c)):!h.isValidDocument()||c.version.compareTo(h.version)>0||c.version.compareTo(h.version)===0&&h.hasPendingWrites?(t.addEntry(c),o=o.insert(l,c)):xt(Xh,"Ignoring outdated watch update for ",l,". Current version:",h.version," Watch version:",c.version)}),{xs:o,Os:r}})}function Cw(i,t){const e=$t(i);return e.persistence.runTransaction("Get next mutation batch","readonly",n=>(t===void 0&&(t=Nh),e.mutationQueue.getNextMutationBatchAfterBatchId(n,t)))}function Iw(i,t){const e=$t(i);return e.persistence.runTransaction("Allocate target","readwrite",n=>{let r;return e.ai.getTargetData(n,t).next(s=>s?(r=s,J.resolve(r)):e.ai.allocateTargetId(n).next(o=>(r=new Di(t,o,"TargetPurposeListen",n.currentSequenceNumber),e.ai.addTargetData(n,r).next(()=>r))))}).then(n=>{const r=e.Ss.get(n.targetId);return(r===null||n.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(e.Ss=e.Ss.insert(n.targetId,n),e.Ds.set(t,n.targetId)),n})}async function lh(i,t,e){const n=$t(i),r=n.Ss.get(t),s=e?"readwrite":"readwrite-primary";try{e||await n.persistence.runTransaction("Release target",s,o=>n.persistence.referenceDelegate.removeTarget(o,r))}catch(o){if(!Es(o))throw o;xt(Xh,`Failed to update sequence numbers for target ${t}: ${o}`)}n.Ss=n.Ss.remove(t),n.Ds.delete(r.target)}function Uf(i,t,e){const n=$t(i);let r=Gt.min(),s=se();return n.persistence.runTransaction("Execute query","readwrite",o=>function(c,h,u){const d=$t(c),m=d.Ds.get(u);return m!==void 0?J.resolve(d.Ss.get(m)):d.ai.getTargetData(h,u)}(n,o,jn(t)).next(l=>{if(l)return r=l.lastLimboFreeSnapshotVersion,n.ai.getMatchingKeysForTargetId(o,l.targetId).next(c=>{s=c})}).next(()=>n.bs.getDocumentsMatchingQuery(o,t,e?r:Gt.min(),e?s:se())).next(l=>(Pw(n,gA(t),l),{documents:l,Ns:s})))}function Pw(i,t,e){let n=i.vs.get(t)||Gt.min();e.forEach((r,s)=>{s.readTime.compareTo(n)>0&&(n=s.readTime)}),i.vs.set(t,n)}class Ff{constructor(){this.activeTargetIds=TA()}$s(t){this.activeTargetIds=this.activeTargetIds.add(t)}Us(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Qs(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class Dw{constructor(){this.So=new Ff,this.Do={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,e,n){}addLocalQueryTarget(t,e=!0){return e&&this.So.$s(t),this.Do[t]||"not-current"}updateQueryState(t,e,n){this.Do[t]=e}removeLocalQueryTarget(t){this.So.Us(t)}isLocalQueryTarget(t){return this.So.activeTargetIds.has(t)}clearQueryState(t){delete this.Do[t]}getAllActiveQueryTargets(){return this.So.activeTargetIds}isActiveQueryTarget(t){return this.So.activeTargetIds.has(t)}start(){return this.So=new Ff,Promise.resolve()}handleUserChange(t,e,n){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(t){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zl="RestConnection",Nw={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class Uw{get Bo(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Lo=e+"://"+t.host,this.ko=`projects/${n}/databases/${r}`,this.qo=this.databaseId.database===Da?`project_id=${n}`:`project_id=${n}&database_id=${r}`}Qo(t,e,n,r,s){const o=ch(),l=this.$o(t,e.toUriEncodedString());xt(Zl,`Sending RPC '${t}' ${o}:`,l,n);const c={"google-cloud-resource-prefix":this.ko,"x-goog-request-params":this.qo};this.Uo(c,r,s);const{host:h}=new URL(l),u=zp(h);return this.Ko(t,l,c,n,u).then(d=>(xt(Zl,`Received RPC '${t}' ${o}: `,d),d),d=>{throw ls(Zl,`RPC '${t}' ${o} failed with error: `,d,"url: ",l,"request:",n),d})}Wo(t,e,n,r,s,o){return this.Qo(t,e,n,r,s)}Uo(t,e,n){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+vs}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((r,s)=>t[s]=r),n&&n.headers.forEach((r,s)=>t[s]=r)}$o(t,e){const n=Nw[t];return`${this.Lo}/v1/${e}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fw{constructor(t){this.Go=t.Go,this.zo=t.zo}jo(t){this.Ho=t}Jo(t){this.Yo=t}Zo(t){this.Xo=t}onMessage(t){this.e_=t}close(){this.zo()}send(t){this.Go(t)}t_(){this.Ho()}n_(){this.Yo()}r_(t){this.Xo(t)}i_(t){this.e_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on="WebChannelConnection";class Ow extends Uw{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Ko(t,e,n,r,s){const o=ch();return new Promise((l,c)=>{const h=new Yp;h.setWithCredentials(!0),h.listenOnce(Kp.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case va.NO_ERROR:const d=h.getResponseJson();xt(on,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(d)),l(d);break;case va.TIMEOUT:xt(on,`RPC '${t}' ${o} timed out`),c(new It(st.DEADLINE_EXCEEDED,"Request time out"));break;case va.HTTP_ERROR:const m=h.getStatus();if(xt(on,`RPC '${t}' ${o} failed with status:`,m,"response text:",h.getResponseText()),m>0){let _=h.getResponseJson();Array.isArray(_)&&(_=_[0]);const x=_==null?void 0:_.error;if(x&&x.status&&x.message){const M=function(p){const I=p.toLowerCase().replace(/_/g,"-");return Object.values(st).indexOf(I)>=0?I:st.UNKNOWN}(x.status);c(new It(M,x.message))}else c(new It(st.UNKNOWN,"Server responded with status "+h.getStatus()))}else c(new It(st.UNAVAILABLE,"Connection failed."));break;default:Bt(9055,{s_:t,streamId:o,o_:h.getLastErrorCode(),__:h.getLastError()})}}finally{xt(on,`RPC '${t}' ${o} completed.`)}});const u=JSON.stringify(r);xt(on,`RPC '${t}' ${o} sending request:`,r),h.send(e,"POST",u,n,15)})}a_(t,e,n){const r=ch(),s=[this.Lo,"/","google.firestore.v1.Firestore","/",t,"/channel"],o=Jp(),l=Zp(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(c.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Uo(c.initMessageHeaders,e,n),c.encodeInitMessageHeaders=!0;const u=s.join("");xt(on,`Creating RPC '${t}' stream ${r}: ${u}`,c);const d=o.createWebChannel(u,c);let m=!1,_=!1;const x=new Fw({Go:g=>{_?xt(on,`Not sending because RPC '${t}' stream ${r} is closed:`,g):(m||(xt(on,`Opening RPC '${t}' stream ${r} transport.`),d.open(),m=!0),xt(on,`RPC '${t}' stream ${r} sending:`,g),d.send(g))},zo:()=>d.close()}),M=(g,p,I)=>{g.listen(p,D=>{try{I(D)}catch(P){setTimeout(()=>{throw P},0)}})};return M(d,Hs.EventType.OPEN,()=>{_||(xt(on,`RPC '${t}' stream ${r} transport opened.`),x.t_())}),M(d,Hs.EventType.CLOSE,()=>{_||(_=!0,xt(on,`RPC '${t}' stream ${r} transport closed`),x.r_())}),M(d,Hs.EventType.ERROR,g=>{_||(_=!0,ls(on,`RPC '${t}' stream ${r} transport errored. Name:`,g.name,"Message:",g.message),x.r_(new It(st.UNAVAILABLE,"The operation could not be completed")))}),M(d,Hs.EventType.MESSAGE,g=>{var p;if(!_){const I=g.data[0];_e(!!I,16349);const D=I,P=(D==null?void 0:D.error)||((p=D[0])===null||p===void 0?void 0:p.error);if(P){xt(on,`RPC '${t}' stream ${r} received error:`,P);const V=P.status;let F=function(y){const v=Oe[y];if(v!==void 0)return Nm(v)}(V),S=P.message;F===void 0&&(F=st.INTERNAL,S="Unknown error status: "+V+" with message "+P.message),_=!0,x.r_(new It(F,S)),d.close()}else xt(on,`RPC '${t}' stream ${r} received:`,I),x.i_(I)}}),M(l,Qp.STAT_EVENT,g=>{g.stat===Qc.PROXY?xt(on,`RPC '${t}' stream ${r} detected buffering proxy`):g.stat===Qc.NOPROXY&&xt(on,`RPC '${t}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{x.n_()},0),x}}function Jl(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function il(i){return new zA(i,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bf="PersistentStream";class Ym{constructor(t,e,n,r,s,o,l,c){this.bi=t,this.R_=n,this.V_=r,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=l,this.listener=c,this.state=0,this.m_=0,this.f_=null,this.g_=null,this.stream=null,this.p_=0,this.y_=new jm(t,e)}w_(){return this.state===1||this.state===5||this.b_()}b_(){return this.state===2||this.state===3}start(){this.p_=0,this.state!==4?this.auth():this.S_()}async stop(){this.w_()&&await this.close(0)}D_(){this.state=0,this.y_.reset()}v_(){this.b_()&&this.f_===null&&(this.f_=this.bi.enqueueAfterDelay(this.R_,6e4,()=>this.C_()))}F_(t){this.M_(),this.stream.send(t)}async C_(){if(this.b_())return this.close(0)}M_(){this.f_&&(this.f_.cancel(),this.f_=null)}x_(){this.g_&&(this.g_.cancel(),this.g_=null)}async close(t,e){this.M_(),this.x_(),this.y_.cancel(),this.m_++,t!==4?this.y_.reset():e&&e.code===st.RESOURCE_EXHAUSTED?(_i(e.toString()),_i("Using maximum backoff delay to prevent overloading the backend."),this.y_.I_()):e&&e.code===st.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.O_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.Zo(e)}O_(){}auth(){this.state=1;const t=this.N_(this.m_),e=this.m_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,r])=>{this.m_===e&&this.B_(n,r)},n=>{t(()=>{const r=new It(st.UNKNOWN,"Fetching auth token failed: "+n.message);return this.L_(r)})})}B_(t,e){const n=this.N_(this.m_);this.stream=this.k_(t,e),this.stream.jo(()=>{n(()=>this.listener.jo())}),this.stream.Jo(()=>{n(()=>(this.state=2,this.g_=this.bi.enqueueAfterDelay(this.V_,1e4,()=>(this.b_()&&(this.state=3),Promise.resolve())),this.listener.Jo()))}),this.stream.Zo(r=>{n(()=>this.L_(r))}),this.stream.onMessage(r=>{n(()=>++this.p_==1?this.q_(r):this.onNext(r))})}S_(){this.state=5,this.y_.E_(async()=>{this.state=0,this.start()})}L_(t){return xt(Bf,`close with error: ${t}`),this.stream=null,this.close(4,t)}N_(t){return e=>{this.bi.enqueueAndForget(()=>this.m_===t?e():(xt(Bf,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class Vw extends Ym{constructor(t,e,n,r,s,o){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}k_(t,e){return this.connection.a_("Listen",t,e)}q_(t){return this.onNext(t)}onNext(t){this.y_.reset();const e=WA(this.serializer,t),n=function(s){if(!("targetChange"in s))return Gt.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?Gt.min():o.readTime?Yn(o.readTime):Gt.min()}(t);return this.listener.Q_(e,n)}U_(t){const e={};e.database=ah(this.serializer),e.addTarget=function(s,o){let l;const c=o.target;if(l=nh(c)?{documents:$A(s,c)}:{query:jA(s,c).gt},l.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){l.resumeToken=Om(s,o.resumeToken);const h=rh(s,o.expectedCount);h!==null&&(l.expectedCount=h)}else if(o.snapshotVersion.compareTo(Gt.min())>0){l.readTime=Va(s,o.snapshotVersion.toTimestamp());const h=rh(s,o.expectedCount);h!==null&&(l.expectedCount=h)}return l}(this.serializer,t);const n=KA(this.serializer,t);n&&(e.labels=n),this.F_(e)}K_(t){const e={};e.database=ah(this.serializer),e.removeTarget=t,this.F_(e)}}class Bw extends Ym{constructor(t,e,n,r,s,o){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}get W_(){return this.p_>0}start(){this.lastStreamToken=void 0,super.start()}O_(){this.W_&&this.G_([])}k_(t,e){return this.connection.a_("Write",t,e)}q_(t){return _e(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,_e(!t.writeResults||t.writeResults.length===0,55816),this.listener.z_()}onNext(t){_e(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.y_.reset();const e=XA(t.writeResults,t.commitTime),n=Yn(t.commitTime);return this.listener.j_(n,e)}H_(){const t={};t.database=ah(this.serializer),this.F_(t)}G_(t){const e={streamToken:this.lastStreamToken,writes:t.map(n=>qA(this.serializer,n))};this.F_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r="RemoteStore";class Gw{constructor(t,e,n,r,s){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.oa=[],this._a=new Map,this.aa=new Set,this.ua=[],this.ca=s,this.ca.vo(o=>{n.enqueueAndForget(async()=>{Tr(this)&&(xt(_r,"Restarting streams for network reachability change."),await async function(c){const h=$t(c);h.aa.add(4),await Eo(h),h.la.set("Unknown"),h.aa.delete(4),await rl(h)}(this))})}),this.la=new Hw(n,r)}}async function rl(i){if(Tr(i))for(const t of i.ua)await t(!0)}async function Eo(i){for(const t of i.ua)await t(!1)}function Km(i,t){const e=$t(i);e._a.has(t.targetId)||(e._a.set(t.targetId,t),Kh(e)?Yh(e):xs(e).b_()&&jh(e,t))}function $h(i,t){const e=$t(i),n=xs(e);e._a.delete(t),n.b_()&&Qm(e,t),e._a.size===0&&(n.b_()?n.v_():Tr(e)&&e.la.set("Unknown"))}function jh(i,t){if(i.ha.Ke(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(Gt.min())>0){const e=i.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}xs(i).U_(t)}function Qm(i,t){i.ha.Ke(t),xs(i).K_(t)}function Yh(i){i.ha=new OA({getRemoteKeysForTarget:t=>i.remoteSyncer.getRemoteKeysForTarget(t),Rt:t=>i._a.get(t)||null,Pt:()=>i.datastore.serializer.databaseId}),xs(i).start(),i.la.ta()}function Kh(i){return Tr(i)&&!xs(i).w_()&&i._a.size>0}function Tr(i){return $t(i).aa.size===0}function Zm(i){i.ha=void 0}async function Ww(i){i.la.set("Online")}async function qw(i){i._a.forEach((t,e)=>{jh(i,t)})}async function Xw(i,t){Zm(i),Kh(i)?(i.la.ia(t),Yh(i)):i.la.set("Unknown")}async function $w(i,t,e){if(i.la.set("Online"),t instanceof Fm&&t.state===2&&t.cause)try{await async function(r,s){const o=s.cause;for(const l of s.targetIds)r._a.has(l)&&(await r.remoteSyncer.rejectListen(l,o),r._a.delete(l),r.ha.removeTarget(l))}(i,t)}catch(n){xt(_r,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await ka(i,n)}else if(t instanceof Ta?i.ha.Xe(t):t instanceof Um?i.ha.ot(t):i.ha.nt(t),!e.isEqual(Gt.min()))try{const n=await $m(i.localStore);e.compareTo(n)>=0&&await function(s,o){const l=s.ha.It(o);return l.targetChanges.forEach((c,h)=>{if(c.resumeToken.approximateByteSize()>0){const u=s._a.get(h);u&&s._a.set(h,u.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,h)=>{const u=s._a.get(c);if(!u)return;s._a.set(c,u.withResumeToken(Je.EMPTY_BYTE_STRING,u.snapshotVersion)),Qm(s,c);const d=new Di(u.target,c,h,u.sequenceNumber);jh(s,d)}),s.remoteSyncer.applyRemoteEvent(l)}(i,e)}catch(n){xt(_r,"Failed to raise snapshot:",n),await ka(i,n)}}async function ka(i,t,e){if(!Es(t))throw t;i.aa.add(1),await Eo(i),i.la.set("Offline"),e||(e=()=>$m(i.localStore)),i.asyncQueue.enqueueRetryable(async()=>{xt(_r,"Retrying IndexedDB access"),await e(),i.aa.delete(1),await rl(i)})}function Jm(i,t){return t().catch(e=>ka(i,e,t))}async function sl(i){const t=$t(i),e=Xi(t);let n=t.oa.length>0?t.oa[t.oa.length-1].batchId:Nh;for(;jw(t);)try{const r=await Cw(t.localStore,n);if(r===null){t.oa.length===0&&e.v_();break}n=r.batchId,Yw(t,r)}catch(r){await ka(t,r)}tg(t)&&eg(t)}function jw(i){return Tr(i)&&i.oa.length<10}function Yw(i,t){i.oa.push(t);const e=Xi(i);e.b_()&&e.W_&&e.G_(t.mutations)}function tg(i){return Tr(i)&&!Xi(i).w_()&&i.oa.length>0}function eg(i){Xi(i).start()}async function Kw(i){Xi(i).H_()}async function Qw(i){const t=Xi(i);for(const e of i.oa)t.G_(e.mutations)}async function Zw(i,t,e){const n=i.oa.shift(),r=kh.from(n,t,e);await Jm(i,()=>i.remoteSyncer.applySuccessfulWrite(r)),await sl(i)}async function Jw(i,t){t&&Xi(i).W_&&await async function(n,r){if(function(o){return UA(o)&&o!==st.ABORTED}(r.code)){const s=n.oa.shift();Xi(n).D_(),await Jm(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await sl(n)}}(i,t),tg(i)&&eg(i)}async function kf(i,t){const e=$t(i);e.asyncQueue.verifyOperationInProgress(),xt(_r,"RemoteStore received new credentials");const n=Tr(e);e.aa.add(3),await Eo(e),n&&e.la.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.aa.delete(3),await rl(e)}async function tb(i,t){const e=$t(i);t?(e.aa.delete(2),await rl(e)):t||(e.aa.add(2),await Eo(e),e.la.set("Unknown"))}function xs(i){return i.Pa||(i.Pa=function(e,n,r){const s=$t(e);return s.Y_(),new Vw(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{jo:Ww.bind(null,i),Jo:qw.bind(null,i),Zo:Xw.bind(null,i),Q_:$w.bind(null,i)}),i.ua.push(async t=>{t?(i.Pa.D_(),Kh(i)?Yh(i):i.la.set("Unknown")):(await i.Pa.stop(),Zm(i))})),i.Pa}function Xi(i){return i.Ta||(i.Ta=function(e,n,r){const s=$t(e);return s.Y_(),new Bw(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{jo:()=>Promise.resolve(),Jo:Kw.bind(null,i),Zo:Jw.bind(null,i),z_:Qw.bind(null,i),j_:Zw.bind(null,i)}),i.ua.push(async t=>{t?(i.Ta.D_(),await sl(i)):(await i.Ta.stop(),i.oa.length>0&&(xt(_r,`Stopping write stream with ${i.oa.length} pending writes`),i.oa=[]))})),i.Ta}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ng{constructor(t){this.key=t}}class ig{constructor(t){this.key=t}}class lb{constructor(t,e){this.query=t,this.qa=e,this.Qa=null,this.hasCachedResults=!1,this.current=!1,this.$a=se(),this.mutatedKeys=se(),this.Ua=Tm(t),this.Ka=new ns(this.Ua)}get Wa(){return this.qa}Ga(t,e){const n=e?e.za:new zf,r=e?e.Ka:this.Ka;let s=e?e.mutatedKeys:this.mutatedKeys,o=r,l=!1;const c=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,h=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal((u,d)=>{const m=r.get(u),_=Ja(this.query,d)?d:null,x=!!m&&this.mutatedKeys.has(m.key),M=!!_&&(_.hasLocalMutations||this.mutatedKeys.has(_.key)&&_.hasCommittedMutations);let g=!1;m&&_?m.data.isEqual(_.data)?x!==M&&(n.track({type:3,doc:_}),g=!0):this.ja(m,_)||(n.track({type:2,doc:_}),g=!0,(c&&this.Ua(_,c)>0||h&&this.Ua(_,h)<0)&&(l=!0)):!m&&_?(n.track({type:0,doc:_}),g=!0):m&&!_&&(n.track({type:1,doc:m}),g=!0,(c||h)&&(l=!0)),g&&(_?(o=o.add(_),s=M?s.add(u):s.delete(u)):(o=o.delete(u),s=s.delete(u)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const u=this.query.limitType==="F"?o.last():o.first();o=o.delete(u.key),s=s.delete(u.key),n.track({type:1,doc:u})}return{Ka:o,za:n,ys:l,mutatedKeys:s}}ja(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,r){const s=this.Ka;this.Ka=t.Ka,this.mutatedKeys=t.mutatedKeys;const o=t.za.da();o.sort((u,d)=>function(_,x){const M=g=>{switch(g){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Bt(20277,{Vt:g})}};return M(_)-M(x)}(u.type,d.type)||this.Ua(u.doc,d.doc)),this.Ha(n),r=r!=null&&r;const l=e&&!r?this.Ja():[],c=this.$a.size===0&&this.current&&!r?1:0,h=c!==this.Qa;return this.Qa=c,o.length!==0||h?{snapshot:new ps(this.query,t.Ka,s,o,t.mutatedKeys,c===0,h,!1,!!n&&n.resumeToken.approximateByteSize()>0),Ya:l}:{Ya:l}}ga(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({Ka:this.Ka,za:new zf,mutatedKeys:this.mutatedKeys,ys:!1},!1)):{Ya:[]}}Za(t){return!this.qa.has(t)&&!!this.Ka.has(t)&&!this.Ka.get(t).hasLocalMutations}Ha(t){t&&(t.addedDocuments.forEach(e=>this.qa=this.qa.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.qa=this.qa.delete(e)),this.current=t.current)}Ja(){if(!this.current)return[];const t=this.$a;this.$a=se(),this.Ka.forEach(n=>{this.Za(n.key)&&(this.$a=this.$a.add(n.key))});const e=[];return t.forEach(n=>{this.$a.has(n)||e.push(new ig(n))}),this.$a.forEach(n=>{t.has(n)||e.push(new ng(n))}),e}Xa(t){this.qa=t.Ns,this.$a=se();const e=this.Ga(t.documents);return this.applyChanges(e,!0)}eu(){return ps.fromInitialDocuments(this.query,this.Ka,this.mutatedKeys,this.Qa===0,this.hasCachedResults)}}const tu="SyncEngine";class cb{constructor(t,e,n){this.query=t,this.targetId=e,this.view=n}}class hb{constructor(t){this.key=t,this.tu=!1}}class ub{constructor(t,e,n,r,s,o){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=r,this.currentUser=s,this.maxConcurrentLimboResolutions=o,this.nu={},this.ru=new Er(l=>xm(l),Za),this.iu=new Map,this.su=new Set,this.ou=new De(Lt.comparator),this._u=new Map,this.au=new Gh,this.uu={},this.cu=new Map,this.lu=fs.ir(),this.onlineState="Unknown",this.hu=void 0}get isPrimaryClient(){return this.hu===!0}}async function db(i,t,e=!0){const n=cg(i);let r;const s=n.ru.get(t);return s?(n.sharedClientState.addLocalQueryTarget(s.targetId),r=s.view.eu()):r=await rg(n,t,e,!0),r}async function fb(i,t){const e=cg(i);await rg(e,t,!0,!1)}async function rg(i,t,e,n){const r=await Iw(i.localStore,jn(t)),s=r.targetId,o=i.sharedClientState.addLocalQueryTarget(s,e);let l;return n&&(l=await pb(i,t,s,o==="current",r.resumeToken)),i.isPrimaryClient&&e&&Km(i.remoteStore,r),l}async function pb(i,t,e,n,r){i.Pu=(d,m,_)=>async function(M,g,p,I){let D=g.view.Ga(p);D.ys&&(D=await Uf(M.localStore,g.query,!1).then(({documents:S})=>g.view.Ga(S,D)));const P=I&&I.targetChanges.get(g.targetId),V=I&&I.targetMismatches.get(g.targetId)!=null,F=g.view.applyChanges(D,M.isPrimaryClient,P,V);return qf(M,g.targetId,F.Ya),F.snapshot}(i,d,m,_);const s=await Uf(i.localStore,t,!0),o=new lb(t,s.Ns),l=o.Ga(s.documents),c=yo.createSynthesizedTargetChangeForCurrentChange(e,n&&i.onlineState!=="Offline",r),h=o.applyChanges(l,i.isPrimaryClient,c);qf(i,e,h.Ya);const u=new cb(t,e,o);return i.ru.set(t,u),i.iu.has(e)?i.iu.get(e).push(t):i.iu.set(e,[t]),h.snapshot}async function mb(i,t,e){const n=$t(i),r=n.ru.get(t),s=n.iu.get(r.targetId);if(s.length>1)return n.iu.set(r.targetId,s.filter(o=>!Za(o,t))),void n.ru.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(r.targetId),n.sharedClientState.isActiveQueryTarget(r.targetId)||await lh(n.localStore,r.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(r.targetId),e&&$h(n.remoteStore,r.targetId),uh(n,r.targetId)}).catch(ys)):(uh(n,r.targetId),await lh(n.localStore,r.targetId,!0))}async function gb(i,t){const e=$t(i),n=e.ru.get(t),r=e.iu.get(n.targetId);e.isPrimaryClient&&r.length===1&&(e.sharedClientState.removeLocalQueryTarget(n.targetId),$h(e.remoteStore,n.targetId))}async function _b(i,t,e){const n=Mb(i);try{const r=await function(o,l){const c=$t(o),h=Ge.now(),u=l.reduce((_,x)=>_.add(x.key),se());let d,m;return c.persistence.runTransaction("Locally write mutations","readwrite",_=>{let x=vi(),M=se();return c.Cs.getEntries(_,u).next(g=>{x=g,x.forEach((p,I)=>{I.isValidDocument()||(M=M.add(p))})}).next(()=>c.localDocuments.getOverlayedDocuments(_,x)).next(g=>{d=g;const p=[];for(const I of l){const D=IA(I,d.get(I.key).overlayedDocument);D!=null&&p.push(new xr(I.key,D,fm(D.value.mapValue),mi.exists(!0)))}return c.mutationQueue.addMutationBatch(_,h,p,l)}).next(g=>{m=g;const p=g.applyToLocalDocumentSet(d,M);return c.documentOverlayCache.saveOverlays(_,g.batchId,p)})}).then(()=>({batchId:m.batchId,changes:Mm(d)}))}(n.localStore,t);n.sharedClientState.addPendingMutation(r.batchId),function(o,l,c){let h=o.uu[o.currentUser.toKey()];h||(h=new De(Zt)),h=h.insert(l,c),o.uu[o.currentUser.toKey()]=h}(n,r.batchId,e),await xo(n,r.changes),await sl(n.remoteStore)}catch(r){const s=Zh(r,"Failed to persist write");e.reject(s)}}async function sg(i,t){const e=$t(i);try{const n=await bw(e.localStore,t);t.targetChanges.forEach((r,s)=>{const o=e._u.get(s);o&&(_e(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1,22616),r.addedDocuments.size>0?o.tu=!0:r.modifiedDocuments.size>0?_e(o.tu,14607):r.removedDocuments.size>0&&(_e(o.tu,42227),o.tu=!1))}),await xo(e,n,t)}catch(n){await ys(n)}}function Wf(i,t,e){const n=$t(i);if(n.isPrimaryClient&&e===0||!n.isPrimaryClient&&e===1){const r=[];n.ru.forEach((s,o)=>{const l=o.view.ga(t);l.snapshot&&r.push(l.snapshot)}),function(o,l){const c=$t(o);c.onlineState=l;let h=!1;c.queries.forEach((u,d)=>{for(const m of d.Ra)m.ga(l)&&(h=!0)}),h&&Jh(c)}(n.eventManager,t),r.length&&n.nu.Q_(r),n.onlineState=t,n.isPrimaryClient&&n.sharedClientState.setOnlineState(t)}}async function vb(i,t,e){const n=$t(i);n.sharedClientState.updateQueryState(t,"rejected",e);const r=n._u.get(t),s=r&&r.key;if(s){let o=new De(Lt.comparator);o=o.insert(s,ln.newNoDocument(s,Gt.min()));const l=se().add(s),c=new nl(Gt.min(),new Map,new De(Zt),o,l);await sg(n,c),n.ou=n.ou.remove(s),n._u.delete(t),eu(n)}else await lh(n.localStore,t,!1).then(()=>uh(n,t,e)).catch(ys)}async function yb(i,t){const e=$t(i),n=t.batch.batchId;try{const r=await ww(e.localStore,t);ag(e,n,null),og(e,n),e.sharedClientState.updateMutationState(n,"acknowledged"),await xo(e,r)}catch(r){await ys(r)}}async function Eb(i,t,e){const n=$t(i);try{const r=await function(o,l){const c=$t(o);return c.persistence.runTransaction("Reject batch","readwrite-primary",h=>{let u;return c.mutationQueue.lookupMutationBatch(h,l).next(d=>(_e(d!==null,37113),u=d.keys(),c.mutationQueue.removeMutationBatch(h,d))).next(()=>c.mutationQueue.performConsistencyCheck(h)).next(()=>c.documentOverlayCache.removeOverlaysForBatchId(h,u,l)).next(()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,u)).next(()=>c.localDocuments.getDocuments(h,u))})}(n.localStore,t);ag(n,t,e),og(n,t),n.sharedClientState.updateMutationState(t,"rejected",e),await xo(n,r)}catch(r){await ys(r)}}function og(i,t){(i.cu.get(t)||[]).forEach(e=>{e.resolve()}),i.cu.delete(t)}function ag(i,t,e){const n=$t(i);let r=n.uu[n.currentUser.toKey()];if(r){const s=r.get(t);s&&(e?s.reject(e):s.resolve(),r=r.remove(t)),n.uu[n.currentUser.toKey()]=r}}function uh(i,t,e=null){i.sharedClientState.removeLocalQueryTarget(t);for(const n of i.iu.get(t))i.ru.delete(n),e&&i.nu.Tu(n,e);i.iu.delete(t),i.isPrimaryClient&&i.au.Ur(t).forEach(n=>{i.au.containsKey(n)||lg(i,n)})}function lg(i,t){i.su.delete(t.path.canonicalString());const e=i.ou.get(t);e!==null&&($h(i.remoteStore,e),i.ou=i.ou.remove(t),i._u.delete(e),eu(i))}function qf(i,t,e){for(const n of e)n instanceof ng?(i.au.addReference(n.key,t),xb(i,n)):n instanceof ig?(xt(tu,"Document no longer in limbo: "+n.key),i.au.removeReference(n.key,t),i.au.containsKey(n.key)||lg(i,n.key)):Bt(19791,{Iu:n})}function xb(i,t){const e=t.key,n=e.path.canonicalString();i.ou.get(e)||i.su.has(n)||(xt(tu,"New document in limbo: "+e),i.su.add(n),eu(i))}function eu(i){for(;i.su.size>0&&i.ou.size<i.maxConcurrentLimboResolutions;){const t=i.su.values().next().value;i.su.delete(t);const e=new Lt(Pe.fromString(t)),n=i.lu.next();i._u.set(n,new hb(e)),i.ou=i.ou.insert(e,n),Km(i.remoteStore,new Di(jn(Em(e.path)),n,"TargetPurposeLimboResolution",ja.le))}}async function xo(i,t,e){const n=$t(i),r=[],s=[],o=[];n.ru.isEmpty()||(n.ru.forEach((l,c)=>{o.push(n.Pu(c,t,e).then(h=>{var u;if((h||e)&&n.isPrimaryClient){const d=h?!h.fromCache:(u=e==null?void 0:e.targetChanges.get(c.targetId))===null||u===void 0?void 0:u.current;n.sharedClientState.updateQueryState(c.targetId,d?"current":"not-current")}if(h){r.push(h);const d=qh.Ps(c.targetId,h);s.push(d)}}))}),await Promise.all(o),n.nu.Q_(r),await async function(c,h){const u=$t(c);try{await u.persistence.runTransaction("notifyLocalViewChanges","readwrite",d=>J.forEach(h,m=>J.forEach(m.ls,_=>u.persistence.referenceDelegate.addReference(d,m.targetId,_)).next(()=>J.forEach(m.hs,_=>u.persistence.referenceDelegate.removeReference(d,m.targetId,_)))))}catch(d){if(!Es(d))throw d;xt(Xh,"Failed to update sequence numbers: "+d)}for(const d of h){const m=d.targetId;if(!d.fromCache){const _=u.Ss.get(m),x=_.snapshotVersion,M=_.withLastLimboFreeSnapshotVersion(x);u.Ss=u.Ss.insert(m,M)}}}(n.localStore,s))}async function Tb(i,t){const e=$t(i);if(!e.currentUser.isEqual(t)){xt(tu,"User change. New user:",t.toKey());const n=await Xm(e.localStore,t);e.currentUser=t,function(s,o){s.cu.forEach(l=>{l.forEach(c=>{c.reject(new It(st.CANCELLED,o))})}),s.cu.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,n.removedBatchIds,n.addedBatchIds),await xo(e,n.Ms)}}function Sb(i,t){const e=$t(i),n=e._u.get(t);if(n&&n.tu)return se().add(n.key);{let r=se();const s=e.iu.get(t);if(!s)return r;for(const o of s){const l=e.ru.get(o);r=r.unionWith(l.view.Wa)}return r}}function cg(i){const t=$t(i);return t.remoteStore.remoteSyncer.applyRemoteEvent=sg.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=Sb.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=vb.bind(null,t),t.nu.Q_=sb.bind(null,t.eventManager),t.nu.Tu=ob.bind(null,t.eventManager),t}function Mb(i){const t=$t(i);return t.remoteStore.remoteSyncer.applySuccessfulWrite=yb.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Eb.bind(null,t),t}class za{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=il(t.databaseInfo.databaseId),this.sharedClientState=this.Au(t),this.persistence=this.Ru(t),await this.persistence.start(),this.localStore=this.Vu(t),this.gcScheduler=this.mu(t,this.localStore),this.indexBackfillerScheduler=this.fu(t,this.localStore)}mu(t,e){return null}fu(t,e){return null}Vu(t){return Aw(this.persistence,new Tw,t.initialUser,this.serializer)}Ru(t){return new qm(Wh.Ei,this.serializer)}Au(t){return new Dw}async terminate(){var t,e;(t=this.gcScheduler)===null||t===void 0||t.stop(),(e=this.indexBackfillerScheduler)===null||e===void 0||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}za.provider={build:()=>new za};class Ab extends za{constructor(t){super(),this.cacheSizeBytes=t}mu(t,e){_e(this.persistence.referenceDelegate instanceof Ba,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new aw(n,t.asyncQueue,e)}Ru(t){const e=this.cacheSizeBytes!==void 0?vn.withCacheSize(this.cacheSizeBytes):vn.DEFAULT;return new qm(n=>Ba.Ei(n,e),this.serializer)}}class dh{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>Wf(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=Tb.bind(null,this.syncEngine),await tb(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new nb}()}createDatastore(t){const e=il(t.databaseInfo.databaseId),n=function(s){return new Ow(s)}(t.databaseInfo);return function(s,o,l,c){return new zw(s,o,l,c)}(t.authCredentials,t.appCheckCredentials,n,e)}createRemoteStore(t){return function(n,r,s,o,l){return new Gw(n,r,s,o,l)}(this.localStore,this.datastore,t.asyncQueue,e=>Wf(this.syncEngine,e,0),function(){return Vf.C()?new Vf:new Lw}())}createSyncEngine(t,e){return function(r,s,o,l,c,h,u){const d=new ub(r,s,o,l,c,h);return u&&(d.hu=!0),d}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(r){const s=$t(r);xt(_r,"RemoteStore shutting down."),s.aa.add(5),await Eo(s),s.ca.shutdown(),s.la.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(e=this.eventManager)===null||e===void 0||e.terminate()}}dh.provider={build:()=>new dh};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wb{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.pu(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.pu(this.observer.error,t):_i("Uncaught Error in snapshot listener:",t.toString()))}yu(){this.muted=!0}pu(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zf="AsyncQueue";class Jf{constructor(t=Promise.resolve()){this.Qu=[],this.$u=!1,this.Uu=[],this.Ku=null,this.Wu=!1,this.Gu=!1,this.zu=[],this.y_=new jm(this,"async_queue_retry"),this.ju=()=>{const n=Jl();n&&xt(Zf,"Visibility state changed to "+n.visibilityState),this.y_.A_()},this.Hu=t;const e=Jl();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this.ju)}get isShuttingDown(){return this.$u}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.Ju(),this.Yu(t)}enterRestrictedMode(t){if(!this.$u){this.$u=!0,this.Gu=t||!1;const e=Jl();e&&typeof e.removeEventListener=="function"&&e.removeEventListener("visibilitychange",this.ju)}}enqueue(t){if(this.Ju(),this.$u)return new Promise(()=>{});const e=new Vi;return this.Yu(()=>this.$u&&this.Gu?Promise.resolve():(t().then(e.resolve,e.reject),e.promise)).then(()=>e.promise)}enqueueRetryable(t){this.enqueueAndForget(()=>(this.Qu.push(t),this.Zu()))}async Zu(){if(this.Qu.length!==0){try{await this.Qu[0](),this.Qu.shift(),this.y_.reset()}catch(t){if(!Es(t))throw t;xt(Zf,"Operation failed with retryable error: "+t)}this.Qu.length>0&&this.y_.E_(()=>this.Zu())}}Yu(t){const e=this.Hu.then(()=>(this.Wu=!0,t().catch(n=>{throw this.Ku=n,this.Wu=!1,_i("INTERNAL UNHANDLED ERROR: ",tp(n)),n}).then(n=>(this.Wu=!1,n))));return this.Hu=e,e}enqueueAfterDelay(t,e,n){this.Ju(),this.zu.indexOf(t)>-1&&(e=0);const r=Qh.createAndSchedule(this,t,e,n,s=>this.Xu(s));return this.Uu.push(r),r}Ju(){this.Ku&&Bt(47125,{ec:tp(this.Ku)})}verifyOperationInProgress(){}async tc(){let t;do t=this.Hu,await t;while(t!==this.Hu)}nc(t){for(const e of this.Uu)if(e.timerId===t)return!0;return!1}rc(t){return this.tc().then(()=>{this.Uu.sort((e,n)=>e.targetTimeMs-n.targetTimeMs);for(const e of this.Uu)if(e.skipDelay(),t!=="all"&&e.timerId===t)break;return this.tc()})}sc(t){this.zu.push(t)}Xu(t){const e=this.Uu.indexOf(t);this.Uu.splice(e,1)}}function tp(i){let t=i.message||"";return i.stack&&(t=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),t}class iu extends ol{constructor(t,e,n,r){super(t,e,n,r),this.type="firestore",this._queue=new Jf,this._persistenceKey=(r==null?void 0:r.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Jf(t),this._firestoreClient=void 0,await t}}}function Fb(i,t){const e=typeof i=="object"?i:xM(),n=typeof i=="string"?i:Da,r=gM(e,"firestore").getImmediate({identifier:n});if(!r._initialized){const s=lS("firestore");s&&Lb(r,...s)}return r}function pg(i){if(i._terminated)throw new It(st.FAILED_PRECONDITION,"The client has already been terminated.");return i._firestoreClient||Ob(i),i._firestoreClient}function Ob(i){var t,e,n;const r=i._freezeSettings(),s=function(l,c,h,u){return new JM(l,c,h,u.host,u.ssl,u.experimentalForceLongPolling,u.experimentalAutoDetectLongPolling,ug(u.experimentalLongPollingOptions),u.useFetchStreams,u.isUsingEmulator)}(i._databaseId,((t=i._app)===null||t===void 0?void 0:t.options.appId)||"",i._persistenceKey,r);i._componentsProvider||!((e=r.localCache)===null||e===void 0)&&e._offlineComponentProvider&&(!((n=r.localCache)===null||n===void 0)&&n._onlineComponentProvider)&&(i._componentsProvider={_offline:r.localCache._offlineComponentProvider,_online:r.localCache._onlineComponentProvider}),i._firestoreClient=new bb(i._authCredentials,i._appCheckCredentials,i._queue,s,i._componentsProvider&&function(l){const c=l==null?void 0:l._online.build();return{_offline:l==null?void 0:l._offline.build(c),_online:c}}(i._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vb=/^__.*__$/;class Bb{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return this.fieldMask!==null?new xr(t,this.data,this.fieldMask,e,this.fieldTransforms):new vo(t,this.data,e,this.fieldTransforms)}}function mg(i){switch(i){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Bt(40011,{oc:i})}}class ll{constructor(t,e,n,r,s,o){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=r,s===void 0&&this._c(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get oc(){return this.settings.oc}ac(t){return new ll(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}uc(t){var e;const n=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.ac({path:n,cc:!1});return r.lc(t),r}hc(t){var e;const n=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.ac({path:n,cc:!1});return r._c(),r}Pc(t){return this.ac({path:void 0,cc:!0})}Tc(t){return Ha(t,this.settings.methodName,this.settings.Ic||!1,this.path,this.settings.Ec)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}_c(){if(this.path)for(let t=0;t<this.path.length;t++)this.lc(this.path.get(t))}lc(t){if(t.length===0)throw this.Tc("Document fields must not be empty");if(mg(this.oc)&&Vb.test(t))throw this.Tc('Document fields cannot begin and end with "__"')}}class kb{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||il(t)}dc(t,e,n,r=!1){return new ll({oc:t,methodName:e,Ec:n,path:Ze.emptyPath(),cc:!1,Ic:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function zb(i){const t=i._freezeSettings(),e=il(i._databaseId);return new kb(i._databaseId,!!t.ignoreUndefinedProperties,e)}function Hb(i,t,e,n,r,s={}){const o=i.dc(s.merge||s.mergeFields?2:0,t,e,r);vg("Data must be an object, but it was:",o,n);const l=gg(n,o);let c,h;if(s.merge)c=new Vn(o.fieldMask),h=o.fieldTransforms;else if(s.mergeFields){const u=[];for(const d of s.mergeFields){const m=Wb(t,d,e);if(!o.contains(m))throw new It(st.INVALID_ARGUMENT,`Field '${m}' is specified in your field mask but missing from your input data.`);Xb(u,m)||u.push(m)}c=new Vn(u),h=o.fieldTransforms.filter(d=>c.covers(d.field))}else c=null,h=o.fieldTransforms;return new Bb(new Cn(l),c,h)}function Gb(i,t,e){return new ll({oc:3,Ec:t.settings.Ec,methodName:i._methodName,cc:e},t.databaseId,t.serializer,t.ignoreUndefinedProperties)}class lu extends su{constructor(t,e){super(t),this.Ac=e}_toFieldTransform(t){const e=Gb(this,t,!0),n=this.Ac.map(s=>cu(s,e)),r=new ds(n);return new wA(t.path,r)}isEqual(t){return t instanceof lu&&no(this.Ac,t.Ac)}}function cu(i,t){if(_g(i=io(i)))return vg("Unsupported field value:",t,i),gg(i,t);if(i instanceof su)return function(n,r){if(!mg(r.oc))throw r.Tc(`${n._methodName}() can only be used with update() and set()`);if(!r.path)throw r.Tc(`${n._methodName}() is not currently supported inside arrays`);const s=n._toFieldTransform(r);s&&r.fieldTransforms.push(s)}(i,t),null;if(i===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),i instanceof Array){if(t.settings.cc&&t.oc!==4)throw t.Tc("Nested arrays are not supported");return function(n,r){const s=[];let o=0;for(const l of n){let c=cu(l,r.Pc(o));c==null&&(c={nullValue:"NULL_VALUE"}),s.push(c),o++}return{arrayValue:{values:s}}}(i,t)}return function(n,r){if((n=io(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return SA(r.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const s=Ge.fromDate(n);return{timestampValue:Va(r.serializer,s)}}if(n instanceof Ge){const s=new Ge(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:Va(r.serializer,s)}}if(n instanceof ou)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof ms)return{bytesValue:Om(r.serializer,n._byteString)};if(n instanceof In){const s=r.databaseId,o=n.firestore._databaseId;if(!o.isEqual(s))throw r.Tc(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Hh(n.firestore._databaseId||r.databaseId,n._key.path)}}if(n instanceof au)return function(o,l){return{mapValue:{fields:{[um]:{stringValue:dm},[La]:{arrayValue:{values:o.toArray().map(h=>{if(typeof h!="number")throw l.Tc("VectorValues must only contain numeric values.");return Bh(l.serializer,h)})}}}}}}(n,r);throw r.Tc(`Unsupported field value: ${nu(n)}`)}(i,t)}function gg(i,t){const e={};return sm(i)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):yr(i,(n,r)=>{const s=cu(r,t.uc(n));s!=null&&(e[n]=s)}),{mapValue:{fields:e}}}function _g(i){return!(typeof i!="object"||i===null||i instanceof Array||i instanceof Date||i instanceof Ge||i instanceof ou||i instanceof ms||i instanceof In||i instanceof su||i instanceof au)}function vg(i,t,e){if(!_g(e)||!function(r){return typeof r=="object"&&r!==null&&(Object.getPrototypeOf(r)===Object.prototype||Object.getPrototypeOf(r)===null)}(e)){const n=nu(e);throw n==="an object"?t.Tc(i+" a custom object"):t.Tc(i+" "+n)}}function Wb(i,t,e){if((t=io(t))instanceof ru)return t._internalPath;if(typeof t=="string")return yg(i,t);throw Ha("Field path arguments must be of type string or ",i,!1,void 0,e)}const qb=new RegExp("[~\\*/\\[\\]]");function yg(i,t,e){if(t.search(qb)>=0)throw Ha(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,i,!1,void 0,e);try{return new ru(...t.split("."))._internalPath}catch{throw Ha(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,i,!1,void 0,e)}}function Ha(i,t,e,n,r){const s=n&&!n.isEmpty(),o=r!==void 0;let l=`Function ${t}() called with invalid data`;e&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${n}`),o&&(c+=` in document ${r}`),c+=")"),new It(st.INVALID_ARGUMENT,l+i+c)}function Xb(i,t){return i.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eg{constructor(t,e,n,r,s){this._firestore=t,this._userDataWriter=e,this._key=n,this._document=r,this._converter=s}get id(){return this._key.path.lastSegment()}get ref(){return new In(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const t=new $b(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const e=this._document.data.field(xg("DocumentSnapshot.get",t));if(e!==null)return this._userDataWriter.convertValue(e)}}}class $b extends Eg{data(){return super.data()}}function xg(i,t){return typeof t=="string"?yg(i,t):t instanceof ru?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kb(i,t,e){let n;return n=i?e&&(e.merge||e.mergeFields)?i.toFirestore(t,e):i.toFirestore(t):t,n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class la{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Qb extends Eg{constructor(t,e,n,r,s,o){super(t,e,n,r,o),this._firestore=t,this._firestoreImpl=t,this.metadata=s}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new Sa(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(xg("DocumentSnapshot.get",t));if(n!==null)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class Sa extends Qb{data(t={}){return super.data(t)}}class Zb{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new la(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new Sa(this._firestore,this._userDataWriter,n.key,n,new la(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new It(st.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(r,s){if(r._snapshot.oldDocs.isEmpty()){let o=0;return r._snapshot.docChanges.map(l=>{const c=new Sa(r._firestore,r._userDataWriter,l.doc.key,l.doc,new la(r._snapshot.mutatedKeys.has(l.doc.key),r._snapshot.fromCache),r.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:o++}})}{let o=r._snapshot.oldDocs;return r._snapshot.docChanges.filter(l=>s||l.type!==3).map(l=>{const c=new Sa(r._firestore,r._userDataWriter,l.doc.key,l.doc,new la(r._snapshot.mutatedKeys.has(l.doc.key),r._snapshot.fromCache),r.query.converter);let h=-1,u=-1;return l.type!==0&&(h=o.indexOf(l.doc.key),o=o.delete(l.doc.key)),l.type!==1&&(o=o.add(l.doc),u=o.indexOf(l.doc.key)),{type:Jb(l.type),doc:c,oldIndex:h,newIndex:u}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function Jb(i){switch(i){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Bt(61501,{type:i})}}class tR extends Yb{constructor(t){super(),this.firestore=t}convertBytes(t){return new ms(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new In(this.firestore,null,e)}}function eR(i){i=uo(i,al);const t=uo(i.firestore,iu),e=pg(t),n=new tR(t);return jb(i._query),Pb(e,i._query).then(r=>new Zb(t,n,i,r))}function nR(i,t,e){i=uo(i,In);const n=uo(i.firestore,iu),r=Kb(i.converter,t,e);return iR(n,[Hb(zb(n),"setDoc",i._key,r,i.converter!==null,e).toMutation(i._key,mi.none())])}function iR(i,t){return function(n,r){const s=new Vi;return n.asyncQueue.enqueueAndForget(async()=>_b(await Cb(n),r,s)),s.promise}(pg(i),t)}function rR(...i){return new lu("arrayUnion",i)}(function(t,e=!0){(function(r){vs=r})(EM),Ia(new ro("firestore",(n,{instanceIdentifier:r,options:s})=>{const o=n.getProvider("app").getImmediate(),l=new iu(new FM(n.getProvider("auth-internal")),new BM(o,n.getProvider("app-check-internal")),function(h,u){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new It(st.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new lo(h.options.projectId,u)}(o,r),o);return s=Object.assign({useFetchStreams:e},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),es(sf,of,t),es(sf,of,"esm2017")})();const sR="AIzaSyAqp3HdlJ4yCpc-do_IDLprQmS4YUjinbk",oR={apiKey:sR,authDomain:"mental-reload-95d66.firebaseapp.com",projectId:"mental-reload-95d66",storageBucket:"mental-reload-95d66.firebasestorage.app",messagingSenderId:"634955541388",appId:"1:634955541388:web:64a9e7fc037ead46f1c4a9"},aR=qp(oR),Tg=Fb(aR);let Sg,ep,Ma=[];async function Mg(){const i=Nb(Tg,"reload");Sg=(await eR(i)).docs[0].data(),Ag(),ep=mqtt.connect("mqtt://mqtt-plain.nextservices.dk:9001"),ep.on("connect",function(n){console.log(n,"serveren er klar til mqtt kommunikation")})}async function lR(i,t,e,n,r,s,o){let l={name:i,volume:t,songNum:e,earthSpeed:n,earthRotationSpeed:r,lightIntensity:s,rotationDirection:o};const c=Ub(Tg,"reload","presets");try{await nR(c,{presets:rR(l)},{merge:!0}),console.log("database updated",l)}catch(h){console.log("det gik mindre godt",h)}Ag()}async function Ag(){return Ma=Sg.presets,Ma.sort((i,t)=>i.name>t.name?1:-1),Ma}const cR=document.querySelector(".hamburger-wrapper"),hR=document.querySelector(".add-button"),np=document.querySelector(".presets-container"),uR=document.getElementById("saveButton"),dR=document.getElementById("preset-input"),{scene:fh,camera:Ga,renderer:wg,labelRenderer:bg,controls:fR,animateParams:Qr}=NT(),Rg=Zg();jT(Qr,Rg,Jg);let ca=!0;function hu(){ca=!ca,Qg(),LT(fh,ca),QT(ca)}function Cg(){np.innerHTML="",Ma.forEach(i=>{const t=document.createElement("div");t.addEventListener("click",()=>{KT(i,ph,Qr),hu()}),t.className="preset",t.innerHTML=`<p>${i.name}</p>`,np.appendChild(t)})}window.addEventListener("resize",()=>{Ga.aspect=window.innerWidth/window.innerHeight,Ga.updateProjectionMatrix(),wg.setSize(window.innerWidth,window.innerHeight),bg.setSize(window.innerWidth,window.innerHeight)});document.addEventListener("DOMContentLoaded",async()=>{await Mg(),Cg(),console.log("loaded")});uR.addEventListener("click",async()=>{if(Aa.length>0){const i=qs?qs.num:1;await lR(Aa,Rg.volume,i,Qr.earthSpeed,Qr.earthRotationSpeed,Qr.lightIntensity,Qr.aroundSunDirection),await Mg(),dR.value="",Cg(),rp(),hu()}else alert("Please enter a valid preset name.")});cR.addEventListener("click",()=>{hu()});hR.addEventListener("click",async()=>{rp()});function Ig(){UT(),fR.update(),wg.render(fh,Ga),bg.render(fh,Ga),window.requestAnimationFrame(Ig)}Ig();
