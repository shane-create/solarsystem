 ...
 */const Fp=function(i){const t=[];let e=0;for(let n=0;n<i.length;n++){let r=i.charCodeAt(n);r<128?t[e++]=r:r<2048?(t[e++]=r>>6|192,t[e++]=r&63|128):(r&64512)===55296&&n+1<i.length&&(i.charCodeAt(n+1)&64512)===56320?(r=65536+((r&1023)<<10)+(i.charCodeAt(++n)&1023),t[e++]=r>>18|240,t[e++]=r>>12&63|128,t[e++]=r>>6&63|128,t[e++]=r&63|128):(t[e++]=r>>12|224,t[e++]=r>>6&63|128,t[e++]=r&63|128)}return t},FT=function(i){const t=[];let e=0,n=0;for(;e<i.length;){const r=i[e++];if(r<128)t[n++]=String.fromCharCode(r);else if(r>191&&r<224){const s=i[e++];t[n++]=String.fromCharCode((r&31)<<6|s&63)}else if(r>239&&r<365){const s=i[e++],o=i[e++],l=i[e++],c=((r&7)<<18|(s&63)<<12|(o&63)<<6|l&63)-65536;t[n++]=String.fromCharCode(55296+(c>>10)),t[n++]=String.fromCharCode(56320+(c&1023))}else{const s=i[e++],o=i[e++];t[n++]=String.fromCharCode((r&15)<<12|(s&63)<<6|o&63)}}return t.join("")},Op={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(i,t){if(!Array.isArray(i))throw Error("encodeByteArray takes an array as a parameter");this.init_();const e=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,n=[];for(let r=0;r<i.length;r+=3){const s=i[r],o=r+1<i.length,l=o?i[r+1]:0,c=r+2<i.length,h=c?i[r+2]:0,u=s>>2,d=(s&3)<<4|l>>4;let m=(l&15)<<2|h>>6,_=h&63;c||(_=64,o||(m=64)),n.push(e[u],e[d],e[m],e[_])}return n.join("")},encodeString(i,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(i):this.encodeByteArray(Fp(i),t)},decodeString(i,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(i):FT(this.decodeStringToByteArray(i,t))},decodeStringToByteArray(i,t){this.init_();const e=t?this.charToByteMapWebSafe_:this.charToByteMap_,n=[];for(let r=0;r<i.length;){const s=e[i.charAt(r++)],l=r<i.length?e[i.charAt(r)]:0;++r;const h=r<i.length?e[i.charAt(r)]:64;++r;const d=r<i.length?e[i.charAt(r)]:64;if(++r,s==null||l==null||h==null||d==null)throw new OT;const m=s<<2|l>>4;if(n.push(m),h!==64){const _=l<<4&240|h>>2;if(n.push(_),d!==64){const x=h<<6&192|d;n.push(x)}}}return n},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let i=0;i<this.ENCODED_VALS.length;i++)this.byteToCharMap_[i]=this.ENCODED_VALS.charAt(i),this.charToByteMap_[this.byteToCharMap_[i]]=i,this.byteToCharMapWebSafe_[i]=this.ENCODED_VALS_WEBSAFE.charAt(i),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[i]]=i,i>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(i)]=i,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(i)]=i)}}};class OT extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const VT=function(i){const t=Fp(i);return Op.encodeByteArray(t,!0)},Ra=function(i){return VT(i).replace(/\./g,"")},BT=function(i){try{return Op.decodeString(i,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zT=()=>kT().__FIREBASE_DEFAULTS__,HT=()=>{if(typeof process>"u"||typeof qd>"u")return;const i=qd.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},GT=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=i&&BT(i[1]);return t&&JSON.parse(t)},Ih=()=>{try{return UT()||zT()||HT()||GT()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},WT=i=>{var t,e;return(e=(t=Ih())===null||t===void 0?void 0:t.emulatorHosts)===null||e===void 0?void 0:e[i]},XT=i=>{const t=WT(i);if(!t)return;const e=t.lastIndexOf(":");if(e<=0||e+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const n=parseInt(t.substring(e+1),10);return t[0]==="["?[t.substring(1,e-1),n]:[t.substring(0,e),n]},Vp=()=>{var i;return(i=Ih())===null||i===void 0?void 0:i.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qT{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,e)=>{this.resolve=t,this.reject=e})}wrapCallback(t){return(e,n)=>{e?this.reject(e):this.resolve(n),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(e):t(e,n))}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $T(i,t){if(i.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const e={alg:"none",type:"JWT"},n=t||"demo-project",r=i.iat||0,s=i.sub||i.user_id;if(!s)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:r,exp:r+3600,auth_time:r,sub:s,user_id:s,firebase:{sign_in_provider:"custom",identities:{}}},i);return[Ra(JSON.stringify(e)),Ra(JSON.stringify(o)),""].join(".")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jT(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function KT(){var i;const t=(i=Ih())===null||i===void 0?void 0:i.forceEnvironment;if(t==="node")return!0;if(t==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function QT(){return!KT()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function ZT(){try{return typeof indexedDB=="object"}catch{return!1}}function JT(){return new Promise((i,t)=>{try{let e=!0;const n="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(n);r.onsuccess=()=>{r.result.close(),e||self.indexedDB.deleteDatabase(n),i(!0)},r.onupgradeneeded=()=>{e=!1},r.onerror=()=>{var s;t(((s=r.error)===null||s===void 0?void 0:s.message)||"")}}catch(e){t(e)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tS="FirebaseError";class _s extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=tS,Object.setPrototypeOf(this,_s.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Bp.prototype.create)}}class Bp{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},r=`${this.service}/${t}`,s=this.errors[t],o=s?eS(s,n):"Error",l=`${this.serviceName}: ${o} (${r}).`;return new _s(r,l,n)}}function eS(i,t){return i.replace(nS,(e,n)=>{const r=t[n];return r!=null?String(r):`<${n}?>`})}const nS=/\{\$([^}]+)}/g;function eo(i,t){if(i===t)return!0;const e=Object.keys(i),n=Object.keys(t);for(const r of e){if(!n.includes(r))return!1;const s=i[r],o=t[r];if($d(s)&&$d(o)){if(!eo(s,o))return!1}else if(s!==o)return!1}for(const r of n)if(!e.includes(r))return!1;return!0}function $d(i){return i!==null&&typeof i=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function no(i){return i&&i._delegate?i._delegate:i}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kp(i){return i.endsWith(".cloudworkstations.dev")}async function iS(i){return(await fetch(i,{credentials:"include"})).ok}class io{constructor(t,e,n){this.name=t,this.instanceFactory=e,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rS{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const n=new qT;if(this.instancesDeferred.set(e,n),this.isInitialized(e)||this.shouldAutoInitialize())try{const r=this.getOrInitializeService({instanceIdentifier:e});r&&n.resolve(r)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const n=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),r=(e=t==null?void 0:t.optional)!==null&&e!==void 0?e:!1;if(this.isInitialized(n)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:n})}catch(s){if(r)return null;throw s}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(oS(t))try{this.getOrInitializeService({instanceIdentifier:ir})}catch{}for(const[e,n]of this.instancesDeferred.entries()){const r=this.normalizeInstanceIdentifier(e);try{const s=this.getOrInitializeService({instanceIdentifier:r});n.resolve(s)}catch{}}}}clearInstance(t=ir){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=ir){return this.instances.has(t)}getOptions(t=ir){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:e={}}=t,n=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(n))throw Error(`${this.name}(${n}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const r=this.getOrInitializeService({instanceIdentifier:n,options:e});for(const[s,o]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(s);n===l&&o.resolve(r)}return r}onInit(t,e){var n;const r=this.normalizeInstanceIdentifier(e),s=(n=this.onInitCallbacks.get(r))!==null&&n!==void 0?n:new Set;s.add(t),this.onInitCallbacks.set(r,s);const o=this.instances.get(r);return o&&t(o,r),()=>{s.delete(t)}}invokeOnInitCallbacks(t,e){const n=this.onInitCallbacks.get(e);if(n)for(const r of n)try{r(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let n=this.instances.get(t);if(!n&&this.component&&(n=this.component.instanceFactory(this.container,{instanceIdentifier:sS(t),options:e}),this.instances.set(t,n),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(n,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,n)}catch{}return n||null}normalizeInstanceIdentifier(t=ir){return this.component?this.component.multipleInstances?t:ir:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function sS(i){return i===ir?void 0:i}function oS(i){return i.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aS{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const e=this.getProvider(t.name);if(e.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);e.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const e=new rS(t,this);return this.providers.set(t,e),e}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ue;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(ue||(ue={}));const lS={debug:ue.DEBUG,verbose:ue.VERBOSE,info:ue.INFO,warn:ue.WARN,error:ue.ERROR,silent:ue.SILENT},cS=ue.INFO,hS={[ue.DEBUG]:"log",[ue.VERBOSE]:"log",[ue.INFO]:"info",[ue.WARN]:"warn",[ue.ERROR]:"error"},uS=(i,t,...e)=>{if(t<i.logLevel)return;const n=new Date().toISOString(),r=hS[t];if(r)console[r](`[${n}]  ${i.name}:`,...e);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class zp{constructor(t){this.name=t,this._logLevel=cS,this._logHandler=uS,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in ue))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?lS[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,ue.DEBUG,...t),this._logHandler(this,ue.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,ue.VERBOSE,...t),this._logHandler(this,ue.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,ue.INFO,...t),this._logHandler(this,ue.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,ue.WARN,...t),this._logHandler(this,ue.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,ue.ERROR,...t),this._logHandler(this,ue.ERROR,...t)}}const dS=(i,t)=>t.some(e=>i instanceof e);let jd,Yd;function fS(){return jd||(jd=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function pS(){return Yd||(Yd=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Hp=new WeakMap,Xc=new WeakMap,Gp=new WeakMap,ql=new WeakMap,Ph=new WeakMap;function mS(i){const t=new Promise((e,n)=>{const r=()=>{i.removeEventListener("success",s),i.removeEventListener("error",o)},s=()=>{e(Ui(i.result)),r()},o=()=>{n(i.error),r()};i.addEventListener("success",s),i.addEventListener("error",o)});return t.then(e=>{e instanceof IDBCursor&&Hp.set(e,i)}).catch(()=>{}),Ph.set(t,i),t}function gS(i){if(Xc.has(i))return;const t=new Promise((e,n)=>{const r=()=>{i.removeEventListener("complete",s),i.removeEventListener("error",o),i.removeEventListener("abort",o)},s=()=>{e(),r()},o=()=>{n(i.error||new DOMException("AbortError","AbortError")),r()};i.addEventListener("complete",s),i.addEventListener("error",o),i.addEventListener("abort",o)});Xc.set(i,t)}let qc={get(i,t,e){if(i instanceof IDBTransaction){if(t==="done")return Xc.get(i);if(t==="objectStoreNames")return i.objectStoreNames||Gp.get(i);if(t==="store")return e.objectStoreNames[1]?void 0:e.objectStore(e.objectStoreNames[0])}return Ui(i[t])},set(i,t,e){return i[t]=e,!0},has(i,t){return i instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in i}};function _S(i){qc=i(qc)}function vS(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...e){const n=i.call($l(this),t,...e);return Gp.set(n,t.sort?t.sort():[t]),Ui(n)}:pS().includes(i)?function(...t){return i.apply($l(this),t),Ui(Hp.get(this))}:function(...t){return Ui(i.apply($l(this),t))}}function yS(i){return typeof i=="function"?vS(i):(i instanceof IDBTransaction&&gS(i),dS(i,fS())?new Proxy(i,qc):i)}function Ui(i){if(i instanceof IDBRequest)return mS(i);if(ql.has(i))return ql.get(i);const t=yS(i);return t!==i&&(ql.set(i,t),Ph.set(t,i)),t}const $l=i=>Ph.get(i);function ES(i,t,{blocked:e,upgrade:n,blocking:r,terminated:s}={}){const o=indexedDB.open(i,t),l=Ui(o);return n&&o.addEventListener("upgradeneeded",c=>{n(Ui(o.result),c.oldVersion,c.newVersion,Ui(o.transaction),c)}),e&&o.addEventListener("blocked",c=>e(c.oldVersion,c.newVersion,c)),l.then(c=>{s&&c.addEventListener("close",()=>s()),r&&c.addEventListener("versionchange",h=>r(h.oldVersion,h.newVersion,h))}).catch(()=>{}),l}const xS=["get","getKey","getAll","getAllKeys","count"],TS=["put","add","delete","clear"],jl=new Map;function Kd(i,t){if(!(i instanceof IDBDatabase&&!(t in i)&&typeof t=="string"))return;if(jl.get(t))return jl.get(t);const e=t.replace(/FromIndex$/,""),n=t!==e,r=TS.includes(e);if(!(e in(n?IDBIndex:IDBObjectStore).prototype)||!(r||xS.includes(e)))return;const s=async function(o,...l){const c=this.transaction(o,r?"readwrite":"readonly");let h=c.store;return n&&(h=h.index(l.shift())),(await Promise.all([h[e](...l),r&&c.done]))[0]};return jl.set(t,s),s}_S(i=>({...i,get:(t,e,n)=>Kd(t,e)||i.get(t,e,n),has:(t,e)=>!!Kd(t,e)||i.has(t,e)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class SS{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(MS(e)){const n=e.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(e=>e).join(" ")}}function MS(i){const t=i.getComponent();return(t==null?void 0:t.type)==="VERSION"}const $c="@firebase/app",Qd="0.12.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gi=new zp("@firebase/app"),AS="@firebase/app-compat",wS="@firebase/analytics-compat",bS="@firebase/analytics",RS="@firebase/app-check-compat",CS="@firebase/app-check",IS="@firebase/auth",PS="@firebase/auth-compat",DS="@firebase/database",LS="@firebase/data-connect",NS="@firebase/database-compat",US="@firebase/functions",FS="@firebase/functions-compat",OS="@firebase/installations",VS="@firebase/installations-compat",BS="@firebase/messaging",kS="@firebase/messaging-compat",zS="@firebase/performance",HS="@firebase/performance-compat",GS="@firebase/remote-config",WS="@firebase/remote-config-compat",XS="@firebase/storage",qS="@firebase/storage-compat",$S="@firebase/firestore",jS="@firebase/vertexai",YS="@firebase/firestore-compat",KS="firebase",QS="11.7.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jc="[DEFAULT]",ZS={[$c]:"fire-core",[AS]:"fire-core-compat",[bS]:"fire-analytics",[wS]:"fire-analytics-compat",[CS]:"fire-app-check",[RS]:"fire-app-check-compat",[IS]:"fire-auth",[PS]:"fire-auth-compat",[DS]:"fire-rtdb",[LS]:"fire-data-connect",[NS]:"fire-rtdb-compat",[US]:"fire-fn",[FS]:"fire-fn-compat",[OS]:"fire-iid",[VS]:"fire-iid-compat",[BS]:"fire-fcm",[kS]:"fire-fcm-compat",[zS]:"fire-perf",[HS]:"fire-perf-compat",[GS]:"fire-rc",[WS]:"fire-rc-compat",[XS]:"fire-gcs",[qS]:"fire-gcs-compat",[$S]:"fire-fst",[YS]:"fire-fst-compat",[jS]:"fire-vertex","fire-js":"fire-js",[KS]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ca=new Map,JS=new Map,Yc=new Map;function Zd(i,t){try{i.container.addComponent(t)}catch(e){gi.debug(`Component ${t.name} failed to register with FirebaseApp ${i.name}`,e)}}function Ia(i){const t=i.name;if(Yc.has(t))return gi.debug(`There were multiple attempts to register component ${t}.`),!1;Yc.set(t,i);for(const e of Ca.values())Zd(e,i);for(const e of JS.values())Zd(e,i);return!0}function tM(i,t){const e=i.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),i.container.getProvider(t)}function eM(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rM=QS;function Wp(i,t={}){let e=i;typeof t!="object"&&(t={name:t});const n=Object.assign({name:jc,automaticDataCollectionEnabled:!1},t),r=n.name;if(typeof r!="string"||!r)throw Fi.create("bad-app-name",{appName:String(r)});if(e||(e=Vp()),!e)throw Fi.create("no-options");const s=Ca.get(r);if(s){if(eo(e,s.options)&&eo(n,s.config))return s;throw Fi.create("duplicate-app",{appName:r})}const o=new aS(r);for(const c of Yc.values())o.addComponent(c);const l=new iM(e,n,o);return Ca.set(r,l),l}function sM(i=jc){const t=Ca.get(i);if(!t&&i===jc&&Vp())return Wp();if(!t)throw Fi.create("no-app",{appName:i});return t}function es(i,t,e){var n;let r=(n=ZS[i])!==null&&n!==void 0?n:i;e&&(r+=`-${e}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const l=[`Unable to register library "${r}" with version "${t}":`];s&&l.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${t}" contains illegal characters (whitespace or "/")`),gi.warn(l.join(" "));return}Ia(new io(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oM="firebase-heartbeat-database",aM=1,ro="firebase-heartbeat-store";let Yl=null;function Xp(){return Yl||(Yl=ES(oM,aM,{upgrade:(i,t)=>{switch(t){case 0:try{i.createObjectStore(ro)}catch(e){console.warn(e)}}}}).catch(i=>{throw Fi.create("idb-open",{originalErrorMessage:i.message})})),Yl}async function lM(i){try{const e=(await Xp()).transaction(ro),n=await e.objectStore(ro).get(qp(i));return await e.done,n}catch(t){if(t instanceof _s)gi.warn(t.message);else{const e=Fi.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});gi.warn(e.message)}}}async function Jd(i,t){try{const n=(await Xp()).transaction(ro,"readwrite");await n.objectStore(ro).put(t,qp(i)),await n.done}catch(e){if(e instanceof _s)gi.warn(e.message);else{const n=Fi.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});gi.warn(n.message)}}}function qp(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cM=1024,hM=30;class uM{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new fM(e),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var t,e;try{const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=tf();if(((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:r}),this._heartbeatsCache.heartbeats.length>hM){const o=pM(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){gi.warn(n)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=tf(),{heartbeatsToSend:n,unsentEntries:r}=dM(this._heartbeatsCache.heartbeats),s=Ra(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return gi.warn(e),""}}}function tf(){return new Date().toISOString().substring(0,10)}function dM(i,t=cM){const e=[];let n=i.slice();for(const r of i){const s=e.find(o=>o.agent===r.agent);if(s){if(s.dates.push(r.date),ef(e)>t){s.dates.pop();break}}else if(e.push({agent:r.agent,dates:[r.date]}),ef(e)>t){e.pop();break}n=n.slice(1)}return{heartbeatsToSend:e,unsentEntries:n}}class fM{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ZT()?JT().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await lM(this.app);return e!=null&&e.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){const r=await this.read();return Jd(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:r.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var e;if(await this._canUseIndexedDBPromise){const r=await this.read();return Jd(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...t.heartbeats]})}else return}}function ef(i){return Ra(JSON.stringify({version:2,heartbeats:i})).length}function pM(i){if(i.length===0)return-1;let t=0,e=i[0].date;for(let n=1;n<i.length;n++)i[n].date<e&&(e=i[n].date,t=n);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mM(i){Ia(new io("platform-logger",t=>new SS(t),"PRIVATE")),Ia(new io("heartbeat",t=>new uM(t),"PRIVATE")),es($c,Qd,i),es($c,Qd,"esm2017"),es("fire-js","")}mM("");var gM="firebase",_M="11.7.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */es(gM,_M,"app");var nf=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gr=new zp("@firebase/firestore");function Wr(){return gr.logLevel}function xt(i,...t){if(gr.logLevel<=ue.DEBUG){const e=t.map(Dh);gr.debug(`Firestore (${vs}): ${i}`,...e)}}function _i(i,...t){if(gr.logLevel<=ue.ERROR){const e=t.map(Dh);gr.error(`Firestore (${vs}): ${i}`,...e)}}function ls(i,...t){if(gr.logLevel<=ue.WARN){const e=t.map(Dh);gr.warn(`Firestore (${vs}): ${i}`,...e)}}function Dh(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tm{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class vM{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(an.UNAUTHENTICATED))}shutdown(){}}class yM{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class EM{constructor(t){this.t=t,this.currentUser=an.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){_e(this.o===void 0,42304);let n=this.i;const r=c=>this.i!==n?(n=this.i,e(c)):Promise.resolve();let s=new Vi;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new Vi,t.enqueueRetryable(()=>r(this.currentUser))};const o=()=>{const c=s;t.enqueueRetryable(async()=>{await c.promise,await r(this.currentUser)})},l=c=>{xt("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(c=>l(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?l(c):(xt("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new Vi)}},0),o()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(n=>this.i!==t?(xt("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(_e(typeof n.accessToken=="string",31837,{l:n}),new tm(n.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return _e(t===null||typeof t=="string",2055,{h:t}),new an(t)}}class xM{constructor(t,e,n){this.P=t,this.T=e,this.I=n,this.type="FirstParty",this.user=an.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const t=this.R();return t&&this.A.set("Authorization",t),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class TM{constructor(t,e,n){this.P=t,this.T=e,this.I=n}getToken(){return Promise.resolve(new xM(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable(()=>e(an.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class of{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class SM{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,eM(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){_e(this.o===void 0,3512);const n=s=>{s.error!=null&&xt("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.m;return this.m=s.token,xt("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?e(s.token):Promise.resolve()};this.o=s=>{t.enqueueRetryable(()=>n(s))};const r=s=>{xt("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(s=>r(s)),setTimeout(()=>{if(!this.appCheck){const s=this.V.getImmediate({optional:!0});s?r(s):xt("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new of(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(_e(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new of(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MM(i){const t=typeof self<"u"&&(self.crypto||self.msCrypto),e=new Uint8Array(i);if(t&&typeof t.getRandomValues=="function")t.getRandomValues(e);else for(let n=0;n<i;n++)e[n]=Math.floor(256*Math.random());return e}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nm{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const r=MM(40);for(let s=0;s<r.length;++s)n.length<20&&r[s]<e&&(n+=t.charAt(r[s]%62))}return n}}function Zt(i,t){return i<t?-1:i>t?1:0}function Qc(i,t){let e=0;for(;e<i.length&&e<t.length;){const n=i.codePointAt(e),r=t.codePointAt(e);if(n!==r){if(n<128&&r<128)return Zt(n,r);{const s=em(),o=AM(s.encode(af(i,e)),s.encode(af(t,e)));return o!==0?o:Zt(n,r)}}e+=n>65535?2:1}return Zt(i.length,t.length)}function af(i,t){return i.codePointAt(t)>65535?i.substring(t,t+2):i.substring(t,t+1)}function AM(i,t){for(let e=0;e<i.length&&e<t.length;++e)if(i[e]!==t[e])return Zt(i[e],t[e]);return Zt(i.length,t.length)}function cs(i,t,e){return i.length===t.length&&i.every((n,r)=>e(n,t[r]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const so=-1;function bM(i,t){const e=i.toTimestamp().seconds,n=i.toTimestamp().nanoseconds+1,r=Gt.fromTimestamp(n===1e9?new Ge(e+1,0):new Ge(e,n));return new Hi(r,Lt.empty(),t)}function RM(i){return new Hi(i.readTime,i.key,so)}class Hi{constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}static min(){return new Hi(Gt.min(),Lt.empty(),so)}static max(){return new Hi(Gt.max(),Lt.empty(),so)}}function CM(i,t){let e=i.readTime.compareTo(t.readTime);return e!==0?e:(e=Lt.comparator(i.documentKey,t.documentKey),e!==0?e:Zt(i.largestBatchId,t.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IM="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class PM{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(t=>t())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ys(i){if(i.code!==st.FAILED_PRECONDITION||i.message!==IM)throw i;xt("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lh=-1;function Ya(i){return i==null}function Pa(i){return i===0&&1/i==-1/0}function LM(i){return typeof i=="number"&&Number.isInteger(i)&&!Pa(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const im="";function NM(i){let t="";for(let e=0;e<i.length;e++)t.length>0&&(t=uf(t)),t=UM(i.get(e),t);return uf(t)}function UM(i,t){let e=t;const n=i.length;for(let r=0;r<n;r++){const s=i.charAt(r);switch(s){case"\0":e+="";break;case im:e+="";break;default:e+=s}}return e}function uf(i){return i+im+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function df(i){let t=0;for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t++;return t}function yr(i,t){for(const e in i)Object.prototype.hasOwnProperty.call(i,e)&&t(e,i[e])}function rm(i){for(const t in i)if(Object.prototype.hasOwnProperty.call(i,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(t){this.comparator=t,this.data=new De(this.comparator)}has(t){return this.data.get(t)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal((e,n)=>(t(e),!1))}forEachInRange(t,e){const n=this.data.getIteratorFrom(t[0]);for(;n.hasNext();){const r=n.getNext();if(this.comparator(r.key,t[1])>=0)return;e(r.key)}}forEachWhile(t,e){let n;for(n=e!==void 0?this.data.getIteratorFrom(e):this.data.getIterator();n.hasNext();)if(!t(n.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new ff(this.data.getIterator())}getIteratorFrom(t){return new ff(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach(n=>{e=e.add(n)}),e}isEqual(t){if(!(t instanceof We)||this.size!==t.size)return!1;const e=this.data.getIterator(),n=t.data.getIterator();for(;e.hasNext();){const r=e.getNext().key,s=n.getNext().key;if(this.comparator(r,s)!==0)return!1}return!0}toArray(){const t=[];return this.forEach(e=>{t.push(e)}),t}toString(){const t=[];return this.forEach(e=>t.push(e)),"SortedSet("+t.toString()+")"}copy(t){const e=new We(this.comparator);return e.data=t,e}}class ff{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const om="server_timestamp",am="__type__",lm="__previous_value__",cm="__local_write_time__";function Nh(i){var t,e;return((e=(((t=i==null?void 0:i.mapValue)===null||t===void 0?void 0:t.fields)||{})[am])===null||e===void 0?void 0:e.stringValue)===om}function Ka(i){const t=i.mapValue.fields[lm];return Nh(t)?Ka(t):t}function oo(i){const t=Gi(i.mapValue.fields[cm].timestampValue);return new Ge(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OM{constructor(t,e,n,r,s,o,l,c,h,u){this.databaseId=t,this.appId=e,this.persistenceKey=n,this.host=r,this.ssl=s,this.forceLongPolling=o,this.autoDetectLongPolling=l,this.longPollingOptions=c,this.useFetchStreams=h,this.isUsingEmulator=u}}const Da="(default)";class ao{constructor(t,e){this.projectId=t,this.database=e||Da}static empty(){return new ao("","")}get isDefaultDatabase(){return this.database===Da}isEqual(t){return t instanceof ao&&t.projectId===this.projectId&&t.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hm="__type__",VM="__max__",sa={mapValue:{}},um="__vector__",La="value";function Xi(i){return"nullValue"in i?0:"booleanValue"in i?1:"integerValue"in i||"doubleValue"in i?2:"timestampValue"in i?3:"stringValue"in i?5:"bytesValue"in i?6:"referenceValue"in i?7:"geoPointValue"in i?8:"arrayValue"in i?9:"mapValue"in i?Nh(i)?4:kM(i)?9007199254740991:BM(i)?10:11:Bt(28295,{value:i})}function Zn(i,t){if(i===t)return!0;const e=Xi(i);if(e!==Xi(t))return!1;switch(e){case 0:case 9007199254740991:return!0;case 1:return i.booleanValue===t.booleanValue;case 4:return oo(i).isEqual(oo(t));case 3:return function(r,s){if(typeof r.timestampValue=="string"&&typeof s.timestampValue=="string"&&r.timestampValue.length===s.timestampValue.length)return r.timestampValue===s.timestampValue;const o=Gi(r.timestampValue),l=Gi(s.timestampValue);return o.seconds===l.seconds&&o.nanos===l.nanos}(i,t);case 5:return i.stringValue===t.stringValue;case 6:return function(r,s){return Wi(r.bytesValue).isEqual(Wi(s.bytesValue))}(i,t);case 7:return i.referenceValue===t.referenceValue;case 8:return function(r,s){return Ue(r.geoPointValue.latitude)===Ue(s.geoPointValue.latitude)&&Ue(r.geoPointValue.longitude)===Ue(s.geoPointValue.longitude)}(i,t);case 2:return function(r,s){if("integerValue"in r&&"integerValue"in s)return Ue(r.integerValue)===Ue(s.integerValue);if("doubleValue"in r&&"doubleValue"in s){const o=Ue(r.doubleValue),l=Ue(s.doubleValue);return o===l?Pa(o)===Pa(l):isNaN(o)&&isNaN(l)}return!1}(i,t);case 9:return cs(i.arrayValue.values||[],t.arrayValue.values||[],Zn);case 10:case 11:return function(r,s){const o=r.mapValue.fields||{},l=s.mapValue.fields||{};if(df(o)!==df(l))return!1;for(const c in o)if(o.hasOwnProperty(c)&&(l[c]===void 0||!Zn(o[c],l[c])))return!1;return!0}(i,t);default:return Bt(52216,{left:i})}}function lo(i,t){return(i.values||[]).find(e=>Zn(e,t))!==void 0}function hs(i,t){if(i===t)return 0;const e=Xi(i),n=Xi(t);if(e!==n)return Zt(e,n);switch(e){case 0:case 9007199254740991:return 0;case 1:return Zt(i.booleanValue,t.booleanValue);case 2:return function(s,o){const l=Ue(s.integerValue||s.doubleValue),c=Ue(o.integerValue||o.doubleValue);return l<c?-1:l>c?1:l===c?0:isNaN(l)?isNaN(c)?0:-1:1}(i,t);case 3:return pf(i.timestampValue,t.timestampValue);case 4:return pf(oo(i),oo(t));case 5:return Qc(i.stringValue,t.stringValue);case 6:return function(s,o){const l=Wi(s),c=Wi(o);return l.compareTo(c)}(i.bytesValue,t.bytesValue);case 7:return function(s,o){const l=s.split("/"),c=o.split("/");for(let h=0;h<l.length&&h<c.length;h++){const u=Zt(l[h],c[h]);if(u!==0)return u}return Zt(l.length,c.length)}(i.referenceValue,t.referenceValue);case 8:return function(s,o){const l=Zt(Ue(s.latitude),Ue(o.latitude));return l!==0?l:Zt(Ue(s.longitude),Ue(o.longitude))}(i.geoPointValue,t.geoPointValue);case 9:return mf(i.arrayValue,t.arrayValue);case 10:return function(s,o){var l,c,h,u;const d=s.fields||{},m=o.fields||{},_=(l=d[La])===null||l===void 0?void 0:l.arrayValue,x=(c=m[La])===null||c===void 0?void 0:c.arrayValue,M=Zt(((h=_==null?void 0:_.values)===null||h===void 0?void 0:h.length)||0,((u=x==null?void 0:x.values)===null||u===void 0?void 0:u.length)||0);return M!==0?M:mf(_,x)}(i.mapValue,t.mapValue);case 11:return function(s,o){if(s===sa.mapValue&&o===sa.mapValue)return 0;if(s===sa.mapValue)return 1;if(o===sa.mapValue)return-1;const l=s.fields||{},c=Object.keys(l),h=o.fields||{},u=Object.keys(h);c.sort(),u.sort();for(let d=0;d<c.length&&d<u.length;++d){const m=Qc(c[d],u[d]);if(m!==0)return m;const _=hs(l[c[d]],h[u[d]]);if(_!==0)return _}return Zt(c.length,u.length)}(i.mapValue,t.mapValue);default:throw Bt(23264,{Pe:e})}}function pf(i,t){if(typeof i=="string"&&typeof t=="string"&&i.length===t.length)return Zt(i,t);const e=Gi(i),n=Gi(t),r=Zt(e.seconds,n.seconds);return r!==0?r:Zt(e.nanos,n.nanos)}function mf(i,t){const e=i.values||[],n=t.values||[];for(let r=0;r<e.length&&r<n.length;++r){const s=hs(e[r],n[r]);if(s)return s}return Zt(e.length,n.length)}function us(i){return Zc(i)}function Zc(i){return"nullValue"in i?"null":"booleanValue"in i?""+i.booleanValue:"integerValue"in i?""+i.integerValue:"doubleValue"in i?""+i.doubleValue:"timestampValue"in i?function(e){const n=Gi(e);return`time(${n.seconds},${n.nanos})`}(i.timestampValue):"stringValue"in i?i.stringValue:"bytesValue"in i?function(e){return Wi(e).toBase64()}(i.bytesValue):"referenceValue"in i?function(e){return Lt.fromName(e).toString()}(i.referenceValue):"geoPointValue"in i?function(e){return`geo(${e.latitude},${e.longitude})`}(i.geoPointValue):"arrayValue"in i?function(e){let n="[",r=!0;for(const s of e.values||[])r?r=!1:n+=",",n+=Zc(s);return n+"]"}(i.arrayValue):"mapValue"in i?function(e){const n=Object.keys(e.fields||{}).sort();let r="{",s=!0;for(const o of n)s?s=!1:r+=",",r+=`${o}:${Zc(e.fields[o])}`;return r+"}"}(i.mapValue):Bt(61005,{value:i})}function ya(i){switch(Xi(i)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:const t=Ka(i);return t?16+ya(t):16;case 5:return 2*i.stringValue.length;case 6:return Wi(i.bytesValue).approximateByteSize();case 7:return i.referenceValue.length;case 9:return function(n){return(n.values||[]).reduce((r,s)=>r+ya(s),0)}(i.arrayValue);case 10:case 11:return function(n){let r=0;return yr(n.fields,(s,o)=>{r+=s.length+ya(o)}),r}(i.mapValue);default:throw Bt(13486,{value:i})}}function Jc(i){return!!i&&"integerValue"in i}function Uh(i){return!!i&&"arrayValue"in i}function gf(i){return!!i&&"nullValue"in i}function _f(i){return!!i&&"doubleValue"in i&&isNaN(Number(i.doubleValue))}function Ea(i){return!!i&&"mapValue"in i}function BM(i){var t,e;return((e=(((t=i==null?void 0:i.mapValue)===null||t===void 0?void 0:t.fields)||{})[hm])===null||e===void 0?void 0:e.stringValue)===um}function qs(i){if(i.geoPointValue)return{geoPointValue:Object.assign({},i.geoPointValue)};if(i.timestampValue&&typeof i.timestampValue=="object")return{timestampValue:Object.assign({},i.timestampValue)};if(i.mapValue){const t={mapValue:{fields:{}}};return yr(i.mapValue.fields,(e,n)=>t.mapValue.fields[e]=qs(n)),t}if(i.arrayValue){const t={arrayValue:{values:[]}};for(let e=0;e<(i.arrayValue.values||[]).length;++e)t.arrayValue.values[e]=qs(i.arrayValue.values[e]);return t}return Object.assign({},i)}function kM(i){return(((i.mapValue||{}).fields||{}).__type__||{}).stringValue===VM}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Na{constructor(t,e){this.position=t,this.inclusive=e}}function vf(i,t,e){let n=0;for(let r=0;r<i.position.length;r++){const s=t[r],o=i.position[r];if(s.field.isKeyField()?n=Lt.comparator(Lt.fromName(o.referenceValue),e.key):n=hs(o,e.data.field(s.field)),s.dir==="desc"&&(n*=-1),n!==0)break}return n}function yf(i,t){if(i===null)return t===null;if(t===null||i.inclusive!==t.inclusive||i.position.length!==t.position.length)return!1;for(let e=0;e<i.position.length;e++)if(!Zn(i.position[e],t.position[e]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ua{constructor(t,e="asc"){this.field=t,this.dir=e}}function zM(i,t){return i.dir===t.dir&&i.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fm{}class He extends fm{constructor(t,e,n){super(),this.field=t,this.op=e,this.value=n}static create(t,e,n){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,n):new GM(t,e,n):e==="array-contains"?new qM(t,n):e==="in"?new $M(t,n):e==="not-in"?new jM(t,n):e==="array-contains-any"?new YM(t,n):new He(t,e,n)}static createKeyFieldInFilter(t,e,n){return e==="in"?new WM(t,n):new XM(t,n)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&e.nullValue===void 0&&this.matchesComparison(hs(e,this.value)):e!==null&&Xi(this.value)===Xi(e)&&this.matchesComparison(hs(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return Bt(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Jn extends fm{constructor(t,e){super(),this.filters=t,this.op=e,this.Te=null}static create(t,e){return new Jn(t,e)}matches(t){return pm(this)?this.filters.find(e=>!e.matches(t))===void 0:this.filters.find(e=>e.matches(t))!==void 0}getFlattenedFilters(){return this.Te!==null||(this.Te=this.filters.reduce((t,e)=>t.concat(e.getFlattenedFilters()),[])),this.Te}getFilters(){return Object.assign([],this.filters)}}function pm(i){return i.op==="and"}function mm(i){return HM(i)&&pm(i)}function HM(i){for(const t of i.filters)if(t instanceof Jn)return!1;return!0}function th(i){if(i instanceof He)return i.field.canonicalString()+i.op.toString()+us(i.value);if(mm(i))return i.filters.map(t=>th(t)).join(",");{const t=i.filters.map(e=>th(e)).join(",");return`${i.op}(${t})`}}function gm(i,t){return i instanceof He?function(n,r){return r instanceof He&&n.op===r.op&&n.field.isEqual(r.field)&&Zn(n.value,r.value)}(i,t):i instanceof Jn?function(n,r){return r instanceof Jn&&n.op===r.op&&n.filters.length===r.filters.length?n.filters.reduce((s,o,l)=>s&&gm(o,r.filters[l]),!0):!1}(i,t):void Bt(19439)}function _m(i){return i instanceof He?function(e){return`${e.field.canonicalString()} ${e.op} ${us(e.value)}`}(i):i instanceof Jn?function(e){return e.op.toString()+" {"+e.getFilters().map(_m).join(" ,")+"}"}(i):"Filter"}class GM extends He{constructor(t,e,n){super(t,e,n),this.key=Lt.fromName(n.referenceValue)}matches(t){const e=Lt.comparator(t.key,this.key);return this.matchesComparison(e)}}class WM extends He{constructor(t,e){super(t,"in",e),this.keys=vm("in",e)}matches(t){return this.keys.some(e=>e.isEqual(t.key))}}class XM extends He{constructor(t,e){super(t,"not-in",e),this.keys=vm("not-in",e)}matches(t){return!this.keys.some(e=>e.isEqual(t.key))}}function vm(i,t){var e;return(((e=t.arrayValue)===null||e===void 0?void 0:e.values)||[]).map(n=>Lt.fromName(n.referenceValue))}class qM extends He{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return Uh(e)&&lo(e.arrayValue,this.value)}}class $M extends He{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&lo(this.value.arrayValue,e)}}class jM extends He{constructor(t,e){super(t,"not-in",e)}matches(t){if(lo(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&e.nullValue===void 0&&!lo(this.value.arrayValue,e)}}class YM extends He{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!Uh(e)||!e.arrayValue.values)&&e.arrayValue.values.some(n=>lo(this.value.arrayValue,n))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KM{constructor(t,e=null,n=[],r=[],s=null,o=null,l=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=r,this.limit=s,this.startAt=o,this.endAt=l,this.Ie=null}}function Ef(i,t=null,e=[],n=[],r=null,s=null,o=null){return new KM(i,t,e,n,r,s,o)}function Fh(i){const t=$t(i);if(t.Ie===null){let e=t.path.canonicalString();t.collectionGroup!==null&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map(n=>th(n)).join(","),e+="|ob:",e+=t.orderBy.map(n=>function(s){return s.field.canonicalString()+s.dir}(n)).join(","),Ya(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(n=>us(n)).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(n=>us(n)).join(",")),t.Ie=e}return t.Ie}function Oh(i,t){if(i.limit!==t.limit||i.orderBy.length!==t.orderBy.length)return!1;for(let e=0;e<i.orderBy.length;e++)if(!zM(i.orderBy[e],t.orderBy[e]))return!1;if(i.filters.length!==t.filters.length)return!1;for(let e=0;e<i.filters.length;e++)if(!gm(i.filters[e],t.filters[e]))return!1;return i.collectionGroup===t.collectionGroup&&!!i.path.isEqual(t.path)&&!!yf(i.startAt,t.startAt)&&yf(i.endAt,t.endAt)}function eh(i){return Lt.isDocumentKey(i.path)&&i.collectionGroup===null&&i.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qa{constructor(t,e=null,n=[],r=[],s=null,o="F",l=null,c=null){this.path=t,this.collectionGroup=e,this.explicitOrderBy=n,this.filters=r,this.limit=s,this.limitType=o,this.startAt=l,this.endAt=c,this.Ee=null,this.de=null,this.Ae=null,this.startAt,this.endAt}}function QM(i,t,e,n,r,s,o,l){return new Qa(i,t,e,n,r,s,o,l)}function ym(i){return new Qa(i)}function xf(i){return i.filters.length===0&&i.limit===null&&i.startAt==null&&i.endAt==null&&(i.explicitOrderBy.length===0||i.explicitOrderBy.length===1&&i.explicitOrderBy[0].field.isKeyField())}function ZM(i){return i.collectionGroup!==null}function $s(i){const t=$t(i);if(t.Ee===null){t.Ee=[];const e=new Set;for(const s of t.explicitOrderBy)t.Ee.push(s),e.add(s.field.canonicalString());const n=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";(function(o){let l=new We(Ze.comparator);return o.filters.forEach(c=>{c.getFlattenedFilters().forEach(h=>{h.isInequality()&&(l=l.add(h.field))})}),l})(t).forEach(s=>{e.has(s.canonicalString())||s.isKeyField()||t.Ee.push(new Ua(s,n))}),e.has(Ze.keyField().canonicalString())||t.Ee.push(new Ua(Ze.keyField(),n))}return t.Ee}function $n(i){const t=$t(i);return t.de||(t.de=JM(t,$s(i))),t.de}function JM(i,t){if(i.limitType==="F")return Ef(i.path,i.collectionGroup,t,i.filters,i.limit,i.startAt,i.endAt);{t=t.map(r=>{const s=r.dir==="desc"?"asc":"desc";return new Ua(r.field,s)});const e=i.endAt?new Na(i.endAt.position,i.endAt.inclusive):null,n=i.startAt?new Na(i.startAt.position,i.startAt.inclusive):null;return Ef(i.path,i.collectionGroup,t,i.filters,i.limit,e,n)}}function nh(i,t,e){return new Qa(i.path,i.collectionGroup,i.explicitOrderBy.slice(),i.filters.slice(),t,e,i.startAt,i.endAt)}function Za(i,t){return Oh($n(i),$n(t))&&i.limitType===t.limitType}function Em(i){return`${Fh($n(i))}|lt:${i.limitType}`}function Xr(i){return`Query(target=${function(e){let n=e.path.canonicalString();return e.collectionGroup!==null&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(r=>_m(r)).join(", ")}]`),Ya(e.limit)||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(r=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(r)).join(", ")}]`),e.startAt&&(n+=", startAt: ",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>us(r)).join(",")),e.endAt&&(n+=", endAt: ",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>us(r)).join(",")),`Target(${n})`}($n(i))}; limitType=${i.limitType})`}function Ja(i,t){return t.isFoundDocument()&&function(n,r){const s=r.key.path;return n.collectionGroup!==null?r.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(s):Lt.isDocumentKey(n.path)?n.path.isEqual(s):n.path.isImmediateParentOf(s)}(i,t)&&function(n,r){for(const s of $s(n))if(!s.field.isKeyField()&&r.data.field(s.field)===null)return!1;return!0}(i,t)&&function(n,r){for(const s of n.filters)if(!s.matches(r))return!1;return!0}(i,t)&&function(n,r){return!(n.startAt&&!function(o,l,c){const h=vf(o,l,c);return o.inclusive?h<=0:h<0}(n.startAt,$s(n),r)||n.endAt&&!function(o,l,c){const h=vf(o,l,c);return o.inclusive?h>=0:h>0}(n.endAt,$s(n),r))}(i,t)}function tA(i){return i.collectionGroup||(i.path.length%2==1?i.path.lastSegment():i.path.get(i.path.length-2))}function xm(i){return(t,e)=>{let n=!1;for(const r of $s(i)){const s=eA(r,t,e);if(s!==0)return s;n=n||r.field.isKeyField()}return 0}}function eA(i,t,e){const n=i.field.isKeyField()?Lt.comparator(t.key,e.key):function(s,o,l){const c=o.data.field(s),h=l.data.field(s);return c!==null&&h!==null?hs(c,h):Bt(42886)}(i.field,t,e);switch(i.dir){case"asc":return n;case"desc":return-1*n;default:return Bt(19790,{direction:i.dir})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nA=new De(Lt.comparator);function vi(){return nA}const Tm=new De(Lt.comparator);function Gs(...i){let t=Tm;for(const e of i)t=t.insert(e.key,e);return t}function Sm(i){let t=Tm;return i.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function ur(){return js()}function Mm(){return js()}function js(){return new Er(i=>i.toString(),(i,t)=>i.isEqual(t))}const iA=new De(Lt.comparator),rA=new We(Lt.comparator);function se(...i){let t=rA;for(const e of i)t=t.add(e);return t}const sA=new We(Zt);function oA(){return sA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vh(i,t){if(i.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Pa(t)?"-0":t}}function Am(i){return{integerValue:""+i}}function aA(i,t){return LM(t)?Am(t):Vh(i,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tl{constructor(){this._=void 0}}function lA(i,t,e){return i instanceof Fa?function(r,s){const o={fields:{[am]:{stringValue:om},[cm]:{timestampValue:{seconds:r.seconds,nanos:r.nanoseconds}}}};return s&&Nh(s)&&(s=Ka(s)),s&&(o.fields[lm]=s),{mapValue:o}}(e,t):i instanceof ds?bm(i,t):i instanceof co?Rm(i,t):function(r,s){const o=wm(r,s),l=Tf(o)+Tf(r.Re);return Jc(o)&&Jc(r.Re)?Am(l):Vh(r.serializer,l)}(i,t)}function cA(i,t,e){return i instanceof ds?bm(i,t):i instanceof co?Rm(i,t):e}function wm(i,t){return i instanceof Oa?function(n){return Jc(n)||function(s){return!!s&&"doubleValue"in s}(n)}(t)?t:{integerValue:0}:null}class Fa extends tl{}class ds extends tl{constructor(t){super(),this.elements=t}}function bm(i,t){const e=Cm(t);for(const n of i.elements)e.some(r=>Zn(r,n))||e.push(n);return{arrayValue:{values:e}}}class co extends tl{constructor(t){super(),this.elements=t}}function Rm(i,t){let e=Cm(t);for(const n of i.elements)e=e.filter(r=>!Zn(r,n));return{arrayValue:{values:e}}}class Oa extends tl{constructor(t,e){super(),this.serializer=t,this.Re=e}}function Tf(i){return Ue(i.integerValue||i.doubleValue)}function Cm(i){return Uh(i)&&i.arrayValue.values?i.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hA{constructor(t,e){this.field=t,this.transform=e}}function uA(i,t){return i.field.isEqual(t.field)&&function(n,r){return n instanceof ds&&r instanceof ds||n instanceof co&&r instanceof co?cs(n.elements,r.elements,Zn):n instanceof Oa&&r instanceof Oa?Zn(n.Re,r.Re):n instanceof Fa&&r instanceof Fa}(i.transform,t.transform)}class dA{constructor(t,e){this.version=t,this.transformResults=e}}class mi{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new mi}static exists(t){return new mi(void 0,t)}static updateTime(t){return new mi(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function xa(i,t){return i.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(i.updateTime):i.exists===void 0||i.exists===t.isFoundDocument()}class el{}function Im(i,t){if(!i.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return i.isNoDocument()?new Dm(i.key,mi.none()):new vo(i.key,i.data,mi.none());{const e=i.data,n=Cn.empty();let r=new We(Ze.comparator);for(let s of t.fields)if(!r.has(s)){let o=e.field(s);o===null&&s.length>1&&(s=s.popLast(),o=e.field(s)),o===null?n.delete(s):n.set(s,o),r=r.add(s)}return new xr(i.key,n,new Vn(r.toArray()),mi.none())}}function fA(i,t,e){i instanceof vo?function(r,s,o){const l=r.value.clone(),c=Mf(r.fieldTransforms,s,o.transformResults);l.setAll(c),s.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(i,t,e):i instanceof xr?function(r,s,o){if(!xa(r.precondition,s))return void s.convertToUnknownDocument(o.version);const l=Mf(r.fieldTransforms,s,o.transformResults),c=s.data;c.setAll(Pm(r)),c.setAll(l),s.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(i,t,e):function(r,s,o){s.convertToNoDocument(o.version).setHasCommittedMutations()}(0,t,e)}function Ys(i,t,e,n){return i instanceof vo?function(s,o,l,c){if(!xa(s.precondition,o))return l;const h=s.value.clone(),u=Af(s.fieldTransforms,c,o);return h.setAll(u),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),null}(i,t,e,n):i instanceof xr?function(s,o,l,c){if(!xa(s.precondition,o))return l;const h=Af(s.fieldTransforms,c,o),u=o.data;return u.setAll(Pm(s)),u.setAll(h),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),l===null?null:l.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map(d=>d.field))}(i,t,e,n):function(s,o,l){return xa(s.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):l}(i,t,e)}function pA(i,t){let e=null;for(const n of i.fieldTransforms){const r=t.data.field(n.field),s=wm(n.transform,r||null);s!=null&&(e===null&&(e=Cn.empty()),e.set(n.field,s))}return e||null}function Sf(i,t){return i.type===t.type&&!!i.key.isEqual(t.key)&&!!i.precondition.isEqual(t.precondition)&&!!function(n,r){return n===void 0&&r===void 0||!(!n||!r)&&cs(n,r,(s,o)=>uA(s,o))}(i.fieldTransforms,t.fieldTransforms)&&(i.type===0?i.value.isEqual(t.value):i.type!==1||i.data.isEqual(t.data)&&i.fieldMask.isEqual(t.fieldMask))}class vo extends el{constructor(t,e,n,r=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class xr extends el{constructor(t,e,n,r,s=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=r,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function Pm(i){const t=new Map;return i.fieldMask.fields.forEach(e=>{if(!e.isEmpty()){const n=i.data.field(e);t.set(e,n)}}),t}function Mf(i,t,e){const n=new Map;_e(i.length===e.length,32656,{Ve:e.length,me:i.length});for(let r=0;r<e.length;r++){const s=i[r],o=s.transform,l=t.data.field(s.field);n.set(s.field,cA(o,l,e[r]))}return n}function Af(i,t,e){const n=new Map;for(const r of i){const s=r.transform,o=e.data.field(r.field);n.set(r.field,lA(s,o,t))}return n}class Dm extends el{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class mA extends el{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const EA=new Oi([4294967295,4294967295],0);function wf(i){const t=em().encode(i),e=new $p;return e.update(t),new Uint8Array(e.digest())}function bf(i){const t=new DataView(i.buffer),e=t.getUint32(0,!0),n=t.getUint32(4,!0),r=t.getUint32(8,!0),s=t.getUint32(12,!0);return[new Oi([e,n],0),new Oi([r,s],0)]}class kh{constructor(t,e,n){if(this.bitmap=t,this.padding=e,this.hashCount=n,e<0||e>=8)throw new Ws(`Invalid padding: ${e}`);if(n<0)throw new Ws(`Invalid hash count: ${n}`);if(t.length>0&&this.hashCount===0)throw new Ws(`Invalid hash count: ${n}`);if(t.length===0&&e!==0)throw new Ws(`Invalid padding when bitmap length is 0: ${e}`);this.pe=8*t.length-e,this.ye=Oi.fromNumber(this.pe)}we(t,e,n){let r=t.add(e.multiply(Oi.fromNumber(n)));return r.compare(EA)===1&&(r=new Oi([r.getBits(0),r.getBits(1)],0)),r.modulo(this.ye).toNumber()}be(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(this.pe===0)return!1;const e=wf(t),[n,r]=bf(e);for(let s=0;s<this.hashCount;s++){const o=this.we(n,r,s);if(!this.be(o))return!1}return!0}static create(t,e,n){const r=t%8==0?0:8-t%8,s=new Uint8Array(Math.ceil(t/8)),o=new kh(s,r,e);return n.forEach(l=>o.insert(l)),o}insert(t){if(this.pe===0)return;const e=wf(t),[n,r]=bf(e);for(let s=0;s<this.hashCount;s++){const o=this.we(n,r,s);this.Se(o)}}Se(t){const e=Math.floor(t/8),n=t%8;this.bitmap[e]|=1<<n}}class Ws extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ta{constructor(t,e,n,r){this.De=t,this.removedTargetIds=e,this.key=n,this.ve=r}}class Nm{constructor(t,e){this.targetId=t,this.Ce=e}}class Um{constructor(t,e,n=Je.EMPTY_BYTE_STRING,r=null){this.state=t,this.targetIds=e,this.resumeToken=n,this.cause=r}}class Rf{constructor(){this.Fe=0,this.Me=Cf(),this.xe=Je.EMPTY_BYTE_STRING,this.Oe=!1,this.Ne=!0}get current(){return this.Oe}get resumeToken(){return this.xe}get Be(){return this.Fe!==0}get Le(){return this.Ne}ke(t){t.approximateByteSize()>0&&(this.Ne=!0,this.xe=t)}qe(){let t=se(),e=se(),n=se();return this.Me.forEach((r,s)=>{switch(s){case 0:t=t.add(r);break;case 2:e=e.add(r);break;case 1:n=n.add(r);break;default:Bt(38017,{changeType:s})}}),new yo(this.xe,this.Oe,t,e,n)}Qe(){this.Ne=!1,this.Me=Cf()}$e(t,e){this.Ne=!0,this.Me=this.Me.insert(t,e)}Ue(t){this.Ne=!0,this.Me=this.Me.remove(t)}Ke(){this.Fe+=1}We(){this.Fe-=1,_e(this.Fe>=0,3241,{Fe:this.Fe})}Ge(){this.Ne=!0,this.Oe=!0}}class xA{constructor(t){this.ze=t,this.je=new Map,this.He=vi(),this.Je=oa(),this.Ye=oa(),this.Ze=new De(Zt)}Xe(t){for(const e of t.De)t.ve&&t.ve.isFoundDocument()?this.et(e,t.ve):this.tt(e,t.key,t.ve);for(const e of t.removedTargetIds)this.tt(e,t.key,t.ve)}nt(t){this.forEachTarget(t,e=>{const n=this.rt(e);switch(t.state){case 0:this.it(e)&&n.ke(t.resumeToken);break;case 1:n.We(),n.Be||n.Qe(),n.ke(t.resumeToken);break;case 2:n.We(),n.Be||this.removeTarget(e);break;case 3:this.it(e)&&(n.Ge(),n.ke(t.resumeToken));break;case 4:this.it(e)&&(this.st(e),n.ke(t.resumeToken));break;default:Bt(56790,{state:t.state})}})}forEachTarget(t,e){t.targetIds.length>0?t.targetIds.forEach(e):this.je.forEach((n,r)=>{this.it(r)&&e(r)})}ot(t){const e=t.targetId,n=t.Ce.count,r=this._t(e);if(r){const s=r.target;if(eh(s))if(n===0){const o=new Lt(s.path);this.tt(e,o,ln.newNoDocument(o,Gt.min()))}else _e(n===1,20013,{expectedCount:n});else{const o=this.ut(e);if(o!==n){const l=this.ct(t),c=l?this.lt(l,t,o):1;if(c!==0){this.st(e);const h=c===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ze=this.Ze.insert(e,h)}}}}}ct(t){const e=t.Ce.unchangedNames;if(!e||!e.bits)return null;const{bits:{bitmap:n="",padding:r=0},hashCount:s=0}=e;let o,l;try{o=Wi(n).toUint8Array()}catch(c){if(c instanceof sm)return ls("Decoding the base64 bloom filter in existence filter failed ("+c.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw c}try{l=new kh(o,r,s)}catch(c){return ls(c instanceof Ws?"BloomFilter error: ":"Applying bloom filter failed: ",c),null}return l.pe===0?null:l}lt(t,e,n){return e.Ce.count===n-this.Tt(t,e.targetId)?0:2}Tt(t,e){const n=this.ze.getRemoteKeysForTarget(e);let r=0;return n.forEach(s=>{const o=this.ze.Pt(),l=`projects/${o.projectId}/databases/${o.database}/documents/${s.path.canonicalString()}`;t.mightContain(l)||(this.tt(e,s,null),r++)}),r}It(t){const e=new Map;this.je.forEach((s,o)=>{const l=this._t(o);if(l){if(s.current&&eh(l.target)){const c=new Lt(l.target.path);this.Et(c).has(o)||this.dt(o,c)||this.tt(o,c,ln.newNoDocument(c,t))}s.Le&&(e.set(o,s.qe()),s.Qe())}});let n=se();this.Ye.forEach((s,o)=>{let l=!0;o.forEachWhile(c=>{const h=this._t(c);return!h||h.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)}),l&&(n=n.add(s))}),this.He.forEach((s,o)=>o.setReadTime(t));const r=new nl(t,e,this.Ze,this.He,n);return this.He=vi(),this.Je=oa(),this.Ye=oa(),this.Ze=new De(Zt),r}et(t,e){if(!this.it(t))return;const n=this.dt(t,e.key)?2:0;this.rt(t).$e(e.key,n),this.He=this.He.insert(e.key,e),this.Je=this.Je.insert(e.key,this.Et(e.key).add(t)),this.Ye=this.Ye.insert(e.key,this.At(e.key).add(t))}tt(t,e,n){if(!this.it(t))return;const r=this.rt(t);this.dt(t,e)?r.$e(e,1):r.Ue(e),this.Ye=this.Ye.insert(e,this.At(e).delete(t)),this.Ye=this.Ye.insert(e,this.At(e).add(t)),n&&(this.He=this.He.insert(e,n))}removeTarget(t){this.je.delete(t)}ut(t){const e=this.rt(t).qe();return this.ze.getRemoteKeysForTarget(t).size+e.addedDocuments.size-e.removedDocuments.size}Ke(t){this.rt(t).Ke()}rt(t){let e=this.je.get(t);return e||(e=new Rf,this.je.set(t,e)),e}At(t){let e=this.Ye.get(t);return e||(e=new We(Zt),this.Ye=this.Ye.insert(t,e)),e}Et(t){let e=this.Je.get(t);return e||(e=new We(Zt),this.Je=this.Je.insert(t,e)),e}it(t){const e=this._t(t)!==null;return e||xt("WatchChangeAggregator","Detected inactive target",t),e}_t(t){const e=this.je.get(t);return e&&e.Be?null:this.ze.Rt(t)}st(t){this.je.set(t,new Rf),this.ze.getRemoteKeysForTarget(t).forEach(e=>{this.tt(t,e,null)})}dt(t,e){return this.ze.getRemoteKeysForTarget(t).has(e)}}function oa(){return new De(Lt.comparator)}function Cf(){return new De(Lt.comparator)}const TA={asc:"ASCENDING",desc:"DESCENDING"},SA={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},MA={and:"AND",or:"OR"};class AA{constructor(t,e){this.databaseId=t,this.useProto3Json=e}}function ih(i,t){return i.useProto3Json||Ya(t)?t:{value:t}}function Va(i,t){return i.useProto3Json?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function Fm(i,t){return i.useProto3Json?t.toBase64():t.toUint8Array()}function wA(i,t){return Va(i,t.toTimestamp())}function jn(i){return _e(!!i,49232),Gt.fromTimestamp(function(e){const n=Gi(e);return new Ge(n.seconds,n.nanos)}(i))}function zh(i,t){return rh(i,t).canonicalString()}function rh(i,t){const e=function(r){return new Pe(["projects",r.projectId,"databases",r.database])}(i).child("documents");return t===void 0?e:e.child(t)}function Om(i){const t=Pe.fromString(i);return _e(Hm(t),10190,{key:t.toString()}),t}function sh(i,t){return zh(i.databaseId,t.path)}function Kl(i,t){const e=Om(t);if(e.get(1)!==i.databaseId.projectId)throw new It(st.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+e.get(1)+" vs "+i.databaseId.projectId);if(e.get(3)!==i.databaseId.database)throw new It(st.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+e.get(3)+" vs "+i.databaseId.database);return new Lt(Bm(e))}function Vm(i,t){return zh(i.databaseId,t)}function bA(i){const t=Om(i);return t.length===4?Pe.emptyPath():Bm(t)}function oh(i){return new Pe(["projects",i.databaseId.projectId,"databases",i.databaseId.database]).canonicalString()}function Bm(i){return _e(i.length>4&&i.get(4)==="documents",29091,{key:i.toString()}),i.popFirst(5)}function If(i,t,e){return{name:sh(i,t),fields:e.value.mapValue.fields}}function RA(i,t){let e;if("targetChange"in t){t.targetChange;const n=function(h){return h==="NO_CHANGE"?0:h==="ADD"?1:h==="REMOVE"?2:h==="CURRENT"?3:h==="RESET"?4:Bt(39313,{state:h})}(t.targetChange.targetChangeType||"NO_CHANGE"),r=t.targetChange.targetIds||[],s=function(h,u){return h.useProto3Json?(_e(u===void 0||typeof u=="string",58123),Je.fromBase64String(u||"")):(_e(u===void 0||u instanceof Buffer||u instanceof Uint8Array,16193),Je.fromUint8Array(u||new Uint8Array))}(i,t.targetChange.resumeToken),o=t.targetChange.cause,l=o&&function(h){const u=h.code===void 0?st.UNKNOWN:Lm(h.code);return new It(u,h.message||"")}(o);e=new Um(n,r,s,l||null)}else if("documentChange"in t){t.documentChange;const n=t.documentChange;n.document,n.document.name,n.document.updateTime;const r=Kl(i,n.document.name),s=jn(n.document.updateTime),o=n.document.createTime?jn(n.document.createTime):Gt.min(),l=new Cn({mapValue:{fields:n.document.fields}}),c=ln.newFoundDocument(r,s,o,l),h=n.targetIds||[],u=n.removedTargetIds||[];e=new Ta(h,u,c.key,c)}else if("documentDelete"in t){t.documentDelete;const n=t.documentDelete;n.document;const r=Kl(i,n.document),s=n.readTime?jn(n.readTime):Gt.min(),o=ln.newNoDocument(r,s),l=n.removedTargetIds||[];e=new Ta([],l,o.key,o)}else if("documentRemove"in t){t.documentRemove;const n=t.documentRemove;n.document;const r=Kl(i,n.document),s=n.removedTargetIds||[];e=new Ta([],s,r,null)}else{if(!("filter"in t))return Bt(11601,{Vt:t});{t.filter;const n=t.filter;n.targetId;const{count:r=0,unchangedNames:s}=n,o=new vA(r,s),l=n.targetId;e=new Nm(l,o)}}return e}function CA(i,t){let e;if(t instanceof vo)e={update:If(i,t.key,t.value)};else if(t instanceof Dm)e={delete:sh(i,t.key)};else if(t instanceof xr)e={update:If(i,t.key,t.data),updateMask:VA(t.fieldMask)};else{if(!(t instanceof mA))return Bt(16599,{ft:t.type});e={verify:sh(i,t.key)}}return t.fieldTransforms.length>0&&(e.updateTransforms=t.fieldTransforms.map(n=>function(s,o){const l=o.transform;if(l instanceof Fa)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof ds)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof co)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof Oa)return{fieldPath:o.field.canonicalString(),increment:l.Re};throw Bt(20930,{transform:o.transform})}(0,n))),t.precondition.isNone||(e.currentDocument=function(r,s){return s.updateTime!==void 0?{updateTime:wA(r,s.updateTime)}:s.exists!==void 0?{exists:s.exists}:Bt(27497)}(i,t.precondition)),e}function IA(i,t){return i&&i.length>0?(_e(t!==void 0,14353),i.map(e=>function(r,s){let o=r.updateTime?jn(r.updateTime):jn(s);return o.isEqual(Gt.min())&&(o=jn(s)),new dA(o,r.transformResults||[])}(e,t))):[]}function PA(i,t){return{documents:[Vm(i,t.path)]}}function DA(i,t){const e={structuredQuery:{}},n=t.path;let r;t.collectionGroup!==null?(r=n,e.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(r=n.popLast(),e.structuredQuery.from=[{collectionId:n.lastSegment()}]),e.parent=Vm(i,r);const s=function(h){if(h.length!==0)return zm(Jn.create(h,"and"))}(t.filters);s&&(e.structuredQuery.where=s);const o=function(h){if(h.length!==0)return h.map(u=>function(m){return{field:qr(m.field),direction:UA(m.dir)}}(u))}(t.orderBy);o&&(e.structuredQuery.orderBy=o);const l=ih(i,t.limit);return l!==null&&(e.structuredQuery.limit=l),t.startAt&&(e.structuredQuery.startAt=function(h){return{before:h.inclusive,values:h.position}}(t.startAt)),t.endAt&&(e.structuredQuery.endAt=function(h){return{before:!h.inclusive,values:h.position}}(t.endAt)),{gt:e,parent:r}}function LA(i){let t=bA(i.parent);const e=i.structuredQuery,n=e.from?e.from.length:0;let r=null;if(n>0){_e(n===1,65062);const u=e.from[0];u.allDescendants?r=u.collectionId:t=t.child(u.collectionId)}let s=[];e.where&&(s=function(d){const m=km(d);return m instanceof Jn&&mm(m)?m.getFilters():[m]}(e.where));let o=[];e.orderBy&&(o=function(d){return d.map(m=>function(x){return new Ua($r(x.field),function(g){switch(g){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(x.direction))}(m))}(e.orderBy));let l=null;e.limit&&(l=function(d){let m;return m=typeof d=="object"?d.value:d,Ya(m)?null:m}(e.limit));let c=null;e.startAt&&(c=function(d){const m=!!d.before,_=d.values||[];return new Na(_,m)}(e.startAt));let h=null;return e.endAt&&(h=function(d){const m=!d.before,_=d.values||[];return new Na(_,m)}(e.endAt)),QM(t,r,o,s,l,"F",c,h)}function NA(i,t){const e=function(r){switch(r){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return Bt(28987,{purpose:r})}}(t.purpose);return e==null?null:{"goog-listen-tags":e}}function km(i){return i.unaryFilter!==void 0?function(e){switch(e.unaryFilter.op){case"IS_NAN":const n=$r(e.unaryFilter.field);return He.create(n,"==",{doubleValue:NaN});case"IS_NULL":const r=$r(e.unaryFilter.field);return He.create(r,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const s=$r(e.unaryFilter.field);return He.create(s,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=$r(e.unaryFilter.field);return He.create(o,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return Bt(61313);default:return Bt(60726)}}(i):i.fieldFilter!==void 0?function(e){return He.create($r(e.fieldFilter.field),function(r){switch(r){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return Bt(58110);default:return Bt(50506)}}(e.fieldFilter.op),e.fieldFilter.value)}(i):i.compositeFilter!==void 0?function(e){return Jn.create(e.compositeFilter.filters.map(n=>km(n)),function(r){switch(r){case"AND":return"and";case"OR":return"or";default:return Bt(1026)}}(e.compositeFilter.op))}(i):Bt(30097,{filter:i})}function UA(i){return TA[i]}function FA(i){return SA[i]}function OA(i){return MA[i]}function qr(i){return{fieldPath:i.canonicalString()}}function $r(i){return Ze.fromServerFormat(i.fieldPath)}function zm(i){return i instanceof He?function(e){if(e.op==="=="){if(_f(e.value))return{unaryFilter:{field:qr(e.field),op:"IS_NAN"}};if(gf(e.value))return{unaryFilter:{field:qr(e.field),op:"IS_NULL"}}}else if(e.op==="!="){if(_f(e.value))return{unaryFilter:{field:qr(e.field),op:"IS_NOT_NAN"}};if(gf(e.value))return{unaryFilter:{field:qr(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:qr(e.field),op:FA(e.op),value:e.value}}}(i):i instanceof Jn?function(e){const n=e.getFilters().map(r=>zm(r));return n.length===1?n[0]:{compositeFilter:{op:OA(e.op),filters:n}}}(i):Bt(54877,{filter:i})}function VA(i){const t=[];return i.fields.forEach(e=>t.push(e.canonicalString())),{fieldPaths:t}}function Hm(i){return i.length>=4&&i.get(0)==="projects"&&i.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BA{constructor(t){this.wt=t}}function kA(i){const t=LA({parent:i.parent,structuredQuery:i.structuredQuery});return i.limitType==="LAST"?nh(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Df="LruGarbageCollector",GA=1048576;function Lf([i,t],[e,n]){const r=Zt(i,e);return r===0?Zt(t,n):r}class WA{constructor(t){this.cr=t,this.buffer=new We(Lf),this.lr=0}hr(){return++this.lr}Pr(t){const e=[t,this.hr()];if(this.buffer.size<this.cr)this.buffer=this.buffer.add(e);else{const n=this.buffer.last();Lf(e,n)<0&&(this.buffer=this.buffer.delete(n).add(e))}}get maxValue(){return this.buffer.last()[0]}}class XA{constructor(t,e,n){this.garbageCollector=t,this.asyncQueue=e,this.localStore=n,this.Tr=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.Ir(6e4)}stop(){this.Tr&&(this.Tr.cancel(),this.Tr=null)}get started(){return this.Tr!==null}Ir(t){xt(Df,`Garbage collection scheduled in ${t}ms`),this.Tr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",t,async()=>{this.Tr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(e){Es(e)?xt(Df,"Ignoring IndexedDB error during garbage collection: ",e):await ys(e)}await this.Ir(3e5)})}}class qA{constructor(t,e){this.Er=t,this.params=e}calculateTargetCount(t,e){return this.Er.dr(t).next(n=>Math.floor(e/100*n))}nthSequenceNumber(t,e){if(e===0)return J.resolve(ja.le);const n=new WA(e);return this.Er.forEachTarget(t,r=>n.Pr(r.sequenceNumber)).next(()=>this.Er.Ar(t,r=>n.Pr(r))).next(()=>n.maxValue)}removeTargets(t,e,n){return this.Er.removeTargets(t,e,n)}removeOrphanedDocuments(t,e){return this.Er.removeOrphanedDocuments(t,e)}collect(t,e){return this.params.cacheSizeCollectionThreshold===-1?(xt("LruGarbageCollector","Garbage collection skipped; disabled"),J.resolve(Pf)):this.getCacheSize(t).next(n=>n<this.params.cacheSizeCollectionThreshold?(xt("LruGarbageCollector",`Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),Pf):this.Rr(t,e))}getCacheSize(t){return this.Er.getCacheSize(t)}Rr(t,e){let n,r,s,o,l,c,h;const u=Date.now();return this.calculateTargetCount(t,this.params.percentileToCollect).next(d=>(d>this.params.maximumSequenceNumbersToCollect?(xt("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${d}`),r=this.params.maximumSequenceNumbersToCollect):r=d,o=Date.now(),this.nthSequenceNumber(t,r))).next(d=>(n=d,l=Date.now(),this.removeTargets(t,n,e))).next(d=>(s=d,c=Date.now(),this.removeOrphanedDocuments(t,n))).next(d=>(h=Date.now(),Wr()<=ue.DEBUG&&xt("LruGarbageCollector",`LRU Garbage Collection
	Counted targets in ${o-u}ms
	Determined least recently used ${r} in `+(l-o)+`ms
	Removed ${s} targets in `+(c-l)+`ms
	Removed ${d} documents in `+(h-c)+`ms
Total Duration: ${h-u}ms`),J.resolve({didRun:!0,sequenceNumbersCollected:r,targetsRemoved:s,documentsRemoved:d})))}}function $A(i,t){return new qA(i,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jA{constructor(){this.changes=new Er(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,ln.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return n!==void 0?J.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QA{constructor(t){this.serializer=t,this.Fr=new Map,this.Mr=new Map}getBundleMetadata(t,e){return J.resolve(this.Fr.get(e))}saveBundleMetadata(t,e){return this.Fr.set(e.id,function(r){return{id:r.id,version:r.version,createTime:jn(r.createTime)}}(e)),J.resolve()}getNamedQuery(t,e){return J.resolve(this.Mr.get(e))}saveNamedQuery(t,e){return this.Mr.set(e.name,function(r){return{name:r.name,query:kA(r.bundledQuery),readTime:jn(r.readTime)}}(e)),J.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZA{constructor(){this.overlays=new De(Lt.comparator),this.Or=new Map}getOverlay(t,e){return J.resolve(this.overlays.get(e))}getOverlays(t,e){const n=ur();return J.forEach(e,r=>this.getOverlay(t,r).next(s=>{s!==null&&n.set(r,s)})).next(()=>n)}saveOverlays(t,e,n){return n.forEach((r,s)=>{this.St(t,e,s)}),J.resolve()}removeOverlaysForBatchId(t,e,n){const r=this.Or.get(n);return r!==void 0&&(r.forEach(s=>this.overlays=this.overlays.remove(s)),this.Or.delete(n)),J.resolve()}getOverlaysForCollection(t,e,n){const r=ur(),s=e.length+1,o=new Lt(e.child("")),l=this.overlays.getIteratorFrom(o);for(;l.hasNext();){const c=l.getNext().value,h=c.getKey();if(!e.isPrefixOf(h.path))break;h.path.length===s&&c.largestBatchId>n&&r.set(c.getKey(),c)}return J.resolve(r)}getOverlaysForCollectionGroup(t,e,n,r){let s=new De((h,u)=>h-u);const o=this.overlays.getIterator();for(;o.hasNext();){const h=o.getNext().value;if(h.getKey().getCollectionGroup()===e&&h.largestBatchId>n){let u=s.get(h.largestBatchId);u===null&&(u=ur(),s=s.insert(h.largestBatchId,u)),u.set(h.getKey(),h)}}const l=ur(),c=s.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((h,u)=>l.set(h,u)),!(l.size()>=r)););return J.resolve(l)}St(t,e,n){const r=this.overlays.get(n.key);if(r!==null){const o=this.Or.get(r.largestBatchId).delete(n.key);this.Or.set(r.largestBatchId,o)}this.overlays=this.overlays.insert(n.key,new _A(e,n));let s=this.Or.get(e);s===void 0&&(s=se(),this.Or.set(e,s)),this.Or.set(e,s.add(n.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JA{constructor(){this.sessionToken=Je.EMPTY_BYTE_STRING}getSessionToken(t){return J.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,J.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ew{constructor(t){this.Zr=t,this.docs=function(){return new De(Lt.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,r=this.docs.get(n),s=r?r.size:0,o=this.Zr(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:o}),this.size+=o-s,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return J.resolve(n?n.document.mutableCopy():ln.newInvalidDocument(e))}getEntries(t,e){let n=vi();return e.forEach(r=>{const s=this.docs.get(r);n=n.insert(r,s?s.document.mutableCopy():ln.newInvalidDocument(r))}),J.resolve(n)}getDocumentsMatchingQuery(t,e,n,r){let s=vi();const o=e.path,l=new Lt(o.child("__id-9223372036854775808__")),c=this.docs.getIteratorFrom(l);for(;c.hasNext();){const{key:h,value:{document:u}}=c.getNext();if(!o.isPrefixOf(h.path))break;h.path.length>o.length+1||CM(RM(u),n)<=0||(r.has(u.key)||Ja(e,u))&&(s=s.insert(u.key,u.mutableCopy()))}return J.resolve(s)}getAllFromCollectionGroup(t,e,n,r){Bt(9500)}Xr(t,e){return J.forEach(this.docs,n=>e(n))}newChangeBuffer(t){return new nw(this)}getSize(t){return J.resolve(this.size)}}class nw extends jA{constructor(t){super(),this.vr=t}applyChanges(t){const e=[];return this.changes.forEach((n,r)=>{r.isValidDocument()?e.push(this.vr.addEntry(t,r)):this.vr.removeEntry(n)}),J.waitFor(e)}getFromCache(t,e){return this.vr.getEntry(t,e)}getAllFromCache(t,e){return this.vr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wh{constructor(t,e,n,r){this.targetId=t,this.fromCache=e,this.ls=n,this.hs=r}static Ps(t,e){let n=se(),r=se();for(const s of e.docChanges)switch(s.type){case 0:n=n.add(s.doc.key);break;case 1:r=r.add(s.doc.key)}return new Wh(t,e.fromCache,n,r)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ow{constructor(){this.Ts=!1,this.Is=!1,this.Es=100,this.ds=function(){return QT()?8:DM(jT())>0?6:4}()}initialize(t,e){this.As=t,this.indexManager=e,this.Ts=!0}getDocumentsMatchingQuery(t,e,n,r){const s={result:null};return this.Rs(t,e).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Vs(t,e,r,n).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new sw;return this.fs(t,e,o).next(l=>{if(s.result=l,this.Is)return this.gs(t,e,o,l.size)})}).next(()=>s.result)}gs(t,e,n,r){return n.documentReadCount<this.Es?(Wr()<=ue.DEBUG&&xt("QueryEngine","SDK will not create cache indexes for query:",Xr(e),"since it only creates cache indexes for collection contains","more than or equal to",this.Es,"documents"),J.resolve()):(Wr()<=ue.DEBUG&&xt("QueryEngine","Query:",Xr(e),"scans",n.documentReadCount,"local documents and returns",r,"documents as results."),n.documentReadCount>this.ds*r?(Wr()<=ue.DEBUG&&xt("QueryEngine","The SDK decides to create cache indexes for query:",Xr(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,$n(e))):J.resolve())}Rs(t,e){if(xf(e))return J.resolve(null);let n=$n(e);return this.indexManager.getIndexType(t,n).next(r=>r===0?null:(e.limit!==null&&r===1&&(e=nh(e,null,"F"),n=$n(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next(s=>{const o=se(...s);return this.As.getDocuments(t,o).next(l=>this.indexManager.getMinOffset(t,n).next(c=>{const h=this.ps(e,l);return this.ys(e,h,o,c.readTime)?this.Rs(t,nh(e,null,"F")):this.ws(t,h,e,c)}))})))}Vs(t,e,n,r){return xf(e)||r.isEqual(Gt.min())?J.resolve(null):this.As.getDocuments(t,n).next(s=>{const o=this.ps(e,s);return this.ys(e,o,n,r)?J.resolve(null):(Wr()<=ue.DEBUG&&xt("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Xr(e)),this.ws(t,o,e,bM(r,so)).next(l=>l))})}ps(t,e){let n=new We(xm(t));return e.forEach((r,s)=>{Ja(t,s)&&(n=n.add(s))}),n}ys(t,e,n,r){if(t.limit===null)return!1;if(n.size!==e.size)return!0;const s=t.limitType==="F"?e.last():e.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(r)>0)}fs(t,e,n){return Wr()<=ue.DEBUG&&xt("QueryEngine","Using full collection scan to execute query:",Xr(e)),this.As.getDocumentsMatchingQuery(t,e,Hi.min(),n)}ws(t,e,n,r){return this.As.getDocumentsMatchingQuery(t,n,r).next(s=>(e.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xh="LocalStore",aw=3e8;class lw{constructor(t,e,n,r){this.persistence=t,this.bs=e,this.serializer=r,this.Ss=new De(Zt),this.Ds=new Er(s=>Fh(s),Oh),this.vs=new Map,this.Cs=t.getRemoteDocumentCache(),this.ai=t.getTargetCache(),this.ci=t.getBundleCache(),this.Fs(n)}Fs(t){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new KA(this.Cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Cs.setIndexManager(this.indexManager),this.bs.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",e=>t.collect(e,this.Ss))}}function cw(i,t,e,n){return new lw(i,t,e,n)}async function Xm(i,t){const e=$t(i);return await e.persistence.runTransaction("Handle user change","readonly",n=>{let r;return e.mutationQueue.getAllMutationBatches(n).next(s=>(r=s,e.Fs(t),e.mutationQueue.getAllMutationBatches(n))).next(s=>{const o=[],l=[];let c=se();for(const h of r){o.push(h.batchId);for(const u of h.mutations)c=c.add(u.key)}for(const h of s){l.push(h.batchId);for(const u of h.mutations)c=c.add(u.key)}return e.localDocuments.getDocuments(n,c).next(h=>({Ms:h,removedBatchIds:o,addedBatchIds:l}))})})}function hw(i,t){const e=$t(i);return e.persistence.runTransaction("Acknowledge batch","readwrite-primary",n=>{const r=t.batch.keys(),s=e.Cs.newChangeBuffer({trackRemovals:!0});return function(l,c,h,u){const d=h.batch,m=d.keys();let _=J.resolve();return m.forEach(x=>{_=_.next(()=>u.getEntry(c,x)).next(M=>{const g=h.docVersions.get(x);_e(g!==null,48541),M.version.compareTo(g)<0&&(d.applyToRemoteDocument(M,h),M.isValidDocument()&&(M.setReadTime(h.commitVersion),u.addEntry(M)))})}),_.next(()=>l.mutationQueue.removeMutationBatch(c,d))}(e,n,t,s).next(()=>s.apply(n)).next(()=>e.mutationQueue.performConsistencyCheck(n)).next(()=>e.documentOverlayCache.removeOverlaysForBatchId(n,r,t.batch.batchId)).next(()=>e.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,function(l){let c=se();for(let h=0;h<l.mutationResults.length;++h)l.mutationResults[h].transformResults.length>0&&(c=c.add(l.batch.mutations[h].key));return c}(t))).next(()=>e.localDocuments.getDocuments(n,r))})}function qm(i){const t=$t(i);return t.persistence.runTransaction("Get last remote snapshot version","readonly",e=>t.ai.getLastRemoteSnapshotVersion(e))}function uw(i,t){const e=$t(i),n=t.snapshotVersion;let r=e.Ss;return e.persistence.runTransaction("Apply remote event","readwrite-primary",s=>{const o=e.Cs.newChangeBuffer({trackRemovals:!0});r=e.Ss;const l=[];t.targetChanges.forEach((u,d)=>{const m=r.get(d);if(!m)return;l.push(e.ai.removeMatchingKeys(s,u.removedDocuments,d).next(()=>e.ai.addMatchingKeys(s,u.addedDocuments,d)));let _=m.withSequenceNumber(s.currentSequenceNumber);t.targetMismatches.get(d)!==null?_=_.withResumeToken(Je.EMPTY_BYTE_STRING,Gt.min()).withLastLimboFreeSnapshotVersion(Gt.min()):u.resumeToken.approximateByteSize()>0&&(_=_.withResumeToken(u.resumeToken,n)),r=r.insert(d,_),function(M,g,p){return M.resumeToken.approximateByteSize()===0||g.snapshotVersion.toMicroseconds()-M.snapshotVersion.toMicroseconds()>=aw?!0:p.addedDocuments.size+p.modifiedDocuments.size+p.removedDocuments.size>0}(m,_,u)&&l.push(e.ai.updateTargetData(s,_))});let c=vi(),h=se();if(t.documentUpdates.forEach(u=>{t.resolvedLimboDocuments.has(u)&&l.push(e.persistence.referenceDelegate.updateLimboDocument(s,u))}),l.push(dw(s,o,t.documentUpdates).next(u=>{c=u.xs,h=u.Os})),!n.isEqual(Gt.min())){const u=e.ai.getLastRemoteSnapshotVersion(s).next(d=>e.ai.setTargetsMetadata(s,s.currentSequenceNumber,n));l.push(u)}return J.waitFor(l).next(()=>o.apply(s)).next(()=>e.localDocuments.getLocalViewOfDocuments(s,c,h)).next(()=>c)}).then(s=>(e.Ss=r,s))}function dw(i,t,e){let n=se(),r=se();return e.forEach(s=>n=n.add(s)),t.getEntries(i,n).next(s=>{let o=vi();return e.forEach((l,c)=>{const h=s.get(l);c.isFoundDocument()!==h.isFoundDocument()&&(r=r.add(l)),c.isNoDocument()&&c.version.isEqual(Gt.min())?(t.removeEntry(l,c.readTime),o=o.insert(l,c)):!h.isValidDocument()||c.version.compareTo(h.version)>0||c.version.compareTo(h.version)===0&&h.hasPendingWrites?(t.addEntry(c),o=o.insert(l,c)):xt(Xh,"Ignoring outdated watch update for ",l,". Current version:",h.version," Watch version:",c.version)}),{xs:o,Os:r}})}function fw(i,t){const e=$t(i);return e.persistence.runTransaction("Get next mutation batch","readonly",n=>(t===void 0&&(t=Lh),e.mutationQueue.getNextMutationBatchAfterBatchId(n,t)))}function pw(i,t){const e=$t(i);return e.persistence.runTransaction("Allocate target","readwrite",n=>{let r;return e.ai.getTargetData(n,t).next(s=>s?(r=s,J.resolve(r)):e.ai.allocateTargetId(n).next(o=>(r=new Di(t,o,"TargetPurposeListen",n.currentSequenceNumber),e.ai.addTargetData(n,r).next(()=>r))))}).then(n=>{const r=e.Ss.get(n.targetId);return(r===null||n.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(e.Ss=e.Ss.insert(n.targetId,n),e.Ds.set(t,n.targetId)),n})}async function ah(i,t,e){const n=$t(i),r=n.Ss.get(t),s=e?"readwrite":"readwrite-primary";try{e||await n.persistence.runTransaction("Release target",s,o=>n.persistence.referenceDelegate.removeTarget(o,r))}catch(o){if(!Es(o))throw o;xt(Xh,`Failed to update sequence numbers for target ${t}: ${o}`)}n.Ss=n.Ss.remove(t),n.Ds.delete(r.target)}function Nf(i,t,e){const n=$t(i);let r=Gt.min(),s=se();return n.persistence.runTransaction("Execute query","readwrite",o=>function(c,h,u){const d=$t(c),m=d.Ds.get(u);return m!==void 0?J.resolve(d.Ss.get(m)):d.ai.getTargetData(h,u)}(n,o,$n(t)).next(l=>{if(l)return r=l.lastLimboFreeSnapshotVersion,n.ai.getMatchingKeysForTargetId(o,l.targetId).next(c=>{s=c})}).next(()=>n.bs.getDocumentsMatchingQuery(o,t,e?r:Gt.min(),e?s:se())).next(l=>(mw(n,tA(t),l),{documents:l,Ns:s})))}function mw(i,t,e){let n=i.vs.get(t)||Gt.min();e.forEach((r,s)=>{s.readTime.compareTo(n)>0&&(n=s.readTime)}),i.vs.set(t,n)}class Uf{constructor(){this.activeTargetIds=oA()}$s(t){this.activeTargetIds=this.activeTargetIds.add(t)}Us(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Qs(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class gw{constructor(){this.So=new Uf,this.Do={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,e,n){}addLocalQueryTarget(t,e=!0){return e&&this.So.$s(t),this.Do[t]||"not-current"}updateQueryState(t,e,n){this.Do[t]=e}removeLocalQueryTarget(t){this.So.Us(t)}isLocalQueryTarget(t){return this.So.activeTargetIds.has(t)}clearQueryState(t){delete this.Do[t]}getAllActiveQueryTargets(){return this.So.activeTargetIds}isActiveQueryTarget(t){return this.So.activeTargetIds.has(t)}start(){return this.So=new Uf,Promise.resolve()}handleUserChange(t,e,n){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(t){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ff="ConnectivityMonitor";class Of{constructor(){this.Co=()=>this.Fo(),this.Mo=()=>this.xo(),this.Oo=[],this.No()}vo(t){this.Oo.push(t)}shutdown(){window.removeEventListener("online",this.Co),window.removeEventListener("offline",this.Mo)}No(){window.addEventListener("online",this.Co),window.addEventListener("offline",this.Mo)}Fo(){xt(Ff,"Network connectivity changed: AVAILABLE");for(const t of this.Oo)t(0)}xo(){xt(Ff,"Network connectivity changed: UNAVAILABLE");for(const t of this.Oo)t(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let aa=null;function lh(){return aa===null?aa=function(){return 268435456+Math.round(2147483648*Math.random())}():aa++,"0x"+aa.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ql="RestConnection",vw={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class yw{get Bo(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Lo=e+"://"+t.host,this.ko=`projects/${n}/databases/${r}`,this.qo=this.databaseId.database===Da?`project_id=${n}`:`project_id=${n}&database_id=${r}`}Qo(t,e,n,r,s){const o=lh(),l=this.$o(t,e.toUriEncodedString());xt(Ql,`Sending RPC '${t}' ${o}:`,l,n);const c={"google-cloud-resource-prefix":this.ko,"x-goog-request-params":this.qo};this.Uo(c,r,s);const{host:h}=new URL(l),u=kp(h);return this.Ko(t,l,c,n,u).then(d=>(xt(Ql,`Received RPC '${t}' ${o}: `,d),d),d=>{throw ls(Ql,`RPC '${t}' ${o} failed with error: `,d,"url: ",l,"request:",n),d})}Wo(t,e,n,r,s,o){return this.Qo(t,e,n,r,s)}Uo(t,e,n){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+vs}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((r,s)=>t[s]=r),n&&n.headers.forEach((r,s)=>t[s]=r)}$o(t,e){const n=vw[t];return`${this.Lo}/v1/${e}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ew{constructor(t){this.Go=t.Go,this.zo=t.zo}jo(t){this.Ho=t}Jo(t){this.Yo=t}Zo(t){this.Xo=t}onMessage(t){this.e_=t}close(){this.zo()}send(t){this.Go(t)}t_(){this.Ho()}n_(){this.Yo()}r_(t){this.Xo(t)}i_(t){this.e_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function il(i){return new AA(i,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vf="PersistentStream";class jm{constructor(t,e,n,r,s,o,l,c){this.bi=t,this.R_=n,this.V_=r,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=l,this.listener=c,this.state=0,this.m_=0,this.f_=null,this.g_=null,this.stream=null,this.p_=0,this.y_=new $m(t,e)}w_(){return this.state===1||this.state===5||this.b_()}b_(){return this.state===2||this.state===3}start(){this.p_=0,this.state!==4?this.auth():this.S_()}async stop(){this.w_()&&await this.close(0)}D_(){this.state=0,this.y_.reset()}v_(){this.b_()&&this.f_===null&&(this.f_=this.bi.enqueueAfterDelay(this.R_,6e4,()=>this.C_()))}F_(t){this.M_(),this.stream.send(t)}async C_(){if(this.b_())return this.close(0)}M_(){this.f_&&(this.f_.cancel(),this.f_=null)}x_(){this.g_&&(this.g_.cancel(),this.g_=null)}async close(t,e){this.M_(),this.x_(),this.y_.cancel(),this.m_++,t!==4?this.y_.reset():e&&e.code===st.RESOURCE_EXHAUSTED?(_i(e.toString()),_i("Using maximum backoff delay to prevent overloading the backend."),this.y_.I_()):e&&e.code===st.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.O_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.Zo(e)}O_(){}auth(){this.state=1;const t=this.N_(this.m_),e=this.m_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,r])=>{this.m_===e&&this.B_(n,r)},n=>{t(()=>{const r=new It(st.UNKNOWN,"Fetching auth token failed: "+n.message);return this.L_(r)})})}B_(t,e){const n=this.N_(this.m_);this.stream=this.k_(t,e),this.stream.jo(()=>{n(()=>this.listener.jo())}),this.stream.Jo(()=>{n(()=>(this.state=2,this.g_=this.bi.enqueueAfterDelay(this.V_,1e4,()=>(this.b_()&&(this.state=3),Promise.resolve())),this.listener.Jo()))}),this.stream.Zo(r=>{n(()=>this.L_(r))}),this.stream.onMessage(r=>{n(()=>++this.p_==1?this.q_(r):this.onNext(r))})}S_(){this.state=5,this.y_.E_(async()=>{this.state=0,this.start()})}L_(t){return xt(Vf,`close with error: ${t}`),this.stream=null,this.close(4,t)}N_(t){return e=>{this.bi.enqueueAndForget(()=>this.m_===t?e():(xt(Vf,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class Tw extends jm{constructor(t,e,n,r,s,o){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}k_(t,e){return this.connection.a_("Listen",t,e)}q_(t){return this.onNext(t)}onNext(t){this.y_.reset();const e=RA(this.serializer,t),n=function(s){if(!("targetChange"in s))return Gt.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?Gt.min():o.readTime?jn(o.readTime):Gt.min()}(t);return this.listener.Q_(e,n)}U_(t){const e={};e.database=oh(this.serializer),e.addTarget=function(s,o){let l;const c=o.target;if(l=eh(c)?{documents:PA(s,c)}:{query:DA(s,c).gt},l.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){l.resumeToken=Fm(s,o.resumeToken);const h=ih(s,o.expectedCount);h!==null&&(l.expectedCount=h)}else if(o.snapshotVersion.compareTo(Gt.min())>0){l.readTime=Va(s,o.snapshotVersion.toTimestamp());const h=ih(s,o.expectedCount);h!==null&&(l.expectedCount=h)}return l}(this.serializer,t);const n=NA(this.serializer,t);n&&(e.labels=n),this.F_(e)}K_(t){const e={};e.database=oh(this.serializer),e.removeTarget=t,this.F_(e)}}class Sw extends jm{constructor(t,e,n,r,s,o){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}get W_(){return this.p_>0}start(){this.lastStreamToken=void 0,super.start()}O_(){this.W_&&this.G_([])}k_(t,e){return this.connection.a_("Write",t,e)}q_(t){return _e(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,_e(!t.writeResults||t.writeResults.length===0,55816),this.listener.z_()}onNext(t){_e(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.y_.reset();const e=IA(t.writeResults,t.commitTime),n=jn(t.commitTime);return this.listener.j_(n,e)}H_(){const t={};t.database=oh(this.serializer),this.F_(t)}G_(t){const e={streamToken:this.lastStreamToken,writes:t.map(n=>CA(this.serializer,n))};this.F_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mw{}class Aw extends Mw{constructor(t,e,n,r){super(),this.authCredentials=t,this.appCheckCredentials=e,this.connection=n,this.serializer=r,this.J_=!1}Y_(){if(this.J_)throw new It(st.FAILED_PRECONDITION,"The client has already been terminated.")}Qo(t,e,n,r){return this.Y_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,o])=>this.connection.Qo(t,rh(e,n),r,s,o)).catch(s=>{throw s.name==="FirebaseError"?(s.code===st.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new It(st.UNKNOWN,s.toString())})}Wo(t,e,n,r,s){return this.Y_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,l])=>this.connection.Wo(t,rh(e,n),r,o,l,s)).catch(o=>{throw o.name==="FirebaseError"?(o.code===st.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new It(st.UNKNOWN,o.toString())})}terminate(){this.J_=!0,this.connection.terminate()}}class ww{constructor(t,e){this.asyncQueue=t,this.onlineStateHandler=e,this.state="Unknown",this.Z_=0,this.X_=null,this.ea=!0}ta(){this.Z_===0&&(this.na("Unknown"),this.X_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.X_=null,this.ra("Backend didn't respond within 10 seconds."),this.na("Offline"),Promise.resolve())))}ia(t){this.state==="Online"?this.na("Unknown"):(this.Z_++,this.Z_>=1&&(this.sa(),this.ra(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.na("Offline")))}set(t){this.sa(),this.Z_=0,t==="Online"&&(this.ea=!1),this.na(t)}na(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}ra(t){const e=`Could not reach Cloud Firestore backend. ${t}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r="RemoteStore";class bw{constructor(t,e,n,r,s){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.oa=[],this._a=new Map,this.aa=new Set,this.ua=[],this.ca=s,this.ca.vo(o=>{n.enqueueAndForget(async()=>{Tr(this)&&(xt(_r,"Restarting streams for network reachability change."),await async function(c){const h=$t(c);h.aa.add(4),await Eo(h),h.la.set("Unknown"),h.aa.delete(4),await rl(h)}(this))})}),this.la=new ww(n,r)}}async function rl(i){if(Tr(i))for(const t of i.ua)await t(!0)}async function Eo(i){for(const t of i.ua)await t(!1)}function Ym(i,t){const e=$t(i);e._a.has(t.targetId)||(e._a.set(t.targetId,t),Yh(e)?jh(e):xs(e).b_()&&$h(e,t))}function qh(i,t){const e=$t(i),n=xs(e);e._a.delete(t),n.b_()&&Km(e,t),e._a.size===0&&(n.b_()?n.v_():Tr(e)&&e.la.set("Unknown"))}function $h(i,t){if(i.ha.Ke(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(Gt.min())>0){const e=i.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}xs(i).U_(t)}function Km(i,t){i.ha.Ke(t),xs(i).K_(t)}function jh(i){i.ha=new xA({getRemoteKeysForTarget:t=>i.remoteSyncer.getRemoteKeysForTarget(t),Rt:t=>i._a.get(t)||null,Pt:()=>i.datastore.serializer.databaseId}),xs(i).start(),i.la.ta()}function Yh(i){return Tr(i)&&!xs(i).w_()&&i._a.size>0}function Tr(i){return $t(i).aa.size===0}function Qm(i){i.ha=void 0}async function Rw(i){i.la.set("Online")}async function Cw(i){i._a.forEach((t,e)=>{$h(i,t)})}async function Iw(i,t){Qm(i),Yh(i)?(i.la.ia(t),jh(i)):i.la.set("Unknown")}async function Pw(i,t,e){if(i.la.set("Online"),t instanceof Um&&t.state===2&&t.cause)try{await async function(r,s){const o=s.cause;for(const l of s.targetIds)r._a.has(l)&&(await r.remoteSyncer.rejectListen(l,o),r._a.delete(l),r.ha.removeTarget(l))}(i,t)}catch(n){xt(_r,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await ka(i,n)}else if(t instanceof Ta?i.ha.Xe(t):t instanceof Nm?i.ha.ot(t):i.ha.nt(t),!e.isEqual(Gt.min()))try{const n=await qm(i.localStore);e.compareTo(n)>=0&&await function(s,o){const l=s.ha.It(o);return l.targetChanges.forEach((c,h)=>{if(c.resumeToken.approximateByteSize()>0){const u=s._a.get(h);u&&s._a.set(h,u.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,h)=>{const u=s._a.get(c);if(!u)return;s._a.set(c,u.withResumeToken(Je.EMPTY_BYTE_STRING,u.snapshotVersion)),Km(s,c);const d=new Di(u.target,c,h,u.sequenceNumber);$h(s,d)}),s.remoteSyncer.applyRemoteEvent(l)}(i,e)}catch(n){xt(_r,"Failed to raise snapshot:",n),await ka(i,n)}}async function ka(i,t,e){if(!Es(t))throw t;i.aa.add(1),await Eo(i),i.la.set("Offline"),e||(e=()=>qm(i.localStore)),i.asyncQueue.enqueueRetryable(async()=>{xt(_r,"Retrying IndexedDB access"),await e(),i.aa.delete(1),await rl(i)})}function Zm(i,t){return t().catch(e=>ka(i,e,t))}async function sl(i){const t=$t(i),e=qi(t);let n=t.oa.length>0?t.oa[t.oa.length-1].batchId:Lh;for(;Dw(t);)try{const r=await fw(t.localStore,n);if(r===null){t.oa.length===0&&e.v_();break}n=r.batchId,Lw(t,r)}catch(r){await ka(t,r)}Jm(t)&&tg(t)}function Dw(i){return Tr(i)&&i.oa.length<10}function Lw(i,t){i.oa.push(t);const e=qi(i);e.b_()&&e.W_&&e.G_(t.mutations)}function Jm(i){return Tr(i)&&!qi(i).w_()&&i.oa.length>0}function tg(i){qi(i).start()}async function Nw(i){qi(i).H_()}async function Uw(i){const t=qi(i);for(const e of i.oa)t.G_(e.mutations)}async function Fw(i,t,e){const n=i.oa.shift(),r=Bh.from(n,t,e);await Zm(i,()=>i.remoteSyncer.applySuccessfulWrite(r)),await sl(i)}async function Ow(i,t){t&&qi(i).W_&&await async function(n,r){if(function(o){return yA(o)&&o!==st.ABORTED}(r.code)){const s=n.oa.shift();qi(n).D_(),await Zm(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await sl(n)}}(i,t),Jm(i)&&tg(i)}async function Bf(i,t){const e=$t(i);e.asyncQueue.verifyOperationInProgress(),xt(_r,"RemoteStore received new credentials");const n=Tr(e);e.aa.add(3),await Eo(e),n&&e.la.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.aa.delete(3),await rl(e)}async function Vw(i,t){const e=$t(i);t?(e.aa.delete(2),await rl(e)):t||(e.aa.add(2),await Eo(e),e.la.set("Unknown"))}function xs(i){return i.Pa||(i.Pa=function(e,n,r){const s=$t(e);return s.Y_(),new Tw(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{jo:Rw.bind(null,i),Jo:Cw.bind(null,i),Zo:Iw.bind(null,i),Q_:Pw.bind(null,i)}),i.ua.push(async t=>{t?(i.Pa.D_(),Yh(i)?jh(i):i.la.set("Unknown")):(await i.Pa.stop(),Qm(i))})),i.Pa}function qi(i){return i.Ta||(i.Ta=function(e,n,r){const s=$t(e);return s.Y_(),new Sw(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{jo:()=>Promise.resolve(),Jo:Nw.bind(null,i),Zo:Ow.bind(null,i),z_:Uw.bind(null,i),j_:Fw.bind(null,i)}),i.ua.push(async t=>{t?(i.Ta.D_(),await sl(i)):(await i.Ta.stop(),i.oa.length>0&&(xt(_r,`Stopping write stream with ${i.oa.length} pending writes`),i.oa=[]))})),i.Ta}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kh{constructor(t,e,n,r,s){this.asyncQueue=t,this.timerId=e,this.targetTimeMs=n,this.op=r,this.removalCallback=s,this.deferred=new Vi,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(o=>{})}get promise(){return this.deferred.promise}static createAndSchedule(t,e,n,r,s){const o=Date.now()+n,l=new Kh(t,e,o,r,s);return l.start(n),l}start(t){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),t)}skipDelay(){return this.handleDelayElapsed()}cancel(t){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new It(st.CANCELLED,"Operation cancelled"+(t?": "+t:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(t=>this.deferred.resolve(t))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Qh(i,t){if(_i("AsyncQueue",`${t}: ${i}`),Es(i))return new It(st.UNAVAILABLE,`${t}: ${i}`);throw i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bw{constructor(){this.Aa=void 0,this.Ra=[]}Va(){return this.Ra.some(t=>t.ma())}}class kw{constructor(){this.queries=zf(),this.onlineState="Unknown",this.fa=new Set}terminate(){(function(e,n){const r=$t(e),s=r.queries;r.queries=zf(),s.forEach((o,l)=>{for(const c of l.Ra)c.onError(n)})})(this,new It(st.ABORTED,"Firestore shutting down"))}}function zf(){return new Er(i=>Em(i),Za)}async function zw(i,t){const e=$t(i);let n=3;const r=t.query;let s=e.queries.get(r);s?!s.Va()&&t.ma()&&(n=2):(s=new Bw,n=t.ma()?0:1);try{switch(n){case 0:s.Aa=await e.onListen(r,!0);break;case 1:s.Aa=await e.onListen(r,!1);break;case 2:await e.onFirstRemoteStoreListen(r)}}catch(o){const l=Qh(o,`Initialization of query '${Xr(t.query)}' failed`);return void t.onError(l)}e.queries.set(r,s),s.Ra.push(t),t.ga(e.onlineState),s.Aa&&t.pa(s.Aa)&&Zh(e)}async function Hw(i,t){const e=$t(i),n=t.query;let r=3;const s=e.queries.get(n);if(s){const o=s.Ra.indexOf(t);o>=0&&(s.Ra.splice(o,1),s.Ra.length===0?r=t.ma()?0:1:!s.Va()&&t.ma()&&(r=2))}switch(r){case 0:return e.queries.delete(n),e.onUnlisten(n,!0);case 1:return e.queries.delete(n),e.onUnlisten(n,!1);case 2:return e.onLastRemoteStoreUnlisten(n);default:return}}function Gw(i,t){const e=$t(i);let n=!1;for(const r of t){const s=r.query,o=e.queries.get(s);if(o){for(const l of o.Ra)l.pa(r)&&(n=!0);o.Aa=r}}n&&Zh(e)}function Ww(i,t,e){const n=$t(i),r=n.queries.get(t);if(r)for(const s of r.Ra)s.onError(e);n.queries.delete(t)}function Zh(i){i.fa.forEach(t=>{t.next()})}var ch,Hf;(Hf=ch||(ch={})).ya="default",Hf.Cache="cache";class Xw{constructor(t,e,n){this.query=t,this.wa=e,this.ba=!1,this.Sa=null,this.onlineState="Unknown",this.options=n||{}}pa(t){if(!this.options.includeMetadataChanges){const n=[];for(const r of t.docChanges)r.type!==3&&n.push(r);t=new ps(t.query,t.docs,t.oldDocs,n,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let e=!1;return this.ba?this.Da(t)&&(this.wa.next(t),e=!0):this.va(t,this.onlineState)&&(this.Ca(t),e=!0),this.Sa=t,e}onError(t){this.wa.error(t)}ga(t){this.onlineState=t;let e=!1;return this.Sa&&!this.ba&&this.va(this.Sa,t)&&(this.Ca(this.Sa),e=!0),e}va(t,e){if(!t.fromCache||!this.ma())return!0;const n=e!=="Offline";return(!this.options.Fa||!n)&&(!t.docs.isEmpty()||t.hasCachedResults||e==="Offline")}Da(t){if(t.docChanges.length>0)return!0;const e=this.Sa&&this.Sa.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!e)&&this.options.includeMetadataChanges===!0}Ca(t){t=ps.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.ba=!0,this.wa.next(t)}ma(){return this.options.source!==ch.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eg{constructor(t){this.key=t}}class ng{constructor(t){this.key=t}}class qw{constructor(t,e){this.query=t,this.qa=e,this.Qa=null,this.hasCachedResults=!1,this.current=!1,this.$a=se(),this.mutatedKeys=se(),this.Ua=xm(t),this.Ka=new ns(this.Ua)}get Wa(){return this.qa}Ga(t,e){const n=e?e.za:new kf,r=e?e.Ka:this.Ka;let s=e?e.mutatedKeys:this.mutatedKeys,o=r,l=!1;const c=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,h=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal((u,d)=>{const m=r.get(u),_=Ja(this.query,d)?d:null,x=!!m&&this.mutatedKeys.has(m.key),M=!!_&&(_.hasLocalMutations||this.mutatedKeys.has(_.key)&&_.hasCommittedMutations);let g=!1;m&&_?m.data.isEqual(_.data)?x!==M&&(n.track({type:3,doc:_}),g=!0):this.ja(m,_)||(n.track({type:2,doc:_}),g=!0,(c&&this.Ua(_,c)>0||h&&this.Ua(_,h)<0)&&(l=!0)):!m&&_?(n.track({type:0,doc:_}),g=!0):m&&!_&&(n.track({type:1,doc:m}),g=!0,(c||h)&&(l=!0)),g&&(_?(o=o.add(_),s=M?s.add(u):s.delete(u)):(o=o.delete(u),s=s.delete(u)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const u=this.query.limitType==="F"?o.last():o.first();o=o.delete(u.key),s=s.delete(u.key),n.track({type:1,doc:u})}return{Ka:o,za:n,ys:l,mutatedKeys:s}}ja(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,r){const s=this.Ka;this.Ka=t.Ka,this.mutatedKeys=t.mutatedKeys;const o=t.za.da();o.sort((u,d)=>function(_,x){const M=g=>{switch(g){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Bt(20277,{Vt:g})}};return M(_)-M(x)}(u.type,d.type)||this.Ua(u.doc,d.doc)),this.Ha(n),r=r!=null&&r;const l=e&&!r?this.Ja():[],c=this.$a.size===0&&this.current&&!r?1:0,h=c!==this.Qa;return this.Qa=c,o.length!==0||h?{snapshot:new ps(this.query,t.Ka,s,o,t.mutatedKeys,c===0,h,!1,!!n&&n.resumeToken.approximateByteSize()>0),Ya:l}:{Ya:l}}ga(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({Ka:this.Ka,za:new kf,mutatedKeys:this.mutatedKeys,ys:!1},!1)):{Ya:[]}}Za(t){return!this.qa.has(t)&&!!this.Ka.has(t)&&!this.Ka.get(t).hasLocalMutations}Ha(t){t&&(t.addedDocuments.forEach(e=>this.qa=this.qa.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.qa=this.qa.delete(e)),this.current=t.current)}Ja(){if(!this.current)return[];const t=this.$a;this.$a=se(),this.Ka.forEach(n=>{this.Za(n.key)&&(this.$a=this.$a.add(n.key))});const e=[];return t.forEach(n=>{this.$a.has(n)||e.push(new ng(n))}),this.$a.forEach(n=>{t.has(n)||e.push(new eg(n))}),e}Xa(t){this.qa=t.Ns,this.$a=se();const e=this.Ga(t.documents);return this.applyChanges(e,!0)}eu(){return ps.fromInitialDocuments(this.query,this.Ka,this.mutatedKeys,this.Qa===0,this.hasCachedResults)}}const Jh="SyncEngine";class $w{constructor(t,e,n){this.query=t,this.targetId=e,this.view=n}}class jw{constructor(t){this.key=t,this.tu=!1}}class Yw{constructor(t,e,n,r,s,o){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=r,this.currentUser=s,this.maxConcurrentLimboResolutions=o,this.nu={},this.ru=new Er(l=>Em(l),Za),this.iu=new Map,this.su=new Set,this.ou=new De(Lt.comparator),this._u=new Map,this.au=new Hh,this.uu={},this.cu=new Map,this.lu=fs.ir(),this.onlineState="Unknown",this.hu=void 0}get isPrimaryClient(){return this.hu===!0}}async function Kw(i,t,e=!0){const n=lg(i);let r;const s=n.ru.get(t);return s?(n.sharedClientState.addLocalQueryTarget(s.targetId),r=s.view.eu()):r=await ig(n,t,e,!0),r}async function Qw(i,t){const e=lg(i);await ig(e,t,!0,!1)}async function ig(i,t,e,n){const r=await pw(i.localStore,$n(t)),s=r.targetId,o=i.sharedClientState.addLocalQueryTarget(s,e);let l;return n&&(l=await Zw(i,t,s,o==="current",r.resumeToken)),i.isPrimaryClient&&e&&Ym(i.remoteStore,r),l}async function Zw(i,t,e,n,r){i.Pu=(d,m,_)=>async function(M,g,p,I){let D=g.view.Ga(p);D.ys&&(D=await Nf(M.localStore,g.query,!1).then(({documents:S})=>g.view.Ga(S,D)));const P=I&&I.targetChanges.get(g.targetId),V=I&&I.targetMismatches.get(g.targetId)!=null,F=g.view.applyChanges(D,M.isPrimaryClient,P,V);return Wf(M,g.targetId,F.Ya),F.snapshot}(i,d,m,_);const s=await Nf(i.localStore,t,!0),o=new qw(t,s.Ns),l=o.Ga(s.documents),c=yo.createSynthesizedTargetChangeForCurrentChange(e,n&&i.onlineState!=="Offline",r),h=o.applyChanges(l,i.isPrimaryClient,c);Wf(i,e,h.Ya);const u=new $w(t,e,o);return i.ru.set(t,u),i.iu.has(e)?i.iu.get(e).push(t):i.iu.set(e,[t]),h.snapshot}async function Jw(i,t,e){const n=$t(i),r=n.ru.get(t),s=n.iu.get(r.targetId);if(s.length>1)return n.iu.set(r.targetId,s.filter(o=>!Za(o,t))),void n.ru.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(r.targetId),n.sharedClientState.isActiveQueryTarget(r.targetId)||await ah(n.localStore,r.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(r.targetId),e&&qh(n.remoteStore,r.targetId),hh(n,r.targetId)}).catch(ys)):(hh(n,r.targetId),await ah(n.localStore,r.targetId,!0))}async function tb(i,t){const e=$t(i),n=e.ru.get(t),r=e.iu.get(n.targetId);e.isPrimaryClient&&r.length===1&&(e.sharedClientState.removeLocalQueryTarget(n.targetId),qh(e.remoteStore,n.targetId))}async function eb(i,t,e){const n=lb(i);try{const r=await function(o,l){const c=$t(o),h=Ge.now(),u=l.reduce((_,x)=>_.add(x.key),se());let d,m;return c.persistence.runTransaction("Locally write mutations","readwrite",_=>{let x=vi(),M=se();return c.Cs.getEntries(_,u).next(g=>{x=g,x.forEach((p,I)=>{I.isValidDocument()||(M=M.add(p))})}).next(()=>c.localDocuments.getOverlayedDocuments(_,x)).next(g=>{d=g;const p=[];for(const I of l){const D=pA(I,d.get(I.key).overlayedDocument);D!=null&&p.push(new xr(I.key,D,dm(D.value.mapValue),mi.exists(!0)))}return c.mutationQueue.addMutationBatch(_,h,p,l)}).next(g=>{m=g;const p=g.applyToLocalDocumentSet(d,M);return c.documentOverlayCache.saveOverlays(_,g.batchId,p)})}).then(()=>({batchId:m.batchId,changes:Sm(d)}))}(n.localStore,t);n.sharedClientState.addPendingMutation(r.batchId),function(o,l,c){let h=o.uu[o.currentUser.toKey()];h||(h=new De(Zt)),h=h.insert(l,c),o.uu[o.currentUser.toKey()]=h}(n,r.batchId,e),await xo(n,r.changes),await sl(n.remoteStore)}catch(r){const s=Qh(r,"Failed to persist write");e.reject(s)}}async function rg(i,t){const e=$t(i);try{const n=await uw(e.localStore,t);t.targetChanges.forEach((r,s)=>{const o=e._u.get(s);o&&(_e(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1,22616),r.addedDocuments.size>0?o.tu=!0:r.modifiedDocuments.size>0?_e(o.tu,14607):r.removedDocuments.size>0&&(_e(o.tu,42227),o.tu=!1))}),await xo(e,n,t)}catch(n){await ys(n)}}function Gf(i,t,e){const n=$t(i);if(n.isPrimaryClient&&e===0||!n.isPrimaryClient&&e===1){const r=[];n.ru.forEach((s,o)=>{const l=o.view.ga(t);l.snapshot&&r.push(l.snapshot)}),function(o,l){const c=$t(o);c.onlineState=l;let h=!1;c.queries.forEach((u,d)=>{for(const m of d.Ra)m.ga(l)&&(h=!0)}),h&&Zh(c)}(n.eventManager,t),r.length&&n.nu.Q_(r),n.onlineState=t,n.isPrimaryClient&&n.sharedClientState.setOnlineState(t)}}async function nb(i,t,e){const n=$t(i);n.sharedClientState.updateQueryState(t,"rejected",e);const r=n._u.get(t),s=r&&r.key;if(s){let o=new De(Lt.comparator);o=o.insert(s,ln.newNoDocument(s,Gt.min()));const l=se().add(s),c=new nl(Gt.min(),new Map,new De(Zt),o,l);await rg(n,c),n.ou=n.ou.remove(s),n._u.delete(t),tu(n)}else await ah(n.localStore,t,!1).then(()=>hh(n,t,e)).catch(ys)}async function ib(i,t){const e=$t(i),n=t.batch.batchId;try{const r=await hw(e.localStore,t);og(e,n,null),sg(e,n),e.sharedClientState.updateMutationState(n,"acknowledged"),await xo(e,r)}catch(r){await ys(r)}}async function rb(i,t,e){const n=$t(i);try{const r=await function(o,l){const c=$t(o);return c.persistence.runTransaction("Reject batch","readwrite-primary",h=>{let u;return c.mutationQueue.lookupMutationBatch(h,l).next(d=>(_e(d!==null,37113),u=d.keys(),c.mutationQueue.removeMutationBatch(h,d))).next(()=>c.mutationQueue.performConsistencyCheck(h)).next(()=>c.documentOverlayCache.removeOverlaysForBatchId(h,u,l)).next(()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,u)).next(()=>c.localDocuments.getDocuments(h,u))})}(n.localStore,t);og(n,t,e),sg(n,t),n.sharedClientState.updateMutationState(t,"rejected",e),await xo(n,r)}catch(r){await ys(r)}}function sg(i,t){(i.cu.get(t)||[]).forEach(e=>{e.resolve()}),i.cu.delete(t)}function og(i,t,e){const n=$t(i);let r=n.uu[n.currentUser.toKey()];if(r){const s=r.get(t);s&&(e?s.reject(e):s.resolve(),r=r.remove(t)),n.uu[n.currentUser.toKey()]=r}}function hh(i,t,e=null){i.sharedClientState.removeLocalQueryTarget(t);for(const n of i.iu.get(t))i.ru.delete(n),e&&i.nu.Tu(n,e);i.iu.delete(t),i.isPrimaryClient&&i.au.Ur(t).forEach(n=>{i.au.containsKey(n)||ag(i,n)})}function ag(i,t){i.su.delete(t.path.canonicalString());const e=i.ou.get(t);e!==null&&(qh(i.remoteStore,e),i.ou=i.ou.remove(t),i._u.delete(e),tu(i))}function Wf(i,t,e){for(const n of e)n instanceof eg?(i.au.addReference(n.key,t),sb(i,n)):n instanceof ng?(xt(Jh,"Document no longer in limbo: "+n.key),i.au.removeReference(n.key,t),i.au.containsKey(n.key)||ag(i,n.key)):Bt(19791,{Iu:n})}function sb(i,t){const e=t.key,n=e.path.canonicalString();i.ou.get(e)||i.su.has(n)||(xt(Jh,"New document in limbo: "+e),i.su.add(n),tu(i))}function tu(i){for(;i.su.size>0&&i.ou.size<i.maxConcurrentLimboResolutions;){const t=i.su.values().next().value;i.su.delete(t);const e=new Lt(Pe.fromString(t)),n=i.lu.next();i._u.set(n,new jw(e)),i.ou=i.ou.insert(e,n),Ym(i.remoteStore,new Di($n(ym(e.path)),n,"TargetPurposeLimboResolution",ja.le))}}async function xo(i,t,e){const n=$t(i),r=[],s=[],o=[];n.ru.isEmpty()||(n.ru.forEach((l,c)=>{o.push(n.Pu(c,t,e).then(h=>{var u;if((h||e)&&n.isPrimaryClient){const d=h?!h.fromCache:(u=e==null?void 0:e.targetChanges.get(c.targetId))===null||u===void 0?void 0:u.current;n.sharedClientState.updateQueryState(c.targetId,d?"current":"not-current")}if(h){r.push(h);const d=Wh.Ps(c.targetId,h);s.push(d)}}))}),await Promise.all(o),n.nu.Q_(r),await async function(c,h){const u=$t(c);try{await u.persistence.runTransaction("notifyLocalViewChanges","readwrite",d=>J.forEach(h,m=>J.forEach(m.ls,_=>u.persistence.referenceDelegate.addReference(d,m.targetId,_)).next(()=>J.forEach(m.hs,_=>u.persistence.referenceDelegate.removeReference(d,m.targetId,_)))))}catch(d){if(!Es(d))throw d;xt(Xh,"Failed to update sequence numbers: "+d)}for(const d of h){const m=d.targetId;if(!d.fromCache){const _=u.Ss.get(m),x=_.snapshotVersion,M=_.withLastLimboFreeSnapshotVersion(x);u.Ss=u.Ss.insert(m,M)}}}(n.localStore,s))}async function ob(i,t){const e=$t(i);if(!e.currentUser.isEqual(t)){xt(Jh,"User change. New user:",t.toKey());const n=await Xm(e.localStore,t);e.currentUser=t,function(s,o){s.cu.forEach(l=>{l.forEach(c=>{c.reject(new It(st.CANCELLED,o))})}),s.cu.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,n.removedBatchIds,n.addedBatchIds),await xo(e,n.Ms)}}function ab(i,t){const e=$t(i),n=e._u.get(t);if(n&&n.tu)return se().add(n.key);{let r=se();const s=e.iu.get(t);if(!s)return r;for(const o of s){const l=e.ru.get(o);r=r.unionWith(l.view.Wa)}return r}}function lg(i){const t=$t(i);return t.remoteStore.remoteSyncer.applyRemoteEvent=rg.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=ab.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=nb.bind(null,t),t.nu.Q_=Gw.bind(null,t.eventManager),t.nu.Tu=Ww.bind(null,t.eventManager),t}function lb(i){const t=$t(i);return t.remoteStore.remoteSyncer.applySuccessfulWrite=ib.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=rb.bind(null,t),t}class za{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=il(t.databaseInfo.databaseId),this.sharedClientState=this.Au(t),this.persistence=this.Ru(t),await this.persistence.start(),this.localStore=this.Vu(t),this.gcScheduler=this.mu(t,this.localStore),this.indexBackfillerScheduler=this.fu(t,this.localStore)}mu(t,e){return null}fu(t,e){return null}Vu(t){return cw(this.persistence,new ow,t.initialUser,this.serializer)}Ru(t){return new Wm(Gh.Ei,this.serializer)}Au(t){return new gw}async terminate(){var t,e;(t=this.gcScheduler)===null||t===void 0||t.stop(),(e=this.indexBackfillerScheduler)===null||e===void 0||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}za.provider={build:()=>new za};class cb extends za{constructor(t){super(),this.cacheSizeBytes=t}mu(t,e){_e(this.persistence.referenceDelegate instanceof Ba,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new XA(n,t.asyncQueue,e)}Ru(t){const e=this.cacheSizeBytes!==void 0?vn.withCacheSize(this.cacheSizeBytes):vn.DEFAULT;return new Wm(n=>Ba.Ei(n,e),this.serializer)}}class uh{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>Gf(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=ob.bind(null,this.syncEngine),await Vw(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new kw}()}createDatastore(t){const e=il(t.databaseInfo.databaseId),n=function(s){return new xw(s)}(t.databaseInfo);return function(s,o,l,c){return new Aw(s,o,l,c)}(t.authCredentials,t.appCheckCredentials,n,e)}createRemoteStore(t){return function(n,r,s,o,l){return new bw(n,r,s,o,l)}(this.localStore,this.datastore,t.asyncQueue,e=>Gf(this.syncEngine,e,0),function(){return Of.C()?new Of:new _w}())}createSyncEngine(t,e){return function(r,s,o,l,c,h,u){const d=new Yw(r,s,o,l,c,h);return u&&(d.hu=!0),d}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(r){const s=$t(r);xt(_r,"RemoteStore shutting down."),s.aa.add(5),await Eo(s),s.ca.shutdown(),s.la.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(e=this.eventManager)===null||e===void 0||e.terminate()}}uh.provider={build:()=>new uh};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hb{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.pu(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.pu(this.observer.error,t):_i("Uncaught Error in snapshot listener:",t.toString()))}yu(){this.muted=!0}pu(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ug(i,t,e){if(!e)throw new It(st.INVALID_ARGUMENT,`Function ${i}() cannot be called with an empty ${t}.`)}function gb(i,t,e,n){if(t===!0&&n===!0)throw new It(st.INVALID_ARGUMENT,`${i} and ${e} cannot be used together.`)}function $f(i){if(!Lt.isDocumentKey(i))throw new It(st.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${i} has ${i.length}.`)}function jf(i){if(Lt.isDocumentKey(i))throw new It(st.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${i} has ${i.length}.`)}function eu(i){if(i===void 0)return"undefined";if(i===null)return"null";if(typeof i=="string")return i.length>20&&(i=`${i.substring(0,20)}...`),JSON.stringify(i);if(typeof i=="number"||typeof i=="boolean")return""+i;if(typeof i=="object"){if(i instanceof Array)return"an array";{const t=function(n){return n.constructor?n.constructor.name:null}(i);return t?`a custom ${t} object`:"an object"}}return typeof i=="function"?"a function":Bt(12329,{type:typeof i})}function ho(i,t){if("_delegate"in i&&(i=i._delegate),!(i instanceof t)){if(t.name===i.constructor.name)throw new It(st.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const e=eu(i);throw new It(st.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${e}`)}}return i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dg="firestore.googleapis.com",Yf=!0;class Kf{constructor(t){var e,n;if(t.host===void 0){if(t.ssl!==void 0)throw new It(st.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=dg,this.ssl=Yf}else this.host=t.host,this.ssl=(e=t.ssl)!==null&&e!==void 0?e:Yf;if(this.isUsingEmulator=t.emulatorOptions!==void 0,this.credentials=t.credentials,this.ignoreUndefinedProperties=!!t.ignoreUndefinedProperties,this.localCache=t.localCache,t.cacheSizeBytes===void 0)this.cacheSizeBytes=Gm;else{if(t.cacheSizeBytes!==-1&&t.cacheSizeBytes<GA)throw new It(st.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=t.cacheSizeBytes}gb("experimentalForceLongPolling",t.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",t.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!t.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:t.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!t.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=hg((n=t.experimentalLongPollingOptions)!==null&&n!==void 0?n:{}),function(s){if(s.timeoutSeconds!==void 0){if(isNaN(s.timeoutSeconds))throw new It(st.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (must not be NaN)`);if(s.timeoutSeconds<5)throw new It(st.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (minimum allowed value is 5)`);if(s.timeoutSeconds>30)throw new It(st.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!t.useFetchStreams}isEqual(t){return this.host===t.host&&this.ssl===t.ssl&&this.credentials===t.credentials&&this.cacheSizeBytes===t.cacheSizeBytes&&this.experimentalForceLongPolling===t.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===t.experimentalAutoDetectLongPolling&&function(n,r){return n.timeoutSeconds===r.timeoutSeconds}(this.experimentalLongPollingOptions,t.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===t.ignoreUndefinedProperties&&this.useFetchStreams===t.useFetchStreams}}class ol{constructor(t,e,n,r){this._authCredentials=t,this._appCheckCredentials=e,this._databaseId=n,this._app=r,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Kf({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new It(st.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(t){if(this._settingsFrozen)throw new It(st.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Kf(t),this._emulatorOptions=t.emulatorOptions||{},t.credentials!==void 0&&(this._authCredentials=function(n){if(!n)return new vM;switch(n.type){case"firstParty":return new TM(n.sessionIndex||"0",n.iamToken||null,n.authTokenFactory||null);case"provider":return n.client;default:throw new It(st.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(t.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(e){const n=qf.get(e);n&&(xt("ComponentProvider","Removing Datastore"),qf.delete(e),n.terminate())}(this),Promise.resolve()}}function _b(i,t,e,n={}){var r;i=ho(i,ol);const s=kp(t),o=i._getSettings(),l=Object.assign(Object.assign({},o),{emulatorOptions:i._getEmulatorOptions()}),c=`${t}:${e}`;s&&iS(`https://${c}`),o.host!==dg&&o.host!==c&&ls("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const h=Object.assign(Object.assign({},o),{host:c,ssl:s,emulatorOptions:n});if(!eo(h,l)&&(i._setSettings(h),n.mockUserToken)){let u,d;if(typeof n.mockUserToken=="string")u=n.mockUserToken,d=an.MOCK_USER;else{u=$T(n.mockUserToken,(r=i._app)===null||r===void 0?void 0:r.options.projectId);const m=n.mockUserToken.sub||n.mockUserToken.user_id;if(!m)throw new It(st.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");d=new an(m)}i._authCredentials=new yM(new tm(u,d))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qf="AsyncQueue";class Zf{constructor(t=Promise.resolve()){this.Qu=[],this.$u=!1,this.Uu=[],this.Ku=null,this.Wu=!1,this.Gu=!1,this.zu=[],this.y_=new $m(this,"async_queue_retry"),this.ju=()=>{const n=Zl();n&&xt(Qf,"Visibility state changed to "+n.visibilityState),this.y_.A_()},this.Hu=t;const e=Zl();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this.ju)}get isShuttingDown(){return this.$u}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.Ju(),this.Yu(t)}enterRestrictedMode(t){if(!this.$u){this.$u=!0,this.Gu=t||!1;const e=Zl();e&&typeof e.removeEventListener=="function"&&e.removeEventListener("visibilitychange",this.ju)}}enqueue(t){if(this.Ju(),this.$u)return new Promise(()=>{});const e=new Vi;return this.Yu(()=>this.$u&&this.Gu?Promise.resolve():(t().then(e.resolve,e.reject),e.promise)).then(()=>e.promise)}enqueueRetryable(t){this.enqueueAndForget(()=>(this.Qu.push(t),this.Zu()))}async Zu(){if(this.Qu.length!==0){try{await this.Qu[0](),this.Qu.shift(),this.y_.reset()}catch(t){if(!Es(t))throw t;xt(Qf,"Operation failed with retryable error: "+t)}this.Qu.length>0&&this.y_.E_(()=>this.Zu())}}Yu(t){const e=this.Hu.then(()=>(this.Wu=!0,t().catch(n=>{throw this.Ku=n,this.Wu=!1,_i("INTERNAL UNHANDLED ERROR: ",Jf(n)),n}).then(n=>(this.Wu=!1,n))));return this.Hu=e,e}enqueueAfterDelay(t,e,n){this.Ju(),this.zu.indexOf(t)>-1&&(e=0);const r=Kh.createAndSchedule(this,t,e,n,s=>this.Xu(s));return this.Uu.push(r),r}Ju(){this.Ku&&Bt(47125,{ec:Jf(this.Ku)})}verifyOperationInProgress(){}async tc(){let t;do t=this.Hu,await t;while(t!==this.Hu)}nc(t){for(const e of this.Uu)if(e.timerId===t)return!0;return!1}rc(t){return this.tc().then(()=>{this.Uu.sort((e,n)=>e.targetTimeMs-n.targetTimeMs);for(const e of this.Uu)if(e.skipDelay(),t!=="all"&&e.timerId===t)break;return this.tc()})}sc(t){this.zu.push(t)}Xu(t){const e=this.Uu.indexOf(t);this.Uu.splice(e,1)}}function Jf(i){let t=i.message||"";return i.stack&&(t=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),t}class nu extends ol{constructor(t,e,n,r){super(t,e,n,r),this.type="firestore",this._queue=new Zf,this._persistenceKey=(r==null?void 0:r.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Zf(t),this._firestoreClient=void 0,await t}}}function Eb(i,t){const e=typeof i=="object"?i:sM(),n=typeof i=="string"?i:Da,r=tM(e,"firestore").getImmediate({identifier:n});if(!r._initialized){const s=XT("firestore");s&&_b(r,...s)}return r}function fg(i){if(i._terminated)throw new It(st.FAILED_PRECONDITION,"The client has already been terminated.");return i._firestoreClient||xb(i),i._firestoreClient}function xb(i){var t,e,n;const r=i._freezeSettings(),s=function(l,c,h,u){return new OM(l,c,h,u.host,u.ssl,u.experimentalForceLongPolling,u.experimentalAutoDetectLongPolling,hg(u.experimentalLongPollingOptions),u.useFetchStreams,u.isUsingEmulator)}(i._databaseId,((t=i._app)===null||t===void 0?void 0:t.options.appId)||"",i._persistenceKey,r);i._componentsProvider||!((e=r.localCache)===null||e===void 0)&&e._offlineComponentProvider&&(!((n=r.localCache)===null||n===void 0)&&n._onlineComponentProvider)&&(i._componentsProvider={_offline:r.localCache._offlineComponentProvider,_online:r.localCache._onlineComponentProvider}),i._firestoreClient=new ub(i._authCredentials,i._appCheckCredentials,i._queue,s,i._componentsProvider&&function(l){const c=l==null?void 0:l._online.build();return{_offline:l==null?void 0:l._offline.build(c),_online:c}}(i._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iu{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new It(st.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ze(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ou{constructor(t){this._values=(t||[]).map(e=>e)}toArray(){return this._values.map(t=>t)}isEqual(t){return function(n,r){if(n.length!==r.length)return!1;for(let s=0;s<n.length;++s)if(n[s]!==r[s])return!1;return!0}(this._values,t._values)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tb=/^__.*__$/;class Sb{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return this.fieldMask!==null?new xr(t,this.data,this.fieldMask,e,this.fieldTransforms):new vo(t,this.data,e,this.fieldTransforms)}}function pg(i){switch(i){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Bt(40011,{oc:i})}}class ll{constructor(t,e,n,r,s,o){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=r,s===void 0&&this._c(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get oc(){return this.settings.oc}ac(t){return new ll(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}uc(t){var e;const n=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.ac({path:n,cc:!1});return r.lc(t),r}hc(t){var e;const n=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.ac({path:n,cc:!1});return r._c(),r}Pc(t){return this.ac({path:void 0,cc:!0})}Tc(t){return Ha(t,this.settings.methodName,this.settings.Ic||!1,this.path,this.settings.Ec)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}_c(){if(this.path)for(let t=0;t<this.path.length;t++)this.lc(this.path.get(t))}lc(t){if(t.length===0)throw this.Tc("Document fields must not be empty");if(pg(this.oc)&&Tb.test(t))throw this.Tc('Document fields cannot begin and end with "__"')}}class Mb{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||il(t)}dc(t,e,n,r=!1){return new ll({oc:t,methodName:e,Ec:n,path:Ze.emptyPath(),cc:!1,Ic:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Ab(i){const t=i._freezeSettings(),e=il(i._databaseId);return new Mb(i._databaseId,!!t.ignoreUndefinedProperties,e)}function wb(i,t,e,n,r,s={}){const o=i.dc(s.merge||s.mergeFields?2:0,t,e,r);_g("Data must be an object, but it was:",o,n);const l=mg(n,o);let c,h;if(s.merge)c=new Vn(o.fieldMask),h=o.fieldTransforms;else if(s.mergeFields){const u=[];for(const d of s.mergeFields){const m=Rb(t,d,e);if(!o.contains(m))throw new It(st.INVALID_ARGUMENT,`Field '${m}' is specified in your field mask but missing from your input data.`);Ib(u,m)||u.push(m)}c=new Vn(u),h=o.fieldTransforms.filter(d=>c.covers(d.field))}else c=null,h=o.fieldTransforms;return new Sb(new Cn(l),c,h)}function bb(i,t,e){return new ll({oc:3,Ec:t.settings.Ec,methodName:i._methodName,cc:e},t.databaseId,t.serializer,t.ignoreUndefinedProperties)}class au extends ru{constructor(t,e){super(t),this.Ac=e}_toFieldTransform(t){const e=bb(this,t,!0),n=this.Ac.map(s=>lu(s,e)),r=new ds(n);return new hA(t.path,r)}isEqual(t){return t instanceof au&&eo(this.Ac,t.Ac)}}function lu(i,t){if(gg(i=no(i)))return _g("Unsupported field value:",t,i),mg(i,t);if(i instanceof ru)return function(n,r){if(!pg(r.oc))throw r.Tc(`${n._methodName}() can only be used with update() and set()`);if(!r.path)throw r.Tc(`${n._methodName}() is not currently supported inside arrays`);const s=n._toFieldTransform(r);s&&r.fieldTransforms.push(s)}(i,t),null;if(i===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),i instanceof Array){if(t.settings.cc&&t.oc!==4)throw t.Tc("Nested arrays are not supported");return function(n,r){const s=[];let o=0;for(const l of n){let c=lu(l,r.Pc(o));c==null&&(c={nullValue:"NULL_VALUE"}),s.push(c),o++}return{arrayValue:{values:s}}}(i,t)}return function(n,r){if((n=no(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return aA(r.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const s=Ge.fromDate(n);return{timestampValue:Va(r.serializer,s)}}if(n instanceof Ge){const s=new Ge(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:Va(r.serializer,s)}}if(n instanceof su)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof ms)return{bytesValue:Fm(r.serializer,n._byteString)};if(n instanceof In){const s=r.databaseId,o=n.firestore._databaseId;if(!o.isEqual(s))throw r.Tc(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:zh(n.firestore._databaseId||r.databaseId,n._key.path)}}if(n instanceof ou)return function(o,l){return{mapValue:{fields:{[hm]:{stringValue:um},[La]:{arrayValue:{values:o.toArray().map(h=>{if(typeof h!="number")throw l.Tc("VectorValues must only contain numeric values.");return Vh(l.serializer,h)})}}}}}}(n,r);throw r.Tc(`Unsupported field value: ${eu(n)}`)}(i,t)}function mg(i,t){const e={};return rm(i)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):yr(i,(n,r)=>{const s=lu(r,t.uc(n));s!=null&&(e[n]=s)}),{mapValue:{fields:e}}}function gg(i){return!(typeof i!="object"||i===null||i instanceof Array||i instanceof Date||i instanceof Ge||i instanceof su||i instanceof ms||i instanceof In||i instanceof ru||i instanceof ou)}function _g(i,t,e){if(!gg(e)||!function(r){return typeof r=="object"&&r!==null&&(Object.getPrototypeOf(r)===Object.prototype||Object.getPrototypeOf(r)===null)}(e)){const n=eu(e);throw n==="an object"?t.Tc(i+" a custom object"):t.Tc(i+" "+n)}}function Rb(i,t,e){if((t=no(t))instanceof iu)return t._internalPath;if(typeof t=="string")return vg(i,t);throw Ha("Field path arguments must be of type string or ",i,!1,void 0,e)}const Cb=new RegExp("[~\\*/\\[\\]]");function vg(i,t,e){if(t.search(Cb)>=0)throw Ha(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,i,!1,void 0,e);try{return new iu(...t.split("."))._internalPath}catch{throw Ha(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,i,!1,void 0,e)}}function Ha(i,t,e,n,r){const s=n&&!n.isEmpty(),o=r!==void 0;let l=`Function ${t}() called with invalid data`;e&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${n}`),o&&(c+=` in document ${r}`),c+=")"),new It(st.INVALID_ARGUMENT,l+i+c)}function Ib(i,t){return i.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Db(i){if(i.limitType==="L"&&i.explicitOrderBy.length===0)throw new It(st.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Lb{convertValue(t,e="none"){switch(Xi(t)){case 0:return null;case 1:return t.booleanValue;case 2:return Ue(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(Wi(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw Bt(62114,{value:t})}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const n={};return yr(t,(r,s)=>{n[r]=this.convertValue(s,e)}),n}convertVectorValue(t){var e,n,r;const s=(r=(n=(e=t.fields)===null||e===void 0?void 0:e[La].arrayValue)===null||n===void 0?void 0:n.values)===null||r===void 0?void 0:r.map(o=>Ue(o.doubleValue));return new ou(s)}convertGeoPoint(t){return new su(Ue(t.latitude),Ue(t.longitude))}convertArray(t,e){return(t.values||[]).map(n=>this.convertValue(n,e))}convertServerTimestamp(t,e){switch(e){case"previous":const n=Ka(t);return n==null?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(oo(t));default:return null}}convertTimestamp(t){const e=Gi(t);return new Ge(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=Pe.fromString(t);_e(Hm(n),9688,{name:t});const r=new ao(n.get(1),n.get(3)),s=new Lt(n.popFirst(5));return r.isEqual(e)||_i(`Document ${s} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nb(i,t,e){let n;return n=i?e&&(e.merge||e.mergeFields)?i.toFirestore(t,e):i.toFirestore(t):t,n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
}`;function rR(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let tp=!1;class cu{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:r,title:s="Controls",closeFolders:o=!1,injectStyles:l=!0,touchStyles:c=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("button"),this.$title.classList.add("title"),this.$title.setAttribute("aria-expanded",!0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),c&&this.domElement.classList.add("allow-touch-styles"),!tp&&l&&(rR(iR),tp=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=o}add(t,e,n,r,s){if(Object(n)===n)return new eR(this,t,e,n);const o=t[e];switch(typeof o){case"number":return new tR(this,t,e,n,r,s);case"boolean":return new $b(this,t,e);case"string":return new nR(this,t,e);case"function":return new tc(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,o)}addColor(t,e,n=1){return new Jb(this,t,e,n)}addFolder(t){const e=new cu({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof tc||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof tc)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}let rr,dr;const ui=[];function sR(i,t,e){rr=new cu,ui.volume=rr.add(t,"volume",0,100,1).name("Volume").onChange(n=>{dr=e(),dr&&dr.setVolume&&dr.setVolume(n)}),ui.earthSpeed=rr.add(i,"earthSpeed",1,100,1).name("Earth Speed"),ui.earthRotationSpeed=rr.add(i,"earthRotationSpeed",1,100,1).name("Earth Rotation Speed"),ui.lightIntensity=rr.add(i,"lightIntensity",1,100,1).name("Light Intensity"),ui.rotationDirection=rr.add(i,"rotationDirection").name("Change Rotation Direction")}function oR(i,t,e){const n=i.songNum;e.aroundSunDirection=i.rotationDirection,ui.earthSpeed.setValue(i.earthSpeed),ui.earthRotationSpeed.setValue(i.earthRotationSpeed),ui.lightIntensity.setValue(i.lightIntensity),ui.volume.setValue(i.volume),dr&&n&&t&&(dr.loadVideoById(t[n-1].id),dr.playVideo())}function aR(i){rr.show(i)}const lR=document.querySelector(".hamburger-wrapper"),cR=document.querySelector(".add-button"),ep=document.querySelector(".presets-container"),hR=document.getElementById("saveButton"),uR=document.getElementById("preset-input"),{scene:fh,camera:Ga,renderer:Ag,labelRenderer:wg,controls:dR,animateParams:Qr}=LT(),bg=Qg();sR(Qr,bg,Zg);let ca=!0;function hu(){ca=!ca,Kg(),DT(fh,ca),aR(ca)}function Rg(){ep.innerHTML="",Ma.forEach(i=>{const t=document.createElement("div");t.addEventListener("click",()=>{oR(i,ph,Qr),hu()}),t.className="preset",t.innerHTML=`<p>${i.name}</p>`,ep.appendChild(t)})}window.addEventListener("resize",()=>{Ga.aspect=window.innerWidth/window.innerHeight,Ga.updateProjectionMatrix(),Ag.setSize(window.innerWidth,window.innerHeight),wg.setSize(window.innerWidth,window.innerHeight)});document.addEventListener("DOMContentLoaded",async()=>{await Sg(),Rg(),console.log("loaded")});hR.addEventListener("click",async()=>{if(Aa.length>0){const i=Xs?Xs.num:1;await qb(Aa,bg.volume,i,Qr.earthSpeed,Qr.earthRotationSpeed,Qr.lightIntensity,Qr.aroundSunDirection),await Sg(),uR.value="",Rg(),ip(),hu()}else alert("Please enter a valid preset name.")});lR.addEventListener("click",()=>{hu()});cR.addEventListener("click",async()=>{ip()});function Cg(){NT(),dR.update(),Ag.render(fh,Ga),wg.render(fh,Ga),window.requestAnimationFrame(Cg)}Cg();
